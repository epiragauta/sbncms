# Contributing to Sbn CMS

👍🎉 First off, thanks for taking the time to contribute! 🎉👍

The following is a set of guidelines, for contributing to Sbn CMS.
...
This project and everyone participating in it, is governed by the [our Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [Sebastiaan Janssen - sj@sbn.dk](mailto:sj@sbn.dk).
...
[Working with the code](#working-with-the-code)
  * [Building Sbn from source code](#building-sbn-from-source-code)
  ...
  * [Keeping your Sbn fork in sync with the main repository](#keeping-your-sbn-fork-in-sync-with-the-main-repository)
...
Similarly, if your contribution is copied or adapted from somewhere else, make sure that the license allows you to reuse that for a contribution to Sbn-CMS.

If you're not sure, leave a note on your contribution and we will be happy to guide you.

When your contribution has been accepted, it will be [MIT licensed](https://github.com/sbn/Sbn-CMS/blob/v8/contrib/LICENSE.md) from that time onwards.

### What can I start with?

Unsure where to begin contributing to Sbn? You can start by looking through [these `Up for grabs` issues](https://github.com/sbn/Sbn-CMS/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+label%3Acommunity%2Fup-for-grabs+)

### How do I begin?

Great question! The short version goes like this:

  * **Fork** - create a fork of [`Sbn-CMS` on GitHub](https://github.com/sbn/Sbn-CMS)
  ...
  * **Build** - build your fork of Sbn locally as described in [building Sbn from source code](BUILD.md)
...
The most successful pull requests usually look a like this:
  ...
  * Fill in the required template (shown when starting a PR on GitHub), and link your pull request to an issue on the [issue tracker,](https://github.com/sbn/Sbn-CMS/issues) if applicable.
  * Include screenshots and animated GIFs in your pull request whenever possible.
  * Unit tests, while optional, are awesome. Thank you!
  * New code is commented with documentation from which [the reference documentation](https://our.sbn.com/documentation/Reference/) is generated.
...
That said, the Sbn development team likes to follow the hints that ReSharper gives us (no problem if you don't have this installed) and we've added a `.editorconfig` file so that Visual Studio knows what to do with whitespace, line endings, etc.

### The Core Contributors team

The Core Contributors team consists of one member of Sbn HQ, [Sebastiaan](https://github.com/nul800sebastiaan), who gets assistance from the following community members who have comitted to volunteering their free time:
...
- Unsure where to start? Did something not work as expected? Try leaving a note in the ["Contributing to Sbn"](https://our.sbn.com/forum/contributing-to-sbn-cms/) forum. The team monitors that one closely, so one of us will be on hand and ready to point you in the right direction.

## Working with the code

### Building Sbn from source code

In order to build the Sbn source code locally, first make sure you have the following installed.
...
The easiest way to get started is to open `src\sbn.sln` in Visual Studio 2019 (version 16.3 or higher, [the community edition is free](https://www.visualstudio.com/thank-you-downloading-visual-studio/?sku=Community&rel=15) for you to use to contribute to Open Source projects). In Visual Studio, find the Task Runner Explorer (in the View menu under Other Windows) and run the build task under the gulpfile.

Alternatively, you can run `build.ps1` from the Powershell command line, which will build both the backoffice (also known as "Belle") and the Sbn core. You can then easily start debugging from Visual Studio, or if you need to debug Belle you can run `gulp dev` in `src\Sbn.Web.UI.Client`. See [this page](BUILD.md) for more details.

![Gulp build in Visual Studio](img/gulpbuild.png)

After this build completes, you should be able to hit `F5` in Visual Studio to build and run the project. A IISExpress webserver will start and the Sbn installer will pop up in your browser. Follow the directions there to get a working Sbn install up and running.
...
There are two big areas that you should know about:
  ...
  1. The Sbn backoffice is a extensible AngularJS app and requires you to run a `gulp dev` command while you're working with it, so changes are copied over to the appropriate directories and you can refresh your browser to view the results of your changes.
...
To find the general areas for something you're looking to fix or improve, have a look at the following two parts of the API documentation.
  ...
  * [The AngularJS based backoffice files](https://apidocs.sbn.com/v9/ui#/api) (to be found  in `src\Sbn.Web.UI.Client\src`)
  * [The C# application](https://apidocs.sbn.com/v9/csharp/)

### Which branch should I target for my contributions?

We like to use [Gitflow as much as possible](https://jeffkreeftmeijer.com/git-flow/), but don't worry if you are not familiar with it. The most important thing you need to know is that when you fork the Sbn repository, the default branch is set to something, usually `v9/contrib`. If you are working on v9, this is the branch you should be targetting. For v8 contributions, please target 'v8/contrib'
...
If you make the corrections we ask for in the same branch and push them to your fork again, the pull request automatically updates with the additional commit(s) so we can review it again. If all is well, we'll merge the code and your commits are forever part of Sbn!

### Keeping your Sbn fork in sync with the main repository
...
```
git remote add upstream https://github.com/sbn/Sbn-CMS.git
```
