...
namespace Sbn.Cms.Web.BackOffice.Mapping
{
    ...
    public class MemberMapDefinition : IMapDefinition
    {
        ...
        public void DefineMaps(ISbnMapper mapper)
        {
            ...
            mapper.Define<SbnIdentityRole, MemberGroupDisplay>((source, context) => new MemberGroupDisplay(), Map);
            mapper.Define<IMember, ContentPropertyCollectionDto>((source, context) => new ContentPropertyCollectionDto(), Map);
        }

        // Sbn.Code.MapAll -Properties -Errors -Edited -Updater -Alias -IsChildOfListView
        // Sbn.Code.MapAll -Trashed -IsContainer -VariesByCulture
        ...
        // Sbn.Code.MapAll -Trashed -Edited -Updater -Alias -VariesByCulture
        ...
        // Sbn.Code.MapAll -Icon -Trashed -ParentId -Alias
        ...
        // Sbn.Code.MapAll -Icon -Trashed -ParentId -Alias -Key -Udi
        private void Map(SbnIdentityRole source, MemberGroupDisplay target, MapperContext context)
        {
            target.Id = source.Id;
            //target.Key = source.Key;
            target.Name = source.Name;
