...
{
    /// <summary>
    /// If Sbn.Core.UseHttps property in web.config is set to true, this filter will redirect any http access to https.
    /// </summary>
    public class SbnRequireHttpsAttribute : RequireHttpsAttribute
    {
