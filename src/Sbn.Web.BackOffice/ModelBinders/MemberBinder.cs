...
{
    /// <summary>
    /// The model binder for <see cref="T:Sbn.Web.Models.ContentEditing.MemberSave" />
    /// </summary>
    internal class MemberBinder : IModelBinder
    {
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            {
                model.PropertyCollectionDto = _sbnMapper.Map<IMember, ContentPropertyCollectionDto>(model.PersistedContent);
