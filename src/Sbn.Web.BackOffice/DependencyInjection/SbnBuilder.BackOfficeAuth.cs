...
namespace Sbn.Extensions
{
    ...
    {
        /// <summary>
        /// Adds Sbn back office authentication requirements
        /// </summary>
        public static ISbnBuilder AddBackOfficeAuthentication(this ISbnBuilder builder)
        {
            builder.Services
        ...
        /// <summary>
        /// Adds Sbn back office authorization policies
        /// </summary>
        public static ISbnBuilder AddBackOfficeAuthorizationPolicies(this ISbnBuilder builder, string backOfficeAuthenticationScheme = Constants.Security.BackOfficeAuthenticationType)
        {
            ...
            builder.Services.AddAuthorization(options
                => options.AddPolicy(AuthorizationPolicies.SbnFeatureEnabled, policy
        ...
        /// </summary>
        private static void AddBackOfficeAuthorizationPoliciesInternal(this ISbnBuilder builder, string backOfficeAuthenticationScheme = Constants.Security.BackOfficeAuthenticationType)
        {
