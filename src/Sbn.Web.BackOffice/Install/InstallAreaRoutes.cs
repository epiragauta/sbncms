        ...
        public void CreateRoutes(IEndpointRouteBuilder endpoints)
        {
            ...
            switch (_runtime.Level)
            {
                case var _ when _runtime.EnableInstaller():
                    ...
                    endpoints.MapSbnRoute<InstallApiController>(installPathSegment, Cms.Core.Constants.Web.Mvc.InstallArea, "api", includeControllerNameInRoute: false);
                    endpoints.MapSbnRoute<InstallController>(installPathSegment, Cms.Core.Constants.Web.Mvc.InstallArea, string.Empty, includeControllerNameInRoute: false);
