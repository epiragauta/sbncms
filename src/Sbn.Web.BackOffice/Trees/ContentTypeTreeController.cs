...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public class ContentTypeTreeController : TreeController, ISearchableTree
    {
        ...
        protected override ActionResult<TreeNodeCollection> GetTreeNodes(string id, FormCollection queryStrings)
        {
            ...
            nodes.AddRange(
                _entityService.GetChildren(intId, SbnObjectTypes.DocumentTypeContainer)
            ...
            var children = _entityService.GetChildren(intId, SbnObjectTypes.DocumentType).ToArray();
        ...
        protected override ActionResult<MenuItemCollection> GetMenuForNode(string id, FormCollection queryStrings)
        {
            ...
            var container = _entityService.Get(int.Parse(id, CultureInfo.InvariantCulture), SbnObjectTypes.DocumentTypeContainer);
            if (container != null)
            {
                //set the default to create
                menu.DefaultMenuAlias = ActionNew.ActionAlias;
        ...
        public IEnumerable<SearchResultEntity> Search(string query, int pageSize, long pageIndex, out long totalFound, string searchFrom = null)
            => _treeSearcher.EntitySearch(SbnObjectTypes.DocumentType, query, pageSize, pageIndex, out totalFound, searchFrom);
