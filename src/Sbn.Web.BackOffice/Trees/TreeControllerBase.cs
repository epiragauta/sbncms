...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public abstract class TreeControllerBase : SbnAuthorizedApiController, ITree
    {
        ...
        protected TreeControllerBase(SbnApiControllerTypeCollection apiControllers, IEventAggregator eventAggregator)
        {
        ...
        /// <param name="hasChildren"></param>
        /// <returns></returns>
        public TreeNode CreateTreeNode(ISbnEntity entity, Guid entityObjectType, string parentId, FormCollection queryStrings, string icon, bool hasChildren)
        {
