...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public class MediaTypeTreeController : TreeController, ISearchableTree
    {
        ...
        protected override ActionResult<TreeNodeCollection> GetTreeNodes(string id, FormCollection queryStrings)
        {
            ...
            nodes.AddRange(
                _entityService.GetChildren(intId, SbnObjectTypes.MediaTypeContainer)
            ...
            nodes.AddRange(
                _entityService.GetChildren(intId, SbnObjectTypes.MediaType)
                    .OrderBy(entity => entity.Name)
                    .Select(dt =>
                    {
        ...
        protected override ActionResult<MenuItemCollection> GetMenuForNode(string id, FormCollection queryStrings)
        {
            ...
            var container = _entityService.Get(int.Parse(id, CultureInfo.InvariantCulture), SbnObjectTypes.MediaTypeContainer);
            if (container != null)
            {
                // set the default to create
                menu.DefaultMenuAlias = ActionNew.ActionAlias;
        ...
        public IEnumerable<SearchResultEntity> Search(string query, int pageSize, long pageIndex, out long totalFound, string searchFrom = null)
            => _treeSearcher.EntitySearch(SbnObjectTypes.MediaType, query, pageSize, pageIndex, out totalFound, searchFrom);
