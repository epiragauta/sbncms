...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public class DataTypeTreeController : TreeController, ISearchableTree
    {
        ...
        protected override ActionResult<TreeNodeCollection> GetTreeNodes(string id, FormCollection queryStrings)
        {
            ...
            //Folders first
            nodes.AddRange(
               _entityService.GetChildren(intId, SbnObjectTypes.DataTypeContainer)
            ...
            var children = _entityService.GetChildren(intId, SbnObjectTypes.DataType).ToArray();
        ...
        protected override ActionResult<MenuItemCollection> GetMenuForNode(string id, FormCollection queryStrings)
        {
            ...
            var container = _entityService.Get(int.Parse(id, CultureInfo.InvariantCulture), SbnObjectTypes.DataTypeContainer);
            if (container != null)
            {
                //set the default to create
                menu.DefaultMenuAlias = ActionNew.ActionAlias;
        ...
        public IEnumerable<SearchResultEntity> Search(string query, int pageSize, long pageIndex, out long totalFound, string searchFrom = null)
            => _treeSearcher.EntitySearch(SbnObjectTypes.DataType, query, pageSize, pageIndex, out totalFound, searchFrom);
    }
}
