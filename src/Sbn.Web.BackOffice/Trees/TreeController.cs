...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public abstract class TreeController : TreeControllerBase
    {
        ...
        protected TreeController(ILocalizedTextService localizedTextService, SbnApiControllerTypeCollection sbnApiControllerTypeCollection, IEventAggregator eventAggregator)
            : base(sbnApiControllerTypeCollection, eventAggregator)
        {
