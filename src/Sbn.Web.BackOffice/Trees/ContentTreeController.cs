...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public class ContentTreeController : ContentTreeControllerBase, ISearchableTree
    {
        ...
        public ContentTreeController(
            ...
            AppCaches appCaches)
            : base(localizedTextService, sbnApiControllerTypeCollection, menuItemCollectionFactory, entityService, backofficeSecurityAccessor, logger, actionCollection, userService, dataTypeService, eventAggregator, appCaches)
        {
        ...
        protected override ActionResult<MenuItemCollection> PerformGetMenuForNode(string id, FormCollection queryStrings)
        {
            ...
            var item = _entityService.Get(iid, SbnObjectTypes.Document);
            if (item == null)
            {
                return NotFound();
            }
        ...
        protected override SbnObjectTypes SbnObjectType => SbnObjectTypes.Document;
        ...
        /// <returns></returns>
        protected MenuItemCollection GetAllNodeMenuItems(ISbnEntity item)
        {
            var menu = _menuItemCollectionFactory.Create();
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        protected MenuItemCollection GetNodeMenuItemsForDeletedContent(ISbnEntity item)
        {
            var menu = _menuItemCollectionFactory.Create();
        ...
        private void AddActionNode<TAction>(ISbnEntity item, MenuItemCollection menu, bool hasSeparator = false, bool opensDialog = false)
        ...
        {
            return _treeSearcher.ExamineSearch(query, SbnEntityTypes.Document, pageSize, pageIndex, out totalFound, searchFrom);
        }
    }
}
