...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public class MediaTreeController : ContentTreeControllerBase, ISearchableTree, ITreeNodeController
    {
        ...
        /// <summary>
        /// Creates a tree node for a content item based on an SbnEntity
        /// </summary>
        /// <param name="e"></param>
        ...
        protected override ActionResult<MenuItemCollection> PerformGetMenuForNode(string id, FormCollection queryStrings)
        {
            ...
            var item = _entityService.Get(iid, SbnObjectTypes.Media);
            if (item == null)
            {
                return NotFound();
            }
        ...
        protected override SbnObjectTypes SbnObjectType => SbnObjectTypes.Media;
        ...
        {
            return _treeSearcher.ExamineSearch(query, SbnEntityTypes.Media, pageSize, pageIndex, out totalFound, searchFrom);
        }
