...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    ...
    public class ContentBlueprintTreeController : TreeController
    {
        ...
        protected override ActionResult<TreeNodeCollection> GetTreeNodes(string id, FormCollection queryStrings)
        {
            ...
            //get all blueprints
            var entities = _entityService.GetChildren(Constants.System.Root, SbnObjectTypes.DocumentBlueprint).ToArray();
            ...
            if (id == Constants.System.RootString)
            {
                ...
                var docTypeEntities = contentTypeIds.Length == 0
                    ? new ISbnEntity[0]
                    : _entityService.GetAll(SbnObjectTypes.DocumentType, contentTypeIds).ToArray();
        ...
        protected override ActionResult<MenuItemCollection> GetMenuForNode(string id, FormCollection queryStrings)
        {
            ...
            var cte = _entityService.Get(int.Parse(id, CultureInfo.InvariantCulture), SbnObjectTypes.DocumentType);
