...
namespace Sbn.Cms.Web.BackOffice.Trees
{
    public static class UrlHelperExtensions
    {
        ...
        {
            //This reuses the Logic from sbn.cms.helpers.DeepLink class
        ...
        public static string GetTreeUrl(this IUrlHelper urlHelper, SbnApiControllerTypeCollection sbnApiControllerTypeCollection, Type treeType, string nodeId, FormCollection queryStrings)
        {
            var actionUrl = urlHelper.GetSbnApiService(sbnApiControllerTypeCollection, "GetNodes", treeType)
                .EnsureEndsWith('?');
        ...
        public static string GetMenuUrl(this IUrlHelper urlHelper, SbnApiControllerTypeCollection sbnApiControllerTypeCollection, Type treeType, string nodeId, FormCollection queryStrings)
        {
            var actionUrl = urlHelper.GetSbnApiService(sbnApiControllerTypeCollection, "GetMenu", treeType)
                .EnsureEndsWith('?');
