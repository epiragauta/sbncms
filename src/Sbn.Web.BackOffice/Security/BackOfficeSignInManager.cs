...
namespace Sbn.Cms.Web.BackOffice.Security
{
    ...
    /// </summary>
    public class BackOfficeSignInManager : SbnSignInManager<BackOfficeIdentityUser>, IBackOfficeSignInManager
    {
        ...
        public override AuthenticationProperties ConfigureExternalAuthenticationProperties(string provider, string redirectUrl, string userId = null)
        {
            ...
            properties.Items[SbnSignInMgrLoginProviderKey] = provider;
            if (userId != null)
            {
                properties.Items[SbnSignInMgrXsrfKey] = userId;
            }
            return properties;
        }
