...
{
    /// <summary>
    /// Custom <see cref="AuthenticationBuilder"/> used to associate external logins with sbn external login options
    /// </summary>
    public class BackOfficeAuthenticationBuilder : AuthenticationBuilder
    {
        ...
        // Ensures that the sign in scheme is always the Sbn back office external type
