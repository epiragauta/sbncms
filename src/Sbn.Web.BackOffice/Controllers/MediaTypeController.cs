...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class MediaTypeController : ContentTypeControllerBase<IMediaType>
    {
        ...
        public ActionResult<MediaTypeDisplay> GetById(int id)
        {
            ...
            var dto = _sbnMapper.Map<IMediaType, MediaTypeDisplay>(ct);
            return dto;
        }
        ...
        public ActionResult<MediaTypeDisplay> GetById(Guid id)
        {
            ...
            var dto = _sbnMapper.Map<IMediaType, MediaTypeDisplay>(mediaType);
            return dto;
        }
        ...
        public IActionResult GetAvailableCompositeMediaTypes(GetAvailableCompositionsFilter filter)
        {
            var actionResult = PerformGetAvailableCompositeContentTypes(filter.ContentTypeId,
                SbnObjectTypes.MediaType, filter.FilterContentTypes, filter.FilterPropertyTypes,
                filter.IsElement);
        ...
        {
            var result =
                PerformGetWhereCompositionIsUsedInContentTypes(filter.ContentTypeId, SbnObjectTypes.MediaType).Value
                    .Select(x => new
                    {
                        contentType = x
                    });
        ...
        public MediaTypeDisplay GetEmpty(int parentId)
        {
            ...
            var dto = _sbnMapper.Map<IMediaType, MediaTypeDisplay>(mt);
            return dto;
        }
        ...
        public IEnumerable<ContentTypeBasic> GetAll() =>
            _mediaTypeService.GetAll()
                .Select(_sbnMapper.Map<IMediaType, ContentTypeBasic>);
        ...
        public ActionResult<MediaTypeDisplay> PostSave(MediaTypeSave contentTypeSave)
        {
            ...
            var display = _sbnMapper.Map<MediaTypeDisplay>(savedCt.Value);
        ...
        public IEnumerable<ContentTypeBasic> GetAllowedChildren(int contentId)
        {
            ...
            var basics = types.Select(_sbnMapper.Map<IMediaType, ContentTypeBasic>).ToList();
