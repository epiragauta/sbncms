...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class SectionController : SbnAuthorizedJsonController
    {
        ...
        public SectionController(
            ...
            ISbnMapper sbnMapper, IControllerFactory controllerFactory,
        ...
        public async Task<ActionResult<IEnumerable<Section>>> GetSections()
        {
            ...
            var sectionModels = sections.Select(_sbnMapper.Map<Section>).ToArray();
        ...
        public IEnumerable<Section> GetAllSections()
        {
            ...
            var mapped = sections.Select(_sbnMapper.Map<Section>);
