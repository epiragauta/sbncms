    ...
    public class DictionaryController : BackOfficeNotificationsController
    {
     ...
     /// <summary>
        ...
        public ActionResult<DictionaryDisplay> GetById(int id)
        {
            ...
            return _sbnMapper.Map<IDictionaryItem, DictionaryDisplay>(dictionary);
        }
        ...
        public ActionResult<DictionaryDisplay> PostSave(DictionarySave dictionary)
        {
            ...
            try
            {
                ...
                var model = _sbnMapper.Map<IDictionaryItem, DictionaryDisplay>(dictionaryItem);
        ...
        public IEnumerable<DictionaryOverviewDisplay> GetList()
        {
            ...
            void BuildTree(int level = 0, Guid? parentId = null)
            {
                ...
                {
                    var display = _sbnMapper.Map<IDictionaryItem, DictionaryOverviewDisplay>(child);
                    display.Level = level;
                    list.Add(display);
        ...
        private void GetChildItemsForList(IDictionaryItem dictionaryItem, int level, ICollection<DictionaryOverviewDisplay> list)
        {
            ...
            {
                var item = _sbnMapper.Map<IDictionaryItem, DictionaryOverviewDisplay>(childItem);
                item.Level = level;
                list.Add(item);
