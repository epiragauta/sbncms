...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class TemplateController : BackOfficeNotificationsController
    {
        ...
        public TemplateDisplay GetByAlias(string alias)
        {
            ...
            return template == null ? null : _sbnMapper.Map<ITemplate, TemplateDisplay>(template);
        }
        ...
        {
            return _fileService.GetTemplates().Select(_sbnMapper.Map<ITemplate, EntityBasic>);
        }
        ...
        public ActionResult<TemplateDisplay> GetById(int id)
        {
            ...
            return _sbnMapper.Map<ITemplate, TemplateDisplay>(template);
        }
        ...
        public TemplateDisplay GetScaffold(int id)
        {
            ...
            var scaffold = _sbnMapper.Map<ITemplate, TemplateDisplay>(dt);
        ...
        public ActionResult<TemplateDisplay> PostSave(TemplateDisplay display)
        {
            ...
            if (display.Id > 0)
            {
                ...
                _sbnMapper.Map(display, template);
                ...
                _sbnMapper.Map(template, display);
            }
            else
            {
                //create
