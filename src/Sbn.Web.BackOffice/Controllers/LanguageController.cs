...
using Language = Sbn.Cms.Core.Models.ContentEditing.Language;
...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class LanguageController : SbnAuthorizedJsonController
    {
        ...
        public IDictionary<string, string> GetAllCultures()
        {
            ...
            // TODO: Fix this requirement, see https://github.com/sbn/Sbn-CMS/issues/3623
        ...
        public IEnumerable<Language> GetAllLanguages()
        {
            ...
            return _sbnMapper.Map<IEnumerable<ILanguage>, IEnumerable<Language>>(allLanguages);
        }
        ...
        public ActionResult<Language> GetLanguage(int id)
        {
            ...
            return _sbnMapper.Map<Language>(lang);
        }
        ...
        public ActionResult<Language> SaveLanguage(Language language)
        {
            ...
            if (existingById == null)
            {
                ...
                return _sbnMapper.Map<Language>(newLang);
            }
            ...
            return _sbnMapper.Map<Language>(existingById);
        }
