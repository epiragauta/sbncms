...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    [IsBackOffice]
    [DisableBrowserCache]
    public class AuthenticationController : SbnApiControllerBase
    {
        ...
        public async Task<ActionResult<UserDisplay>> PostVerifyInvite([FromQuery] int id, [FromQuery] string token)
        {
            ...
            return _sbnMapper.Map<UserDisplay>(user);
        }
        ...
        /// <summary>
        /// Returns the currently logged in Sbn user
        /// </summary>
        /// <returns></returns>
        /// <remarks>
        ...
        public UserDetail GetCurrentUser()
        {
            ...
            var result = _sbnMapper.Map<UserDetail>(user);
            ...
            if (identityUser != null)
            {
                ...
                if (user != null)
                {
                    ...
                    var message = _textService.Localize("login","resetPasswordEmailCopyFormat",
                        ...
                        SbnUserExtensions.GetUserCulture(identityUser.Culture, _textService, _globalSettings),
        ...
        public async Task<IActionResult> PostSend2FACode([FromBody] string provider)
        {
            ...
            var subject = _textService.Localize("login","mfaSecurityCodeSubject",
                       // Ensure the culture of the found user is used for the email!
                       SbnUserExtensions.GetUserCulture(user.Culture, _textService, _globalSettings));
        ...
        private UserDetail GetUserDetail(IUser user)
        {
            ...
            var userDetail = _sbnMapper.Map<UserDetail>(user);
