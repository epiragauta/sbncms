...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class UserGroupsController : BackOfficeNotificationsController
    {
        ...
        public ActionResult<UserGroupDisplay> PostSaveUserGroup(UserGroupSave userGroupSave)
        {
            ...
            _sbnMapper.Map(userGroupSave, userGroupSave.PersistedUserGroup);
            ...
            var display = _sbnMapper.Map<UserGroupDisplay>(userGroupSave.PersistedUserGroup);
        ...
        {
            return _sbnMapper.Map<UserGroupDisplay>(new UserGroup(_shortStringHelper));
        }
        ...
        {
            var allGroups = _sbnMapper.MapEnumerable<IUserGroup, UserGroupBasic>(_userService.GetAllUserGroups())
                .ToList();
        ...
        public ActionResult<UserGroupDisplay> GetUserGroup(int id)
        {
            ...
            var display =  _sbnMapper.Map<UserGroupDisplay>(found);
