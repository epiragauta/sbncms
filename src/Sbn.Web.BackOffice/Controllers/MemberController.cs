...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class MemberController : ContentControllerBase
    {
        ...
        /// <param name="sbnMapper">The mapper</param>
            ...
            string memberTypeAlias = null)
        {
            ...
            {
                Items = members.Select(x => _sbnMapper.Map<MemberBasic>(x))
            };
            return pagedResult;
        }
        ...
        public MemberDisplay GetByKey(Guid key)
        {
            ...
            return _sbnMapper.Map<MemberDisplay>(foundMember);
        }
        ...
        public ActionResult<MemberDisplay> GetEmpty(string contentTypeAlias = null)
        {
            ...
            return _sbnMapper.Map<MemberDisplay>(emptyContent);
        }
        ...
        public async Task<ActionResult<MemberDisplay>> PostSave([ModelBinder(typeof(MemberBinder))] MemberSave contentItem)
        {
            ...
            {
                MemberDisplay forDisplay = _sbnMapper.Map<MemberDisplay>(contentItem.PersistedContent);
            ...
            MemberDisplay display = _sbnMapper.Map<MemberDisplay>(contentItem.PersistedContent);
        ...
        private async Task<ActionResult<bool>> CreateMemberAsync(MemberSave contentItem)
        {
            ...
            member = _sbnMapper.Map<MemberSave, IMember>(contentItem, member);
