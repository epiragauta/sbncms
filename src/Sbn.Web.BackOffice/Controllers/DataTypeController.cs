...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class DataTypeController : BackOfficeNotificationsController
    {
        ...
        public DataTypeDisplay GetByName(string name)
        {
            ...
            return dataType == null ? null : _sbnMapper.Map<IDataType, DataTypeDisplay>(dataType);
        }
        ...
        public ActionResult<DataTypeDisplay> GetById(int id)
        {
            ...
            return _sbnMapper.Map<IDataType, DataTypeDisplay>(dataType);
        }
        ...
        public DataTypeDisplay GetEmpty(int parentId)
        {
            ...
            return _sbnMapper.Map<IDataType, DataTypeDisplay>(dt);
        }
        ...
        public ActionResult<IEnumerable<DataTypeConfigurationFieldDisplay>> GetPreValues(string editorAlias, int dataTypeId = -1)
        {
            ...
            if (dataTypeId == -1)
            {
                ...
                return new ActionResult<IEnumerable<DataTypeConfigurationFieldDisplay>>(_sbnMapper.Map<IDataEditor, IEnumerable<DataTypeConfigurationFieldDisplay>>(propEd));
            }
            ...
            if (dataType.EditorAlias == editorAlias)
            {
                ...
                return new ActionResult<IEnumerable<DataTypeConfigurationFieldDisplay>>(_sbnMapper.Map<IDataType, IEnumerable<DataTypeConfigurationFieldDisplay>>(dataType));
            }
        ...
        public ActionResult<DataTypeDisplay> PostSave(DataTypeSave dataType)
        {
            ...
            var display = _sbnMapper.Map<IDataType, DataTypeDisplay>(dataType.PersistedDataType);
        ...
        public DataTypeReferences GetReferences(int id)
        {
            ...
            foreach(var groupOfEntityType in usages.GroupBy(x => x.Key.EntityType))
            {
                ...
                if (groupOfEntityType.Key == ObjectTypes.GetUdiType(SbnObjectTypes.DocumentType))
                ...
                else if (groupOfEntityType.Key == ObjectTypes.GetUdiType(SbnObjectTypes.MediaType))
                    result.MediaTypes = GetContentTypeUsages(_mediaTypeService.GetAll(guidsAndPropertyAliases.Keys), guidsAndPropertyAliases);
                else if (groupOfEntityType.Key == ObjectTypes.GetUdiType(SbnObjectTypes.MemberType))
            ...
            IReadOnlyDictionary<Guid, IEnumerable<string>> usages)
        {
            return cts.Select(x => new DataTypeReferences.ContentTypeReferences
            {
                ...
                Icon = x.Icon,
                Name = x.Name,
                Udi = new GuidUdi(ObjectTypes.GetUdiType(SbnObjectTypes.DocumentType), x.Key),
        ...
        public IEnumerable<DataTypeBasic> GetAll()
        {
            return _dataTypeService
                     .GetAll()
                     .Select(_sbnMapper.Map<IDataType, DataTypeBasic>).Where(x => x.IsSystemDataType == false);
        }
        ...
        public IDictionary<string, IEnumerable<DataTypeBasic>> GetGroupedDataTypes()
        {
            var dataTypes = _dataTypeService
                     .GetAll()
                     .Select(_sbnMapper.Map<IDataType, DataTypeBasic>)
                     .ToArray();
        ...
        public IDictionary<string, IEnumerable<DataTypeBasic>> GetGroupedPropertyEditors()
        {
            ...
            foreach (var propertyEditor in propertyEditors)
            {
                ...
                var basic = _sbnMapper.Map<DataTypeBasic>(propertyEditor);
        ...
        public IEnumerable<PropertyEditorBasic> GetAllPropertyEditors()
        {
            return _propertyEditorCollection
                .OrderBy(x => x.Name)
                .Select(_sbnMapper.Map<PropertyEditorBasic>);
        }
        #endregion
    }
}
