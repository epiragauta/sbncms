...
using Sbn.Cms.Core.Strings.Css;
...
using Stylesheet = Sbn.Cms.Core.Models.Stylesheet;
using StylesheetRule = Sbn.Cms.Core.Models.ContentEditing.StylesheetRule;
...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class CodeFileController : BackOfficeNotificationsController
    {
        ...
        public ActionResult<CodeFileDisplay> PostCreateContainer(string type, string parentId, string name)
        {
            ...
            switch (type)
            {
                ...
                case Constants.Trees.PartialViewMacros:
                    ...
                    break;
                case Constants.Trees.Scripts:
                    virtualPath = NormalizeVirtualPath(name, _globalSettings.SbnScriptsPath);
                    _fileService.CreateScriptFolder(virtualPath);
                    break;
                case Constants.Trees.Stylesheets:
                    virtualPath = NormalizeVirtualPath(name, _globalSettings.SbnCssPath);
        ...
        public ActionResult<CodeFileDisplay> GetByPath(string type, string virtualPath)
        {
            ...
            switch (type)
            {
                case Constants.Trees.PartialViews:
                    ...
                    if (view != null)
                    {
                        var display = _sbnMapper.Map<IPartialView, CodeFileDisplay>(view);
                ...
                case Constants.Trees.PartialViewMacros:
                    ...
                    if (viewMacro != null)
                    {
                        var display = _sbnMapper.Map<IPartialView, CodeFileDisplay>(viewMacro);
                ...
                case Constants.Trees.Scripts:
                    ...
                    if (script != null)
                    {
                        var display = _sbnMapper.Map<IScript, CodeFileDisplay>(script);
                ...
                case Constants.Trees.Stylesheets:
                    ...
                    if (stylesheet != null)
                    {
                        var display = _sbnMapper.Map<IStylesheet, CodeFileDisplay>(stylesheet);
        ...
        public ActionResult<CodeFileDisplay> GetScaffold(string type, string id, string snippetName = null)
        {
            ...
            {
                case Constants.Trees.PartialViews:
                    codeFileDisplay = _sbnMapper.Map<IPartialView, CodeFileDisplay>(new PartialView(PartialViewType.PartialView, string.Empty));
                    ...
                    break;
                case Constants.Trees.PartialViewMacros:
                    codeFileDisplay = _sbnMapper.Map<IPartialView, CodeFileDisplay>(new PartialView(PartialViewType.PartialViewMacro, string.Empty));
                    ...
                    break;
                case Constants.Trees.Scripts:
                    codeFileDisplay = _sbnMapper.Map<Script, CodeFileDisplay>(new Script(string.Empty));
                    codeFileDisplay.VirtualPath = _globalSettings.SbnScriptsPath;
                    break;
                case Constants.Trees.Stylesheets:
                    codeFileDisplay = _sbnMapper.Map<Stylesheet, CodeFileDisplay>(new Stylesheet(string.Empty));
                    codeFileDisplay.VirtualPath = _globalSettings.SbnCssPath;
                    break;
                default:
                    return new SbnProblemResult("Unsupported editortype", HttpStatusCode.BadRequest);
            }
        ...
        public IActionResult Delete(string type, string virtualPath)
        {
            ...
            switch (type)
            {
                case Constants.Trees.PartialViews:
                    ...
                    return new SbnProblemResult("No Partial View or folder found with the specified path", HttpStatusCode.NotFound);
                ...
                case Constants.Trees.PartialViewMacros:
                    ...
                    return new SbnProblemResult("No Partial View Macro or folder found with the specified path", HttpStatusCode.NotFound);

                case Constants.Trees.Scripts:
                    if (IsDirectory(_hostingEnvironment.MapPathWebRoot(Path.Combine(_globalSettings.SbnScriptsPath, virtualPath))))
                    {
                    ...
                    return new SbnProblemResult("No Script or folder found with the specified path", HttpStatusCode.NotFound);
                case Constants.Trees.Stylesheets:
                    if (IsDirectory(_hostingEnvironment.MapPathWebRoot(Path.Combine(_globalSettings.SbnCssPath, virtualPath))))
                    {
                    ...
                    return new SbnProblemResult("No Stylesheet found with the specified path", HttpStatusCode.NotFound);
                default:
                    return NotFound();
            }
        }
        ...
        public ActionResult<CodeFileDisplay> PostSave(CodeFileDisplay display)
        {
            ...
            switch (display.FileType)
            {
                case Constants.Trees.PartialViews:
                    ...
                    {
                        display = _sbnMapper.Map(partialViewResult.Result, display);
                ...
                case Constants.Trees.PartialViewMacros:
                    ...
                    {
                        display = _sbnMapper.Map(partialViewMacroResult.Result, display);
                ...
                case Constants.Trees.Scripts:
                    ...
                    display = _sbnMapper.Map(scriptResult, display);
                ...
                case Constants.Trees.Stylesheets:
                    ...
                    display = _sbnMapper.Map(stylesheetResult, display);
        ...
        /// <summary>
        /// Extracts "sbn style rules" from a style sheet
        /// </summary>
        ...
        /// <remarks>
        /// Any "sbn style rules" in the CSS will be removed and replaced with the rules passed in <see cref="data"/>
        /// </remarks>
