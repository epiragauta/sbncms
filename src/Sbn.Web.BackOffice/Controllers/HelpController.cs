...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class HelpController : SbnAuthorizedJsonController
    {
        ...
        public async Task<List<HelpPage>> GetContextHelpForPage(string section, string tree, string baseUrl = "https://our.sbn.com")
        {
            var url = string.Format(baseUrl + "/Sbn/Documentation/Lessons/GetContextHelpDocs?sectionAlias={0}&treeAlias={1}", section, tree);
