...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class UsersController : BackOfficeNotificationsController
    {
        ...
        public ActionResult<UserDisplay> GetById(int id)
        {
            ...
            var result = _sbnMapper.Map<IUser, UserDisplay>(user);
            return result;
        }
        ...
        public ActionResult<IEnumerable<UserDisplay>> GetByIds([FromJsonPath]int[] ids)
        {
            ...
            var result = _sbnMapper.MapEnumerable<IUser, UserDisplay>(users);
            return result;
        }
            ...
            string filter = "")
        {
            ...
            // https://github.com/sbn/Sbn-CMS/blob/dev-v7/src/Sbn.Web/sbn.presentation/sbn/Trees/loadUsers.cs#L91
            ...
            {
                Items = _sbnMapper.MapEnumerable<IUser, UserBasic>(result),
        ...
        public async Task<ActionResult<UserDisplay>> PostCreateUser(UserInvite userSave)
        {
            ...
            user = _sbnMapper.Map(userSave, user);
            ...
            var display = _sbnMapper.Map<UserDisplay>(user);
        ...
        private async Task SendUserInviteEmailAsync(UserBasic userDisplay, string from, string fromEmail, IUser to, string message)
        {
            ...
            var emailSubject = _localizedTextService.Localize("user","inviteEmailCopySubject",
                ...
                SbnUserExtensions.GetUserCulture(to.Language, _localizedTextService, _globalSettings));
        ...
        public ActionResult<UserDisplay> PostSaveUser(UserSave userSave)
        {
            ...
            var user = _sbnMapper.Map(userSave, found);
