...
using ContentType = Sbn.Cms.Core.Models.ContentType;
...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class ContentTypeController : ContentTypeControllerBase<IContentType>
    {
        ...
        public ActionResult<DocumentTypeDisplay> GetById(int id)
        {
            ...
            var dto = _sbnMapper.Map<IContentType, DocumentTypeDisplay>(ct);
            return dto;
        }
        ...
        public ActionResult<DocumentTypeDisplay> GetById(Guid id)
        {
            ...
            var dto = _sbnMapper.Map<IContentType, DocumentTypeDisplay>(contentType);
            return dto;
        }
        ...
        public ActionResult GetAvailableCompositeContentTypes(GetAvailableCompositionsFilter filter)
        {
            var actionResult = PerformGetAvailableCompositeContentTypes(filter.ContentTypeId,
                SbnObjectTypes.DocumentType, filter.FilterContentTypes, filter.FilterPropertyTypes,
                filter.IsElement);
        ...
        {
            var result = PerformGetWhereCompositionIsUsedInContentTypes(filter.ContentTypeId, SbnObjectTypes.DocumentType).Value
                .Select(x => new
                {
                    contentType = x
                });
        ...
        public ActionResult<DocumentTypeDisplay> PostSave(DocumentTypeSave contentTypeSave)
        {
            ...
            var savedCt = PerformPostSave<DocumentTypeDisplay, DocumentTypeSave, PropertyTypeBasic>(
                ...
                beforeCreateNew:    ctSave =>
                {
                    ...
                    if (ctSave.DefaultTemplate.IsNullOrWhiteSpace() == false && ctSave.DefaultTemplate == ctSave.Alias)
                    {
                        ...
                        // For more info: http://issues.sbn.org/issue/U4-11059
            ...
            var display = _sbnMapper.Map<DocumentTypeDisplay>(savedCt.Value);
        ...
        public ActionResult<TemplateDisplay> PostCreateDefaultTemplate(int id)
        {
            ...
            return _sbnMapper.Map<TemplateDisplay>(template);
        }
        ...
        public IEnumerable<ContentTypeBasic> GetAll()
        {
            ...
            var basics = types.Select(_sbnMapper.Map<IContentType, ContentTypeBasic>);
        ...
        public IEnumerable<ContentTypeBasic> GetAllowedChildren(int contentId)
        {
            ...
            var basics = types.Where(type => type.IsElement == false).Select(_sbnMapper.Map<IContentType, ContentTypeBasic>).ToList();

            var localizedTextService = _localizedTextService;
            foreach (var basic in basics)
            {
                basic.Name = localizedTextService.SbnDictionaryTranslate(CultureDictionary, basic.Name);
                basic.Description = localizedTextService.SbnDictionaryTranslate(CultureDictionary, basic.Description);
            }
