...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class MemberGroupController : SbnAuthorizedJsonController
    {
        ...
        public ActionResult<MemberGroupDisplay> GetById(int id)
        {
            ...
            MemberGroupDisplay dto = _sbnMapper.Map<IMemberGroup, MemberGroupDisplay>(memberGroup);
            return dto;
        }
        ...
        public ActionResult<MemberGroupDisplay> GetById(Guid id)
        {
            ...
            return _sbnMapper.Map<IMemberGroup, MemberGroupDisplay>(memberGroup);
        }
        ...
        public IEnumerable<MemberGroupDisplay> GetByIds([FromQuery] int[] ids)
            => _memberGroupService.GetByIds(ids).Select(_sbnMapper.Map<IMemberGroup, MemberGroupDisplay>);
        ...
        public IEnumerable<MemberGroupDisplay> GetAllGroups()
            => _memberGroupService.GetAll()
                    .Select(_sbnMapper.Map<IMemberGroup, MemberGroupDisplay>);

        public MemberGroupDisplay GetEmpty()
        {
            var item = new MemberGroup();
            return _sbnMapper.Map<IMemberGroup, MemberGroupDisplay>(item);
        }
        ...
        public ActionResult<MemberGroupDisplay> PostSave(MemberGroupSave saveModel)
        {
            ...
            MemberGroupDisplay display = _sbnMapper.Map<IMemberGroup, MemberGroupDisplay>(memberGroup);
