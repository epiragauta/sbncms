...
namespace Sbn.Cms.Web.BackOffice.Controllers
{
    ...
    public class CurrentUserController : SbnAuthorizedJsonController
    {
        ...
        public async Task<ActionResult<UserDetail>> PostSetInvitedUserPassword([FromBody]string newPassword)
        {
            ...
            var userDisplay = _sbnMapper.Map<UserDetail>(_backofficeSecurityAccessor.BackOfficeSecurity.CurrentUser);
        ...
        // TODO: Why is this necessary? This inherits from SbnAuthorizedApiController
