...
namespace JsonSchema
{
    class Program
    {
        ...
        {
            [Option('o', "outputFile", Required = false, HelpText = "Set path of the output file.", Default = "../../../../Sbn.Web.UI/sbn/config/appsettings-schema.json")]
        ...
        {
            var generator = new SbnJsonSchemaGenerator();
