...
using SecuritySettings = Sbn.Cms.Core.Configuration.Models.SecuritySettings;

namespace JsonSchema
{
    public class AppSettings
    {
        public SbnDefinition Sbn { get; set; }

        /// <summary>
        /// Configuration of Sbn CMS and packages
        /// </summary>
        public class SbnDefinition
        {
            public CmsDefinition CMS { get; set; }
            public DeployDefinition Deploy { get; set; }

            /// <summary>
            /// Configurations for the Sbn CMS
            /// </summary>
            public class CmsDefinition
            {
                ...
                public SbnPluginSettings Plugins { get; set; }
            ...
            /// <summary>
            /// Configurations for the Sbn Deploy package to Sbn CMS
            /// </summary>
