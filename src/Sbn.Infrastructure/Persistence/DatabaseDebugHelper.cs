...
using System.Text;
using Sbn.Core.Persistence.FaultHandling;

namespace Sbn.Cms.Core.Persistence
{
    internal static class DatabaseDebugHelper
    {
        ...
        {
            if (con.UnwrapSbn() is DbConnection ucon && !(ucon is SqlCeConnection))
                con = ucon;
            else
