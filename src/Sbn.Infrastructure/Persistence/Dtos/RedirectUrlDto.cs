...
{
    [TableName(Cms.Core.Constants.DatabaseSchema.Tables.RedirectUrl)]
    ...
    class RedirectUrlDto
    {
        ...
        [Column("id")]
        [PrimaryKeyColumn(Name = "PK_sbnRedirectUrl", AutoIncrement = false)]
        ...
        [Column("urlHash")]
        [NullSetting(NullSetting = NullSettings.NotNull)]
        [Index(IndexTypes.UniqueNonClustered, Name = "IX_sbnRedirectUrl", ForColumns = "urlHash, contentKey, culture, createDateUtc")]
        [Length(40)]
