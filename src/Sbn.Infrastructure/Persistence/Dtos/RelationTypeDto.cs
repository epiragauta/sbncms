...
namespace Sbn.Cms.Infrastructure.Persistence.Dtos
{
    ...
    internal class RelationTypeDto
    {
        ...
        [Column("typeUniqueId")]
        [Index(IndexTypes.UniqueNonClustered, Name = "IX_sbnRelationType_UniqueId")]
        ...
        [Index(IndexTypes.UniqueNonClustered, Name = "IX_sbnRelationType_name")]
        public string Name { get; set; }

        [Column("alias")]
        [NullSetting(NullSetting = NullSettings.NotNull)]
        [Length(100)]
        [Index(IndexTypes.UniqueNonClustered, Name = "IX_sbnRelationType_alias")]
