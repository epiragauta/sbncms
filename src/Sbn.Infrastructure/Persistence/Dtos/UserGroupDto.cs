...
namespace Sbn.Cms.Infrastructure.Persistence.Dtos
{
    ...
    public class UserGroupDto
    {
        ...
        [Length(200)]
        [Index(IndexTypes.UniqueNonClustered, Name = "IX_sbnUserGroup_userGroupAlias")]
        public string Alias { get; set; }

        [Column("userGroupName")]
        [Length(200)]
        [Index(IndexTypes.UniqueNonClustered, Name = "IX_sbnUserGroup_userGroupName")]
        ...
        [NullSetting(NullSetting = NullSettings.Null)]
        [ForeignKey(typeof(NodeDto), Name = "FK_startContentId_sbnNode_id")]
        public int? StartContentId { get; set; }

        [Column("startMediaId")]
        [NullSetting(NullSetting = NullSettings.Null)]
        [ForeignKey(typeof(NodeDto), Name = "FK_startMediaId_sbnNode_id")]
