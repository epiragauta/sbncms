...
namespace Sbn.Cms.Infrastructure.Persistence.Dtos
{
    ...
    {
        public const string TableName = Cms.Core.Constants.DatabaseSchema.Tables.Node;
        ...
        // NOTE: This index is primarily for the nucache data lookup, see https://github.com/sbn/Sbn-CMS/pull/8365#issuecomment-673404177
        [Column("level")]
