...
namespace Sbn.Extensions
{
    ...
    public static partial class NPocoDatabaseExtensions
    {
        ...
        /// </remarks>
        public static RecordPersistenceType InsertOrUpdate<T>(this ISbnDatabase db, T poco)
            where T : class
        {
        ...
        /// once T1 and T2 have completed. Whereas here, it could contain T1's value.</para>
        /// </remarks>
        public static RecordPersistenceType InsertOrUpdate<T>(this ISbnDatabase db,
            T poco,
