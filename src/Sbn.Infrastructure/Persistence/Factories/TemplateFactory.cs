...
namespace Sbn.Cms.Infrastructure.Persistence.Factories
{
    internal static class TemplateFactory
    {
        ...
        public static Template BuildEntity(IShortStringHelper shortStringHelper, TemplateDto dto, IEnumerable<ISbnEntity> childDefinitions, Func<File, string> getFileContent)
        {
