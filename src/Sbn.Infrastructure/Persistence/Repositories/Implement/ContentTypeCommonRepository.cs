...
namespace Sbn.Cms.Infrastructure.Persistence.Repositories.Implement
{
    ...
    {
        private const string CacheKey = "Sbn.Core.Persistence.Repositories.Implement.ContentTypeCommonRepository::AllTypes";
        ...
        private ISbnDatabase Database => AmbientScope.Database;
