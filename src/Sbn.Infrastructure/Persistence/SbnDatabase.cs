...
namespace Sbn.Cms.Infrastructure.Persistence
{
    ...
    /// <summary>
    /// Extends NPoco Database for Sbn.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Is never created directly but obtained from the <see cref="SbnDatabaseFactory"/>.</para>
    /// </remarks>
    public class SbnDatabase : Database, ISbnDatabase
    {
        private readonly ILogger<SbnDatabase> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SbnDatabase"/> class.
        /// </summary>
        /// <remarks>
        /// <para>Used by SbnDatabaseFactory to create databases.</para>
        ...
        /// <summary>
        /// Returns true if Sbn database tables are detected to be installed
        /// </summary>
        public bool IsSbnInstalled() => ValidateSchema().DetermineHasInstalledVersion();
