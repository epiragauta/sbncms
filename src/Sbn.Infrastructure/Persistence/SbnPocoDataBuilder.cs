...
{
    /// <summary>
    /// Sbn's implementation of NPoco <see cref="PocoDataBuilder"/>.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal class SbnPocoDataBuilder : PocoDataBuilder
    {
        private readonly bool _upgrading;

        public SbnPocoDataBuilder(Type type, MapperCollection mapper, bool upgrading)
            : base(type, mapper)
        {
