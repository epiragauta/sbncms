...
using Sbn.Cms.Infrastructure.Migrations.Notifications;
...
namespace Sbn.Cms.Infrastructure.Migrations.Install
{
    ...
    {
        private readonly ISbnDatabase _database;
        private readonly ILogger<DatabaseSchemaCreator> _logger;
        private readonly ILoggerFactory _loggerFactory;
        private readonly ISbnVersion _sbnVersion;
        private readonly IEventAggregator _eventAggregator;

        public DatabaseSchemaCreator(ISbnDatabase database, ILogger<DatabaseSchemaCreator> logger, ILoggerFactory loggerFactory, ISbnVersion sbnVersion, IEventAggregator eventAggregator)
        {
        ...
        /// <summary>
        /// Drops all Sbn tables in the db.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the database by creating the sbn db schema.
        /// </summary>
        ...
        public void InitializeDatabaseSchema()
        {
            ...
            {
                var dataCreation = new DatabaseDataCreator(_database, _loggerFactory.CreateLogger<DatabaseDataCreator>(), _sbnVersion);
        ...
        /// <remarks>
        /// This does not validate any database constraints that are not PKs or FKs because Sbn does not create a database with non PK/FK constraints.
            ...
            where T : new()
        {
            ...
            CreateTable(overwrite, tableType, new DatabaseDataCreator(_database, _loggerFactory.CreateLogger<DatabaseDataCreator>(), _sbnVersion));
        }
