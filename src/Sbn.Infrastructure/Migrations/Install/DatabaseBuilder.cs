...
namespace Sbn.Cms.Infrastructure.Migrations.Install
{
    ...
    public class DatabaseBuilder
    {
        ...
        /// mean that it is possible to connect, nor that Sbn is installed, nor up-to-date.
        /// </summary>
        ...
        /// It does not necessarily mean that Sbn is installed, nor up-to-date.
        /// </summary>
        ...
        public bool HasSomeNonDefaultUser()
        {
            using (var scope = _scopeProvider.CreateScope())
            {
                ...
                if (has == false)
                {
                    ...
                    result = scope.Database.ExecuteScalar<int>("SELECT COUNT(*) FROM sbnUser");
                    has = result != 1;
                }
                scope.Complete();
                return has;
        ...
        internal bool IsSbnInstalled()
        {
            using (var scope = _scopeProvider.CreateScope(autoComplete: true))
            {
                return scope.Database.IsSbnInstalled();
            }
        }
        ...
        public const string EmbeddedDatabaseConnectionString = @"Data Source=|DataDirectory|\Sbn.sdf;Flush Interval=1";
        ...
        public const string LocalDbConnectionString = @"Data Source=(localdb)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\Sbn.mdf;Integrated Security=True";
        ...
        private void Configure(string connectionString, string providerName, bool installMissingDatabase)
        {
            ...
            var sbnConnectionString = new ConfigConnectionString(Constants.System.SbnConnectionName, connectionString, providerName);
            _connectionStrings.CurrentValue.SbnConnectionString = sbnConnectionString;

            _databaseFactory.Configure(sbnConnectionString.ConnectionString, sbnConnectionString.ProviderName);
        ...
        /// </remarks>
        public Result UpgradeSchemaAndData(SbnPlan plan)
        {
            try
            {
                var readyForInstall = CheckReadyForInstall();
