namespace Sbn.Cms.Infrastructure.Migrations.Upgrade.V_8_6_0
{
    ...
    public class UpdateRelationTypeTable : MigrationBase
    {
        ...
        protected override void Migrate()
        {
            ...
            Alter.Table(Cms.Core.Constants.DatabaseSchema.Tables.RelationType).AlterColumn("childObjectType").AsGuid().Nullable().Do();
            ...
            if (IndexExists("IX_sbnRelationType_alias"))
                Delete
                   .Index("IX_sbnRelationType_alias")
                   .OnTable(Cms.Core.Constants.DatabaseSchema.Tables.RelationType)
                   .Do();
            //change the column to non nullable
            Alter.Table(Cms.Core.Constants.DatabaseSchema.Tables.RelationType).AlterColumn("alias").AsString(100).NotNullable().Do();
            //re-create the index
            Create
                .Index("IX_sbnRelationType_alias")
                .OnTable(Cms.Core.Constants.DatabaseSchema.Tables.RelationType)
