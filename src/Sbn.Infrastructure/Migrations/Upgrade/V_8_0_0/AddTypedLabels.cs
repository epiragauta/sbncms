...
namespace Sbn.Cms.Infrastructure.Migrations.Upgrade.V_8_0_0
{
    public class AddTypedLabels : MigrationBase
    {
        ...
        protected override void Migrate()
        {
            ...
            InsertDataTypeDto(Cms.Core.Constants.DataTypes.LabelInt, "Integer", "{\"sbnDataValueType\":\"INT\"}");
            InsertDataTypeDto(Cms.Core.Constants.DataTypes.LabelBigint, "Nvarchar", "{\"sbnDataValueType\":\"BIGINT\"}");
            InsertDataTypeDto(Cms.Core.Constants.DataTypes.LabelDateTime, "Date", "{\"sbnDataValueType\":\"DATETIME\"}");
            InsertDataTypeDto(Cms.Core.Constants.DataTypes.LabelDecimal, "Decimal", "{\"sbnDataValueType\":\"DECIMAL\"}");
            InsertDataTypeDto(Cms.Core.Constants.DataTypes.LabelTime, "Date", "{\"sbnDataValueType\":\"TIME\"}");
