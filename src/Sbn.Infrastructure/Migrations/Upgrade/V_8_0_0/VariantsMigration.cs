...
INNER JOIN {PreTables.PropertyData} ON {PreTables.ContentVersion}.versionId = {PreTables.PropertyData}.versionId");
        ...
        {
            // Creates a temporary index on sbnPropertyData to speed up other migrations which update property values.
            ...
            Create.Index("IX_sbnPropertyData_Temp").OnTable(PropertyDataDto.TableName)
                .WithOptions().Unique()
...
AND (v1.segment=v2.segment OR (v1.segment IS NULL AND v2.segment IS NULL))");
        ...
        private static class PreTables
        {
            ...
            public const string Lock = "sbnLock";
            public const string Log = "sbnLog";

            public const string Node = "sbnNode";
            ...
            public const string RelationType = "sbnRelationType";
            public const string Relation = "sbnRelation";

            public const string Domain = "sbnDomains";
            public const string Language = "sbnLanguage";
            public const string DictionaryEntry = "cmsDictionary";
            public const string DictionaryValue = "cmsLanguageText";

            public const string User = "sbnUser";
            public const string UserGroup = "sbnUserGroup";
            public const string UserStartNode = "sbnUserStartNode";
            public const string User2UserGroup = "sbnUser2UserGroup";
            public const string User2NodeNotify = "sbnUser2NodeNotify";
            public const string UserGroup2App = "sbnUserGroup2App";
            public const string UserGroup2NodePermission = "sbnUserGroup2NodePermission";
            public const string ExternalLogin = "sbnExternalLogin";
            ...
            public const string Access = "sbnAccess";
            public const string AccessRule = "sbnAccessRule";
            public const string RedirectUrl = "sbnRedirectUrl";

            public const string CacheInstruction = "sbnCacheInstruction";
            public const string Migration = "sbnMigration";
            public const string Server = "sbnServer";
