...
namespace Sbn.Cms.Infrastructure.Migrations.Upgrade
{
    /// <summary>
    /// Represents the Sbn CMS migration plan.
    /// </summary>
    /// <seealso cref="MigrationPlan" />
    public class SbnPlan : MigrationPlan
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SbnPlan" /> class.
        /// </summary>
        /// <param name="sbnVersion">The Sbn version.</param>
        public SbnPlan(ISbnVersion sbnVersion)
            : base(Core.Constants.Conventions.Migrations.SbnUpgradePlanName)
        {
        ...
        public override string InitialState
        {
            get
            {
                var currentVersion = _sbnVersion.SemanticVersion;

                // only from 8.0.0 and above
                var minVersion = new SemVersion(8, 0);
                if (currentVersion < minVersion)
                    throw new InvalidOperationException($"Version {currentVersion} cannot be migrated to {_sbnVersion.SemanticVersion}."
        ...
        public override void ThrowOnUnknownInitialState(string state)
        {
            ...
            {
                throw new InvalidOperationException($"Version {_sbnVersion.SemanticVersion} does not support migrating from {initVersion}."
        ...
        protected void DefinePlan()
        {
            ...
            To<RenameSbnDomainsTable>("{6017F044-8E70-4E10-B2A3-336949692ADD}");
