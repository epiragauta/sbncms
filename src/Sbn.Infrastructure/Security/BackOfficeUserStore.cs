...
namespace Sbn.Cms.Core.Security
{
    ...
    /// </summary>
    public class BackOfficeUserStore : SbnUserStore<BackOfficeIdentityUser, IdentityRole<string>>, IUserSessionStore<BackOfficeIdentityUser>
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Identity Role names are equal to Sbn UserGroup alias.
        /// </remarks>
        ...
        /// <summary>
        /// Overridden to support Sbn's own data storage requirements
        /// </summary>
        /// <remarks>
