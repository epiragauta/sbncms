...
{
    public abstract class SbnErrorDescriberBase : IdentityErrorDescriber
    {
        private readonly ILocalizedTextService _textService;

        protected SbnErrorDescriberBase(ILocalizedTextService textService) => _textService = textService;
