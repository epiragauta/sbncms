...
{
    public class SbnPasswordHasher<TUser> : PasswordHasher<TUser>
        where TUser: SbnIdentityUser
    {
        ...
        public SbnPasswordHasher(LegacyPasswordSecurity legacyPasswordSecurity, IJsonSerializer jsonSerializer)
        {
