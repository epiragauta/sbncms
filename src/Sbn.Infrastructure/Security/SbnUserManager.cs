...
{
    /// <summary>
    /// Abstract class for Sbn User Managers for back office users or front-end members
    /// </summary>
    /// <typeparam name="TUser">The type of user</typeparam>
    /// /// <typeparam name="TPasswordConfig">The type password config</typeparam>
    public abstract class SbnUserManager<TUser, TPasswordConfig> : UserManager<TUser>
        ...
        where TPasswordConfig : class, IPasswordConfiguration, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SbnUserManager{T, TPasswordConfig}"/> class.
        /// </summary>
        public SbnUserManager(
