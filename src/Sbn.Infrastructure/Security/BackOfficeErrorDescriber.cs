...
{
    /// <summary>
    /// Sbn back office specific <see cref="IdentityErrorDescriber"/>
    /// </summary>
    public class BackOfficeErrorDescriber : SbnErrorDescriberBase
    {
    ...
    public class MembersErrorDescriber : SbnErrorDescriberBase
    {
        private readonly ILocalizedTextService _textService;
