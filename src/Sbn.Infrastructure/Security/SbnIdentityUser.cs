...
namespace Sbn.Cms.Core.Security
{
    ...
    /// <summary>
    /// Abstract class for use in Sbn Identity for users and members
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public abstract class SbnIdentityUser : IdentityUser, IRememberBeingDirty
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SbnIdentityUser"/> class.
        /// </summary>
        public SbnIdentityUser()
        {
