...
{
    public abstract class SbnUserStore<TUser, TRole>
    ...
    {
        protected SbnUserStore(IdentityErrorDescriber describer) : base(describer)
        {
        }

        /// <summary>
        /// Not supported in Sbn
        /// </summary>
        /// <inheritdoc />
        ...
        /// <summary>
        /// Not supported in Sbn, see comments above on GetTokenAsync, RemoveTokenAsync, SetTokenAsync
        /// </summary>
        /// <inheritdoc />
        [EditorBrowsable(EditorBrowsableState.Never)]
