...
namespace Sbn.Cms.Infrastructure.ModelsBuilder
{
    ...
    public sealed class SbnServices
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SbnServices"/> class.
        /// </summary>
        public SbnServices(
        ...
        private IList<TypeModel> GetTypes(PublishedItemType itemType, IContentTypeComposition[] contentTypes)
        {
            ...
            foreach (var typeModel in typeModels.Where(x => x.ParentId > 0))
            {
                ...
                // Sbn 7.4 introduces content types containers, so even though ParentId > 0, the parent might
