...
namespace Sbn.Cms.Infrastructure.ModelsBuilder.Building
{
    public class ModelsGenerator
    {
        private readonly SbnServices _sbnService;
        private readonly ModelsBuilderSettings _config;
        private readonly OutOfDateModelsStatus _outOfDateModels;
        private readonly IHostingEnvironment _hostingEnvironment;

        public ModelsGenerator(SbnServices sbnService, IOptions<ModelsBuilderSettings> config, OutOfDateModelsStatus outOfDateModels, IHostingEnvironment hostingEnvironment)
        {
            _sbnService = sbnService;
        ...
        public void GenerateModels()
        {
            ...
            System.Collections.Generic.IList<TypeModel> typeModels = _sbnService.GetAllTypes();
            ...
            ourFiles["models.hash.cs"] = $@"using Sbn.ModelsBuilder;
