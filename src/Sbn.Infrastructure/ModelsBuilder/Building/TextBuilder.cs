...
namespace Sbn.Cms.Infrastructure.ModelsBuilder.Building
{
    ...
    public class TextBuilder : Builder
    {
        ...
        {
            sb.AppendFormat("{0}[global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"Sbn.ModelsBuilder.Embedded\", \"{1}\")]\n", tabs, ApiVersion.Current.Version);
        }
        ...
        private void WriteNonGenericClrType(StringBuilder sb, string s)
        {
            ...
            // so if we want Sbn.Core.Models.IPublishedContent
            // and using Sbn.Core.Models, then we just need IPublishedContent
            typeName = s;
