...
namespace Sbn.Cms.Infrastructure.ModelsBuilder.Building
{
    ...
    public abstract class Builder
    {
        ...
        protected IList<string> TypesUsing { get; } = new List<string>
        {
            ...
            "Sbn.Cms.Core.Models.PublishedContent",
            "Sbn.Cms.Core.PublishedCache",
            "Sbn.Cms.Infrastructure.ModelsBuilder",
            "Sbn.Cms.Core",
            "Sbn.Extensions"
        };
        ...
        // looking for a simple symbol eg 'Sbn' or 'String'
        // expecting to match eg 'Sbn' or 'System.String'
