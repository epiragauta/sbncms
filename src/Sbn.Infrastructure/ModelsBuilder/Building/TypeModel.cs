...
namespace Sbn.Cms.Infrastructure.ModelsBuilder.Building
{
    ...
    public class TypeModel
    {
        ...
        /// </remarks>
        public TypeModel BaseType; // the parent type in Sbn (type inherits its properties)
        ...
        /// </summary>
        /// <remarks>Can be either because the content type has a base content type declared in Sbn,
