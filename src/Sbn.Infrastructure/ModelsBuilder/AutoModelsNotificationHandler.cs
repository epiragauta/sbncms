...
namespace Sbn.Cms.Infrastructure.ModelsBuilder
{
    ...
    /// </remarks>
    public sealed class AutoModelsNotificationHandler : INotificationHandler<SbnApplicationStartingNotification>,
        INotificationHandler<SbnRequestEndNotification>,
        ...
        INotificationHandler<DataTypeCacheRefresherNotification>
    {
        ...
        /// <summary>
        /// Handles the <see cref="SbnApplicationStartingNotification"/> notification
        /// </summary>
        public void Handle(SbnApplicationStartingNotification notification) => Install();
        ...
        public void Handle(SbnRequestEndNotification notification)
        {
