...
namespace Sbn.Cms.Infrastructure.DependencyInjection
{
    public static partial class SbnBuilderExtensions
    {
        ...
        /// Adds Sbn services
        /// </summary>
        internal static ISbnBuilder AddServices(this ISbnBuilder builder)
        {
        ...
        private static LocalizedTextServiceFileSources SourcesFactory(IServiceProvider container)
        {
            ...
            var mainLangFolder = new DirectoryInfo(hostingEnvironment.MapPathContentRoot(WebPath.Combine(Constants.SystemDirectories.Sbn, "config", "lang")));
