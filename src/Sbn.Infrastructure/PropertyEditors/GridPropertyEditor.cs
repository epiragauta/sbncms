    ...
    public class GridPropertyEditor : DataEditor
    {
        ...
        internal class GridPropertyValueEditor : DataValueEditor, IDataValueReference
        {
            ...
            public IEnumerable<SbnEntityReference> GetReferences(object value)
            {
                ...
                foreach (var sbnEntityReference in richTextEditorValues.SelectMany(x =>
                    _richTextPropertyValueEditor.GetReferences(x.Value)))
                    yield return sbnEntityReference;

                foreach (var sbnEntityReference in mediaValues.Where(x=>x.Value.HasValues)
