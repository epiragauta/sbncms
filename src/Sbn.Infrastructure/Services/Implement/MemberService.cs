...
namespace Sbn.Cms.Core.Services.Implement
{
    ...
    public class MemberService : RepositoryService, IMemberService
    {
        ...
        private void Audit(AuditType type, int userId, int objectId, string message = null) => _auditRepository.Save(new AuditItem(objectId, type, userId, ObjectTypes.GetName(SbnObjectTypes.Member), message));
