...
namespace Sbn.Cms.Core.Services.Implement
{
    public class NotificationService : INotificationService
    {
        ...
        {
            // Regarding this: http://issues.sbn.org/issue/U4-5180
            ...
            Func<(IUser user, NotificationEmailBodyParams body, bool isHtml), string> createBody)
        {
            ...
            var subjectVars = new NotificationEmailSubjectParams(
                string.Concat(siteUri.Authority, _ioHelper.ResolveUrl(_globalSettings.SbnPath)),
                actionName,
                content.Name);
            ...
            var bodyVars = new NotificationEmailBodyParams(
                ...
                string.Format("{2}://{0}/{1}",
                    ...
                    /*sbn.library.NiceUrl(documentObject.Id))*/
