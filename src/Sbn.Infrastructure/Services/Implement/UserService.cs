...
namespace Sbn.Cms.Core.Services.Implement
{
    ...
    internal class UserService : RepositoryService, IUserService
    {
        ...
        public IUser GetByUsername(string username)
        {
            using (var scope = ScopeProvider.CreateScope(autoComplete: true))
            {
                ...
                catch (DbException)
                {
                    ...
                    // so we need to do it differently, see the custom SbnPocoDataBuilder which should
        ...
        /// <summary>
        /// This performs the calculations for inherited nodes based on this http://issues.sbn.org/issue/U4-10075#comment=67-40085
        /// </summary>
