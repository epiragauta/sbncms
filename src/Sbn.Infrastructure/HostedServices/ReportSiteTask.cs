...
namespace Sbn.Cms.Infrastructure.HostedServices
{
    public class ReportSiteTask : RecurringHostedServiceBase
    {
        ...
        {
            // Try & get a value stored in sbnSettings.config on the backoffice XML element ID attribute
            ...
            try
            {
                ...
                if (s_httpClient.BaseAddress is null)
                {
                    ...
                    s_httpClient.BaseAddress = new Uri("https://telemetry.sbn.com/");
                ...
                {
                    var postData = new TelemetryReportData { Id = telemetrySiteIdentifier, Version = _sbnVersion.SemanticVersion.ToSemanticStringWithoutBuild() };
                    ...
                    // https://telemetry.sbn.com/installs/
            ...
            catch
            {
                ...
                _logger.LogDebug("There was a problem sending a request to the Sbn telemetry service");
            }
        }
        [DataContract]
