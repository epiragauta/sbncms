...
namespace Sbn.Cms.Core.Mapping
{
    ...
    /// </remarks>
    public class SbnMapper : ISbnMapper
    {
        // note
        //
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SbnMapper"/> class.
        /// </summary>
        /// <param name="profiles"></param>
        /// <param name="scopeProvider"></param>
        public SbnMapper(MapDefinitionCollection profiles, IScopeProvider scopeProvider)
        {
