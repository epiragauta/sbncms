...
namespace Sbn.Cms.Core
{
    ...
    public interface IPublishedContentQuery
    {
        ...
        /// <param name="indexName">The name of the index to search (defaults to <see cref="Constants.SbnIndexes.ExternalIndexName" />).</param>
        ...
        /// </remarks>
        IEnumerable<PublishedSearchResult> Search(string term, int skip, int take, out long totalRecords, string culture = "*", string indexName = Constants.SbnIndexes.ExternalIndexName, ISet<string> loadedFields = null);
        ...
        /// <param name="term">The term to search.</param>
        /// <param name="culture">The culture (defaults to a culture insensitive search).</param>
        /// <param name="indexName">The name of the index to search (defaults to <see cref="Cms.Core.Constants.SbnIndexes.ExternalIndexName" />).</param>
        /// <returns>
        /// The search results.
        /// </returns>
        /// <remarks>
        ...
        /// <para>While enumerating results, the ambient culture is changed to be the searched culture.</para>
        /// </remarks>
        IEnumerable<PublishedSearchResult> Search(string term, string culture = "*", string indexName = Constants.SbnIndexes.ExternalIndexName);
