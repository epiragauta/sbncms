...
namespace Sbn.Cms.Infrastructure.WebAssets
{
    ...
    public class BackOfficeJavaScriptInitializer
    {
        ...
        public static string GetJavascriptInitialization(IEnumerable<string> scripts, string angularModule, GlobalSettings globalSettings, IHostingEnvironment hostingEnvironment)
        {
            ...
            return WriteScript(jarray.ToString(), hostingEnvironment.ToAbsolute(globalSettings.SbnPath), angularModule);
        }
        ...
        /// </summary>
        /// <param name="scripts"></param>
        /// <param name="sbnPath"></param>
        /// <param name="angularModule"></param>
        /// <returns></returns>
        internal static string WriteScript(string scripts, string sbnPath, string angularModule)
        {
            var count = 0;
            var replacements = new[] { scripts, sbnPath, angularModule };
