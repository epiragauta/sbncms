...
namespace Sbn.Cms.Infrastructure.Install.InstallSteps
{
    [InstallSetupStep(InstallationType.NewInstall,
        "DatabaseConfigure", "database", 10, "Setting up a database, so Sbn has a place to store your website",
    ...
    public class DatabaseConfigureStep : InstallSetupStep<DatabaseModel>
    {
        ...
        public static bool IsSqlCeAvailable() =>
            ...
            !(Type.GetType("Sbn.Cms.Persistence.SqlCe.SqlCeSyntaxProvider, Sbn.Persistence.SqlCe") is null);
