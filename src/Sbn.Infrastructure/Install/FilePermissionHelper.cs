...
namespace Sbn.Cms.Infrastructure.Install
{
    ...
    {
        // ensure that these directories exist and Sbn can write to them
        private readonly string[] _permissionDirs;
        private readonly string[] _packagesPermissionsDirs;

        // ensure Sbn can write to these files (the directories must exist)
        ...
        public FilePermissionHelper(IOptions<GlobalSettings> globalSettings, IIOHelper ioHelper, IHostingEnvironment hostingEnvironment)
        {
            ...
            _permissionDirs = new[]
            {
                hostingEnvironment.MapPathWebRoot(_globalSettings.SbnCssPath),
                ...
                hostingEnvironment.MapPathWebRoot(_globalSettings.SbnMediaPath),
            ...
            _packagesPermissionsDirs = new[]
            {
                ...
                hostingEnvironment.MapPathContentRoot(Constants.SystemDirectories.Sbn),
                hostingEnvironment.MapPathWebRoot(_globalSettings.SbnPath),
        ...
        public bool RunFilePermissionTestSuite(out Dictionary<FilePermissionTest, IEnumerable<string>> report)
        {
            ...
            EnsureCanCreateSubDirectory(_hostingEnvironment.MapPathWebRoot(_globalSettings.SbnMediaPath), out errors);
        ...
        private bool TryAccessDirectory(string dirPath, bool canWrite)
        {
            try
            {
                ...
                if (canWrite)
                {
                    ...
                    File.WriteAllText(filePath, "This is an Sbn internal test file. It is safe to delete it.");
