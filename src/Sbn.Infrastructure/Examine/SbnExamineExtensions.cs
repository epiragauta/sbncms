...
{
    public static class SbnExamineExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static IEnumerable<string> GetCultureFields(this ISbnIndex index, string culture)
        {
        ...
        /// <param name="culture"></param>
        /// <returns></returns>
        public static IEnumerable<string> GetCultureAndInvariantFields(this ISbnIndex index, string culture)
        {
            IEnumerable<string> allFields = index.GetFieldNames();
        ...
        {
            var fieldQuery = query.Field(SbnExamineFieldNames.NodeNameFieldName, (IExamineValue)new ExamineValue(Examineness.Explicit, nodeName));
            return fieldQuery;
        }
        ...
        {
            var fieldQuery = query.Field(SbnExamineFieldNames.NodeNameFieldName, nodeName);
            return fieldQuery;
        }
