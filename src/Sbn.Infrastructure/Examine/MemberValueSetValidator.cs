...
namespace Sbn.Cms.Infrastructure.Examine
{
    public class MemberValueSetValidator : ValueSetValidator
    {
        ...
        /// </summary>
        public static readonly string[] DefaultMemberIndexFields = { "id", SbnExamineFieldNames.NodeNameFieldName, "updateDate", "loginName", "email", SbnExamineFieldNames.NodeKeyFieldName };
