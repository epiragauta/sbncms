...
namespace Sbn.Cms.Infrastructure.Examine
{
    ...
    /// </summary>
    public class ContentIndexPopulator : IndexPopulator<ISbnContentIndex>
    {
        ...
        private IQuery<IContent> PublishedQuery => _publishedQuery ??= _sbnDatabaseFactory.SqlContext.Query<IContent>().Where(x => x.Published);
        ...
        public ContentIndexPopulator(
            ...
            : this(logger, false, null, contentService, sbnDatabaseFactory, contentValueSetBuilder)
        {
        }
            ...
            IValueSetBuilder<IContent> contentValueSetBuilder)
        {
            ...
            _sbnDatabaseFactory = sbnDatabaseFactory ?? throw new ArgumentNullException(nameof(sbnDatabaseFactory));
        ...
        public override bool IsRegistered(ISbnContentIndex index)
        {
