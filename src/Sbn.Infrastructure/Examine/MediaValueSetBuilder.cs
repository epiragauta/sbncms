        ...
        public override IEnumerable<ValueSet> GetValueSets(params IMedia[] media)
        {
            foreach (IMedia m in media)
            {
                ...
                var values = new Dictionary<string, IEnumerable<object>>
                {
                    ...
                    {"id", new object[] {m.Id}},
                    {SbnExamineFieldNames.NodeKeyFieldName, new object[] {m.Key}},
                    ...
                    {SbnExamineFieldNames.NodeNameFieldName, m.Name?.Yield() ?? Enumerable.Empty<string>()},
                    ...
                    {SbnExamineFieldNames.SbnFileFieldName, mediaFiles}
                };
