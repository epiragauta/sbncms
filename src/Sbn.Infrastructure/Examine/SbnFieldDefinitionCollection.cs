...
namespace Sbn.Cms.Infrastructure.Examine
{
    ...
    /// </summary>
    public class SbnFieldDefinitionCollection : FieldDefinitionCollection
    {

        public SbnFieldDefinitionCollection()
            : base(SbnIndexFieldDefinitions)
        {
        }

        /// <summary>
        /// A type that defines the type of index for each Sbn field (non user defined fields)
        /// Alot of standard sbn fields shouldn't be tokenized or even indexed, just stored into lucene
        /// for retreival after searching.
        /// </summary>
        public static readonly FieldDefinition[] SbnIndexFieldDefinitions =
        {
            ...
            new FieldDefinition(SbnExamineFieldNames.NodeKeyFieldName, FieldDefinitionTypes.InvariantCultureIgnoreCase),
            ...
            new FieldDefinition(SbnExamineFieldNames.PublishedFieldName, FieldDefinitionTypes.Raw),
            new FieldDefinition(SbnExamineFieldNames.IndexPathFieldName, FieldDefinitionTypes.Raw),
            new FieldDefinition(SbnExamineFieldNames.IconFieldName, FieldDefinitionTypes.Raw),
            new FieldDefinition(SbnExamineFieldNames.VariesByCultureFieldName, FieldDefinitionTypes.Raw),
        };
        ...
        public override bool TryGetValue(string fieldName, out FieldDefinition fieldDefinition)
        {
            ...
            var match = SbnExamineExtensions.CultureIsoCodeFieldNameMatchExpression.Match(fieldName);
            if (match.Success)
            {
