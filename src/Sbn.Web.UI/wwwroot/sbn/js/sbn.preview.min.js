(function () {
    ...
    /*********************************************************************************************************/
    var app = angular.module('sbn.preview', [
        'sbn.resources',
        'sbn.services'
        ...
        function configureSignalR(iframe) {
            ...
            if ($.connection && $.connection.connectionState === signalR.HubConnectionState.Connected)
                return;
            $.connection = new signalR.HubConnectionBuilder().withUrl(Sbn.Sys.ServerVariables.sbnUrls.previewHubUrl).withAutomaticReconnect().configureLogging(signalR.LogLevel.Warning).build();
        ...
        function checkPreviewState() {
            if (getCookie('UMB_PREVIEW') === null) {
                ...
                modal.innerHTML = '<div class="sbn-preview-dialog__headline">'.concat(umbLocalizedVars.returnToPreviewHeadline, '</div>\n                    <div class="sbn-preview-dialog__question">').concat(umbLocalizedVars.returnToPreviewDescription, '</div>');
