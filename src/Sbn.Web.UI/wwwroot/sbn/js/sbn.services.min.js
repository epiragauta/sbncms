 ...
 * </pre>
 */
    angular.module('sbn.services').factory('assetsService', function ($q, $log, angularHelper, umbRequestHelper, $rootScope, $http, userService, javascriptLibraryResource) {
        ...
        return {
            ...
            registerGenericTab: function registerGenericTab(groups) {
                ...
                var isRootGroup = function isRootGroup(group) {
                    return group.type === contentTypeHelper.TYPE_GROUP && group.parentAlias === null;
                };
        ...
        function hasDenyLocalLogin(provider) {
            if (!provider) {
                return _.some(externalLoginInfo.providers, function (x) {
                    return x.properties && x.properties.DenyLocalLogin === true;
                });
            } else {
 ...
 */
    ...
    */
    ...
    'use strict';
    angular.module('sbn.services').factory('gridService', function ($http, $q) {
    ...
    'use strict';
    angular.module('sbn.services').factory('helpService', function ($http, $q, umbRequestHelper, dashboardResource) {
        var helpTopics = {};
 ...
 * </pre> 
 */
    angular.module('sbn.services').factory('historyService', function ($rootScope, $timeout, angularHelper, eventsService) {
        var nArray = [];
        function _add(item) {
            if (!item) {
                return null;
  ...
  */
   ...
   */
        function init() {
            ...
            $http({
                method: 'GET',
                url: Sbn.Sys.ServerVariables.sbnUrls.iconApiBaseUrl + 'GetIcons'
...
**/
    ...
    angular.module('sbn.services').factory('keyboardService', [
        '$window',
        '$timeout',
        keyboardService
    ]);
 ...
 * </pre>
 */
    angular.module('sbn.services').factory('localizationService', function ($http, $q, eventsService) {
      ...
      */
            getTreeTemplateUrl: function getTreeTemplateUrl(treeAlias, action) {
                ...
                if (packageTreeFolder) {
                    return Sbn.Sys.ServerVariables.sbnSettings.appPluginsPath + '/' + packageTreeFolder + '/backoffice/' + treeAlias + '/' + action + '.html';
                } else {
 ...
 * </pre>
 */
    angular.module('sbn.services').factory('notificationsService', function ($rootScope, $timeout, angularHelper) {
        var nArray = [];
    ...
    (function () {
        ...
        function platformService() {
            ...
            function getBrowserInfo() {
                var data = matchUserAgent(navigator.userAgent);
                console.log(data);
                if (data) {
                    var test = data[1];
                    return {
            ...
            function matchUserAgent(ua) {
                return ua !== '' && userAgentRules.reduce(function (matched, _ref) {
                    var _ref2 = _slicedToArray(_ref, 2), browser = _ref2[0], regex = _ref2[1];
                    if (matched) {
                        return matched;
                    }
 ...
 * </pre>
 */
    angular.module('sbn.services').factory('searchService', function (entityResource, $injector, searchResultFormatter) {
        return {
            /**
    * @ngdoc method
        ...
        function templateHelperService(localizationService) {
            ...
            function getTemplateEditorShortcuts() {
                ...
                return localizationService.localizeMany(keys).then(function (data) {
                    ...
                    return {
                        'name': 'Sbn',
                        //No need to localise Sbn is the same in all languages :)
                        'shortcuts': [
                            {
   ...
   */
        function getStyles(configuredStylesheets) {
            ...
            return $q.all(promises).then(function () {
                ...
                stylesheets.push(''.concat(Sbn.Sys.ServerVariables.sbnSettings.sbnPath, '/assets/css/rte-content.css'));
                return $q.when({
   ...
   */
     ...
     */
            getTinyMceEditorConfig: function getTinyMceEditorConfig(args) {
                ...
                tinymce.baseURL = Sbn.Sys.ServerVariables.sbnSettings.sbnPath + '/lib/tinymce/';
 ...
 */
     ...
     */
            getTreePackageFolder: function getTreePackageFolder(treeAlias) {
                ...
                if (Sbn.Sys.ServerVariables.sbnPlugins && Sbn.Sys.ServerVariables.sbnPlugins.trees && Utilities.isArray(Sbn.Sys.ServerVariables.sbnPlugins.trees)) {
...
**/
     ...
     */
            getApiUrl: function getApiUrl(apiName, actionName, queryStrings) {
                ...
                return Sbn.Sys.ServerVariables['sbnUrls'][apiName] + actionName + (!queryStrings ? '' : '?' + (Utilities.isString(queryStrings) ? queryStrings : this.dictionaryToQueryString(queryStrings)));
            },
            /**
     * @ngdoc function
...
**/
    ...
    'use strict';
    angular.module('sbn.services').factory('userService', function ($rootScope, eventsService, $q, $location, $window, requestRetryQueue, authResource, emailMarketingResource, $timeout, angularHelper) {
