(function () {
    ...
    (function () {
        ...
        function createAskUserAboutVersionDialog(jsonLocalization) {
            ...
            modal.innerHTML = '<div class="sbn-preview-dialog__headline">'.concat(umbLocalizedVars.preview.viewPublishedContentHeadline, '</div>\n            <div class="sbn-preview-dialog__question">').concat(umbLocalizedVars.preview.viewPublishedContentDescription, '</div>');
