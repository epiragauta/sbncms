(function () {
    ...
    angular.module('sbn.filters').filter('compareArrays', function () {
...
**/
    ...
    'use strict';
    angular.module('sbn.filters').filter('safe_html', [
        '$sce',
        function ($sce) {
            return function (text) {
 ...
 */
    angular.module('sbn.filters').filter('truncate', function () {
