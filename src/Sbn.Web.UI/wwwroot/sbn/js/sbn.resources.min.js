 ...
 **/
    ...
    */
     ...
     */
            ...
            getBlueprintScaffold: function getBlueprintScaffold(parentId, blueprintId) {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('contentApiBaseUrl', 'GetEmptyBlueprint', {
    ...
    */
            ...
            allowsCultureVariation: function allowsCultureVariation() {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('contentTypeApiBaseUrl', 'AllowsCultureVariation')), 'Failed to retrieve variant content types');
            }
        };
    }
    ...
    function currentUserResource($q, $http, umbRequestHelper, umbDataFormatter) {
      ...
      */
            ...
            getUserData: function getUserData() {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('currentUserApiBaseUrl', 'GetUserData')), 'Server call failed for getting current user data');
            },
 ...
 **/
    function emailMarketingResource($http, umbRequestHelper) {
        ...
        var emailApiUrl = 'https://emailcollector.sbn.io/api/EmailProxy';
        //the factory object returned
        return {
 ...
 */
     ...
     */
            function getAllChecks() {
                return umbRequestHelper.resourcePromise($http.get(Sbn.Sys.ServerVariables.sbnUrls.healthCheckBaseUrl + 'GetAllHealthChecks'), 'Failed to retrieve health checks');
            }
            /**
     * @ngdoc function
     ...
     */
            function getStatus(id) {
                return umbRequestHelper.resourcePromise($http.get(Sbn.Sys.ServerVariables.sbnUrls.healthCheckBaseUrl + 'GetStatus?id=' + id), 'Failed to retrieve status for health check with ID ' + id);
            }
            /**
     * @ngdoc function
     ...
     */
            function executeAction(action) {
                return umbRequestHelper.resourcePromise($http.post(Sbn.Sys.ServerVariables.sbnUrls.healthCheckBaseUrl + 'ExecuteAction', action), 'Failed to execute action with alias ' + action.alias + ' and healthCheckId + ' + action.healthCheckId);
            }
            var resource = {
    ...
    function memberTypeResource($q, $http, umbRequestHelper, umbDataFormatter, localizationService) {
        return {
            ...
            getTypes: function getTypes() {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('memberTypeQueryApiBaseUrl', 'GetAllTypes')), 'Failed to retrieve data for member types id');
            },
            getById: function getById(id) {
...
**/
    ...
    */
    ...
    'use strict';
    angular.module('sbn.resources').factory('Sbn.PropertyEditors.NestedContent.Resources', function ($q, $http, umbRequestHelper) {
        return {
    ...
    function ourPackageRepositoryResource($q, $http, umbDataFormatter, umbRequestHelper) {
        ...
        return {
            getDetails: function getDetails(packageId) {
                return umbRequestHelper.resourcePromise($http.get(baseurl + '/' + packageId + '?version=' + Sbn.Sys.ServerVariables.application.version), 'Failed to get package details');
            },
            ...
            getPopular: function getPopular(maxResults, category) {
                ...
                return umbRequestHelper.resourcePromise($http.get(baseurl + '?pageIndex=0&pageSize=' + maxResults + '&category=' + category + '&order=Popular&version=' + Sbn.Sys.ServerVariables.application.version), 'Failed to query packages');
            },
            search: function search(pageIndex, pageSize, orderBy, category, query, canceler) {
                ...
                return umbRequestHelper.resourcePromise($http.get(baseurl + '?pageIndex=' + pageIndex + '&pageSize=' + pageSize + '&category=' + category + '&query=' + query + order + '&version=' + Sbn.Sys.ServerVariables.application.version), httpConfig, 'Failed to query packages');
            }
        };
    }
    ...
    **/
     ...
     */
            ...
            runMigrations: function runMigrations(packageName) {
                return umbRequestHelper.resourcePromise($http.post(umbRequestHelper.getApiUrl('packageApiBaseUrl', 'RunMigrations', { packageName: packageName })), 'Failed to run migrations for package');
            },
            /**
     * @ngdoc method
     ...
     */
            ...
            getInstalledByName: function getInstalledByName(packageName) {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('packageApiBaseUrl', 'GetInstalledPackageByName', { packageName: packageName })), 'Failed to get package');
            },
    ...
    function publicAccessResource($http, umbRequestHelper) {
      ...
      */
            getPublicAccess: function getPublicAccess(contentId) {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('publicAccessApiBaseUrl', 'GetPublicAccess', { contentId: contentId })), 'Failed to get public access for content item with id ' + contentId);
            },
            /**
      * @ngdoc method
      ...
      */
            updatePublicAccess: function updatePublicAccess(contentId, groups, usernames, loginPageId, errorPageId) {
                ...
                return umbRequestHelper.resourcePromise($http.post(umbRequestHelper.getApiUrl('publicAccessApiBaseUrl', 'PostPublicAccess', publicAccess)), 'Failed to update public access for content item with id ' + contentId);
            },
            /**
      * @ngdoc method
      ...
      */
            removePublicAccess: function removePublicAccess(contentId) {
                return umbRequestHelper.resourcePromise($http.post(umbRequestHelper.getApiUrl('publicAccessApiBaseUrl', 'RemovePublicAccess', { contentId: contentId })), 'Failed to remove public access for content item with id ' + contentId);
            }
        };
    }
