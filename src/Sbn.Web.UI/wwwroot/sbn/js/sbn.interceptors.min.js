(function () {
    'use strict';
    angular.module('sbn.interceptors', [])    // We have to add the interceptor to the queue as a string because the interceptor depends upon service instances that are not available in the config block.
.config([
        '$httpProvider',
