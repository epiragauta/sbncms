(function () {
    'use strict';
    angular.module('sbn.install', ['sbn.directives']);
    'use strict';
    angular.module('sbn.install').controller('Sbn.InstallerController', function ($scope, installerService) {
    ...
    angular.module('sbn.install').factory('installerService', function ($rootScope, $q, $timeout, $http, $templateRequest) {
        ...
        var facts = [
            'Sbn helped millions of people watch a man jump from the edge of space',
       ...
       */
            ...
            install: function install() {
                ...
                function processInstallStep() {
                    $http.post(Sbn.Sys.ServerVariables.installApiBaseUrl + 'PostPerformInstall', _installerModel).then(function (response) {
            ...
            complete: function complete() {
                $http.post(Sbn.Sys.ServerVariables.installApiBaseUrl + 'CompleteInstall', _installerModel).then(function () {
    ...
    angular.module('sbn.install').controller('Sbn.Installer.DataBaseController', function ($scope, $http, installerService) {
        ...
        $scope.validateAndForward = function () {
            if (!$scope.checking && this.myForm.$valid) {
                ...
                $http.post(Sbn.Sys.ServerVariables.installApiBaseUrl + 'PostValidateDatabaseConnection', model).then(function (response) {
