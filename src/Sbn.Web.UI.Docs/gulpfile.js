...
var config = require('../Sbn.Web.UI.Client/gulp/config');
...
var documentationFiles = ['../Sbn.Web.UI.Client/src/common/**/*.js', './src/api/**/*.ngdoc'];
...
gulp.task('docs', [], function (cb) {
    ...
    var options = {
        html5Mode: false,
        startPage: '/api',
        title: "Sbn 9 Backoffice UI API Documentation",
        dest: './api',
        styles: ['./umb-docs.css'],
        image: "https://our.sbn.com/assets/images/logo.svg"
    }
