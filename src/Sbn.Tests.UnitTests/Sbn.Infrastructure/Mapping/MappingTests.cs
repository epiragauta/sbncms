...
using PropertyCollection = Sbn.Cms.Core.Models.PropertyCollection;

namespace Sbn.Cms.Tests.UnitTests.Sbn.Infrastructure.Mapping
{
    [TestFixture]
    public class MappingTests
    {
        ...
        public void SimpleMap()
        {
            ...
            var mapper = new SbnMapper(definitions, _scopeProvider);
        ...
        {
            public void DefineMaps(ISbnMapper mapper) => mapper.Define<Thing1, Thing2>((source, context) => new Thing2(), Map);
        ...
        private class MapperDefinition3 : IMapDefinition
        {
            public void DefineMaps(ISbnMapper mapper)
            {
                ...
                mapper.Define<SbnMapper, object>();
