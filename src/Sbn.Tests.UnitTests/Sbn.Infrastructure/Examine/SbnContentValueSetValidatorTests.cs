...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Infrastructure.Examine
{
    [TestFixture]
    public class SbnContentValueSetValidatorTests
    {
        [Test]
        ...
        public void Recycle_Bin_Content()
        {
            ...
            result = validator.Validate(new ValueSet(
                ...
                new Dictionary<string, object>
                {
                    ["hello"] = "world",
                    ["path"] = "-1,555",
                    [SbnExamineFieldNames.PublishedFieldName] = "y"
                }));
            Assert.AreEqual(ValueSetValidationResult.Valid, result);
        }
        ...
        public void Published_Only()
        {
            ...
            result = validator.Validate(new ValueSet(
                ...
                new Dictionary<string, object>
                {
                    ["hello"] = "world",
                    ["path"] = "-1,555",
                    [SbnExamineFieldNames.PublishedFieldName] = "n"
                }));
            Assert.AreEqual(ValueSetValidationResult.Failed, result);
        ...
        public void Published_Only_With_Variants()
        {
            ...
            var valueSet = new ValueSet(
                ...
                new Dictionary<string, object>
                {
                    ...
                    ["path"] = "-1,555",
                    [SbnExamineFieldNames.VariesByCultureFieldName] = "y",
                    [$"{SbnExamineFieldNames.PublishedFieldName}_en-us"] = "y",
                    ["hello_en-us"] = "world",
                    ["title_en-us"] = "my title",
                    [$"{SbnExamineFieldNames.PublishedFieldName}_es-es"] = "n",
                    ["hello_es-ES"] = "world",
                    ["title_es-ES"] = "my title",
                    [SbnExamineFieldNames.PublishedFieldName] = "y"
                });
            Assert.AreEqual(10, valueSet.Values.Count());
            Assert.IsTrue(valueSet.Values.ContainsKey($"{SbnExamineFieldNames.PublishedFieldName}_es-es"));
            ...
            Assert.IsFalse(valueSet.Values.ContainsKey($"{SbnExamineFieldNames.PublishedFieldName}_es-es"));
