...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.BackOffice
{
    [TestFixture]
    public class BackOfficeClaimsPrincipalFactoryTests
    {
        ...
        public async Task CreateAsync_Should_Create_Principal_With_Claims_Identity()
        {
            ...
            var sbnBackOfficeIdentity = claimsPrincipal.Identity as ClaimsIdentity;
            Assert.IsNotNull(sbnBackOfficeIdentity);
        }
        ...
        public async Task CreateAsync_Should_Include_Claim(string expectedClaimType, object expectedClaimValue)
        {
            ...
            Assert.True(claimsPrincipal.GetSbnIdentity().HasClaim(expectedClaimType, expectedClaimValue.ToString()));
        }
        ...
        public async Task CreateAsync_When_SecurityStamp_Supported_Expect_SecurityStamp_Claim()
        {
            ...
            Assert.True(claimsPrincipal.GetSbnIdentity().HasClaim(expectedClaimType, expectedClaimValue));
        }

        [Test]
        public async Task CreateAsync_When_Roles_Supported_Expect_Role_Claims_In_SbnIdentity()
        {
