...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Infrastructure.Persistence.Querying
{
    ...
    public class ExpressionTests : BaseUsingSqlSyntax
    {
        ...
        public void CachedExpression_Can_Verify_Path_StartsWith_Predicate_In_Same_Result()
        {
            ...
            Assert.AreEqual("upper([sbnNode].[path]) LIKE upper(@0)", result1);
            ...
            Assert.AreEqual("upper([sbnNode].[path]) LIKE upper(@0)", result2);
        ...
        public void Can_Verify_Path_StartsWith_Predicate_In_Same_Result()
        {
            ...
            Assert.AreEqual("upper([sbnNode].[path]) LIKE upper(@0)", result);
        ...
        public void Can_Verify_ParentId_StartsWith_Predicate_In_Same_Result()
        {
            ...
            Assert.AreEqual("([sbnNode].[parentId] = @0)", result);
            Assert.AreEqual(-1, modelToSqlExpressionHelper.GetSqlParameters()[0]);
        }
        ...
        public void Equals_Operator_For_Value_Gets_Escaped()
        {
            ...
            Assert.AreEqual("([sbnUser].[userLogin] = @0)", result);
        ...
        public void Equals_Method_For_Value_Gets_Escaped()
        {
            ...
            Assert.AreEqual("upper([sbnUser].[userLogin]) = upper(@0)", result);
            Assert.AreEqual("hello@world.com", modelToSqlExpressionHelper.GetSqlParameters()[0]);
        }
        ...
        public void Sql_Replace_Mapped()
        {
            ...
            Assert.AreEqual("(replace([sbnUser].[userLogin], @1, @2) = @0)", result);
        ...
        public void Sql_In()
        {
            ...
            Assert.AreEqual("[sbnUser].[userLogin] IN (@1,@2)", result);
        ...
        public void StartsWith()
        {
            ...
            Assert.AreEqual("upper([sbnUser].[userLogin]) LIKE upper(@0)", result);
