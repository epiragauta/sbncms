...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Infrastructure.Persistence.NPocoTests
{
    [TestFixture]
    public class NPocoSqlTests : BaseUsingSqlSyntax
    {
        ...
        public void Where_Clause_With_Starts_With_Additional_Parameters()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (upper([sbnNode].[path]) LIKE upper(@0))", sql.SQL.Replace("\n", " "));
        ...
        public void Where_Clause_With_Starts_With_By_Variable()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE ((upper([sbnNode].[path]) LIKE upper(@0) AND ([sbnNode].[id] <> @1)))", sql.SQL.Replace("\n", " "));
        ...
        public void Where_Clause_With_Not_Starts_With()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE ((([sbnNode].[level] = @0) AND NOT (upper([sbnNode].[path]) LIKE upper(@1))))", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(2, sql.Arguments.Length);
        ...
        public void Where_Clause_With_Equals_Clause()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (upper([sbnNode].[text]) = upper(@0))", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(1, sql.Arguments.Length);
        ...
        public void Where_Clause_With_False_Boolean()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE ([sbnNode].[trashed] = @0)", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(1, sql.Arguments.Length);
        ...
        public void Where_Clause_With_ToString()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (([sbnNode].[text] = @0))", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(1, sql.Arguments.Length);
        ...
        public void Where_Clause_With_Wildcard()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (upper([sbnNode].[text]) LIKE upper(@0))", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(1, sql.Arguments.Length);
        ...
        public void Where_Clause_Single_Constant()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (([sbnNode].[id] = @0))", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(1, sql.Arguments.Length);
        ...
        public void Where_Clause_And_Constant()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE ((([sbnNode].[id] <> @0) AND ([sbnNode].[id] <> @1)))", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(2, sql.Arguments.Length);
            Assert.AreEqual(2, sql.Arguments[0]);
        ...
        public void Where_Clause_Or_Constant()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE ((([sbnNode].[text] = @0) OR ([sbnNode].[id] = @1)))", sql.SQL.Replace("\n", " "));
            Assert.AreEqual(2, sql.Arguments.Length);
            Assert.AreEqual("hello", sql.Arguments[0]);
            Assert.AreEqual(3, sql.Arguments[1]);
        }
        ...
        public void Where_Null()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (([sbnNode].[id] IS NULL))", sql.SQL.Replace("\n", " "));
        }
        ...
        public void Where_Not_Null()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (([sbnNode].[id] IS NOT NULL))", sql.SQL.Replace("\n", " "));
        }
        ...
        public void Where_Any()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnNode] WHERE (( (([sbnNode].[id] = @0)) ) OR ( (([sbnNode].[id] = @1)) ))", sql.SQL.Replace("\n", " "));
        }
        ...
        public void ForUpdate()
        {
            ...
            Assert.AreEqual("SELECT * FROM [sbnUserLogin] WHERE (([sbnUserLogin].[sessionId] = @0))", sql.SQL.NoCrLf());

            sql = sql.ForUpdate();

            Assert.AreEqual("SELECT * FROM [sbnUserLogin] WITH (UPDLOCK) WHERE (([sbnUserLogin].[sessionId] = @0))", sql.SQL.NoCrLf());
        }
    }
}
