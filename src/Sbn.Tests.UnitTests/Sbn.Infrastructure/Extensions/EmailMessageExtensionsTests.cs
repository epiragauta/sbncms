...
using Sbn.Cms.Infrastructure.Extensions;

namespace Sbn.Cms.Tests.UnitTests.Sbn.Infrastructure.Extensions
{
    [TestFixture]
    public class EmailMessageExtensionsTests
    {
        private const string ConfiguredSender = "noreply@sbn.com";
