...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Infrastructure.Logging
{
    [TestFixture]
    public class LogviewerTests
    {
        ...
        private const string LogfileName = "SbnTraceLog.UNITTEST.20181112.json";
        ...
        [TestCase("StartsWith(SourceContext, 'Sbn.Core')", 86)]
        [TestCase("@MessageTemplate = '{EndMessage} ({Duration}ms) [Timing {TimingId}]'", 26)]
        [TestCase("SortedComponentTypes[?] = 'Sbn.Web.Search.ExamineComponent'", 1)]
