...
using Sbn.Cms.Tests.UnitTests.Sbn.Core.ShortStringHelper;
...
using MemberMapDefinition = Sbn.Cms.Web.BackOffice.Mapping.MemberMapDefinition;
...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Web.BackOffice.Controllers
{
    ...
    public class MemberControllerUnitTests
    {
        ...
        public void PostSaveMember_WhenModelStateIsNotValid_ExpectFailureResponse(
            [Frozen] IMemberManager sbnMembersUserManager,
            ...
            IUser user)
        {
            ...
            MemberController sut = CreateSut(memberService, memberTypeService, memberGroupService, sbnMembersUserManager, dataTypeService, backOfficeSecurityAccessor, passwordChanger, globalSettings, user);
            sut.ModelState.AddModelError("key", "Invalid model state");

            Mock.Get(sbnMembersUserManager)
            ...
            IUser user)
        {
            ...
            SetupPasswordSuccess(sbnMembersUserManager, passwordChanger);
            ...
            IUser user)
        {
            ...
            SetupUserAccess(backOfficeSecurityAccessor, backOfficeSecurity, user);
            SetupPasswordSuccess(sbnMembersUserManager, passwordChanger, false);
        ...
        private static void SetupPasswordSuccess(IMemberManager sbnMembersUserManager, IPasswordChanger<MemberIdentityUser> passwordChanger, bool successful = true)
        {
            ...
            if (!successful)
            {
                ...
                Mock.Get(passwordChanger)
                   .Setup(x => x.ChangePasswordWithIdentityAsync(It.IsAny<ChangingPasswordModel>(), sbnMembersUserManager))
        ...
        private MemberController CreateSut(
            ...
            IMemberTypeService memberTypeService,
            IMemberGroupService memberGroupService,
            ISbnUserManager<MemberIdentityUser> membersUserManager,
            IDataTypeService dataTypeService,
            IBackOfficeSecurityAccessor backOfficeSecurityAccessor,
            IPasswordChanger<MemberIdentityUser> passwordChanger,
            IOptions<GlobalSettings> globalSettings,
            IUser user)
        {
            ...
            {
                new global::Sbn.Cms.Core.Models.Mapping.MemberMapDefinition(),
                memberMapDefinition,
            ...
            _mapper = new SbnMapper(map, scopeProvider);
