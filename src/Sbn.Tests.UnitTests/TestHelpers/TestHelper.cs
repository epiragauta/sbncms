...
namespace Sbn.Cms.Tests.UnitTests.TestHelpers
{
    ...
    public static class TestHelper
    {
        ...
        public static void InitializeContentDirectories() => CreateDirectories(new[] { Constants.SystemDirectories.MvcViews, new GlobalSettings().SbnMediaPath, Constants.SystemDirectories.AppPlugins });

        public static void CleanContentDirectories() => CleanDirectories(new[] { Constants.SystemDirectories.MvcViews, new GlobalSettings().SbnMediaPath });
        ...
        public static ISbnVersion GetSbnVersion() => s_testHelperInternal.GetSbnVersion();
