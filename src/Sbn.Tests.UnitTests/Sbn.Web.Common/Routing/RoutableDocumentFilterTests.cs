...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Web.Common.Routing
{
    ...
    public class RoutableDocumentFilterTests
    {
        ...
        [TestCase("/Sbn/RenderMvcs", false)]
        [TestCase("/Sbn/RenderMvc", true)]
        [TestCase("/sbn/RenderMvc/Index", true)]
        [TestCase("/Sbn/RenderMvc/Index/1234", true)]
        [TestCase("/Sbn/RenderMvc/Index/1234/", true)]
        [TestCase("/Sbn/RenderMvc/Index/1234/9876", false)]
        [TestCase("/api", true)]
        ...
        [TestCase("/sbn", true)]
        [TestCase("/sbn/", true)]
        [TestCase("/sbn/Default", true)]
        [TestCase("/sbn/default/", true)]
        [TestCase("/sbn/default/123", true)]
        [TestCase("/sbn/default/blah/123", false)]
