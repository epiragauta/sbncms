...
using Sbn.Cms.Web.Common.Views;

namespace Sbn.Cms.Tests.UnitTests.Sbn.Web.Common.Views
{
    [TestFixture]
    public class SbnViewPageTests
    {
        [Test]
        ...
        public class TestPage<TModel> : SbnViewPage<TModel>
        {
