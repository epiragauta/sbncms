...
using Sbn.Cms.Core;
using Sbn.Cms.Core.Deploy;

namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.Deploy
{
    [TestFixture]
    public class ArtifactBaseTests
    {
        ...
        {
            // This test was introduced following: https://github.com/sbn/Sbn.Deploy.Issues/issues/72 to verify
