...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.Cache.DistributedCache
{
    /// <summary>
    ...
    {
        private global::Sbn.Cms.Core.Cache.DistributedCache _distributedCache;
        ...
        public void Setup()
        {
            ...
            _distributedCache = new global::Sbn.Cms.Core.Cache.DistributedCache(ServerMessenger, cacheRefresherCollection);
        }
