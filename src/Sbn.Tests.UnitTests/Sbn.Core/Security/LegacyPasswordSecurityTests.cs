...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.Security
{
    ...
    public class LegacyPasswordSecurityTests
    {
        ...
        {
            IPasswordConfiguration passwordConfiguration = Mock.Of<IPasswordConfiguration>(x => x.HashAlgorithmType == Constants.Security.AspNetSbn8PasswordHashAlgorithmName);
            var passwordSecurity = new LegacyPasswordSecurity();
        ...
        {
            IPasswordConfiguration passwordConfiguration = Mock.Of<IPasswordConfiguration>(x => x.HashAlgorithmType == Constants.Security.AspNetSbn4PasswordHashAlgorithmName);
            var passwordSecurity = new LegacyPasswordSecurity();
