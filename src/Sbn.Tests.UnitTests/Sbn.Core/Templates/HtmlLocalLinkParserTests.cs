...
<a href=""{locallink:umb://document-type/2D692FCB070B4CDA92FB6883FDBFD6E2}"">hello</a>
            ...
            var sbnContextAccessor = new TestSbnContextAccessor();
            var parser = new HtmlLocalLinkParser(sbnContextAccessor, Mock.Of<IPublishedUrlProvider>());
        ...
        public void ParseLocalLinks(string input, string result)
        {
            ...
            ISbnContextFactory sbnContextFactory = TestSbnContextFactory.Create(
            ...
            using (SbnContextReference reference = sbnContextFactory.EnsureSbnContext())
            {
                var contentCache = Mock.Get(reference.SbnContext.Content);
                ...
                var mediaCache = Mock.Get(reference.SbnContext.Media);
