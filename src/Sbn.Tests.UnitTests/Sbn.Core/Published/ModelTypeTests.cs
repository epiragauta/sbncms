...
using Sbn.Cms.Tests.Common.Published;

namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.Published
{
    [TestFixture]
    public class ModelTypeTests
    {
        ...
        public void ModelTypeMapTests()
        {
            ...
            Assert.AreEqual(
                "Sbn.Cms.Tests.Common.Published.PublishedSnapshotTestObjects+TestElementModel1",
                ModelType.Map(ModelType.For("alias1"), map).ToString());
            Assert.AreEqual(
                "Sbn.Cms.Tests.Common.Published.PublishedSnapshotTestObjects+TestElementModel1[]",
                ModelType.Map(ModelType.For("alias1").MakeArrayType(), map).ToString());
            Assert.AreEqual(
                "System.Collections.Generic.IEnumerable`1[Sbn.Cms.Tests.Common.Published.PublishedSnapshotTestObjects+TestElementModel1]",
