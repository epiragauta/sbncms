...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.Routing
{
    ...
    public class UriUtilityTests
    {
        ...
        [TestCase("http://LocalHost/Home/Sub1/", "http://localhost/home/sub1")]
        [TestCase("http://LocalHost/Home/Sub1/?x=y", "http://localhost/home/sub1?x=y")]
        public void Uri_To_Sbn(string sourceUrl, string expectedUrl)
        {
            // Arrange
            ...
            // Act
            Uri resultUri = uriUtility.UriToSbn(sourceUri);
        ...
        public void Uri_From_Sbn(string sourceUrl, string expectedUrl, bool trailingSlash)
        {
            // Arrange
            ...
            // Act
            Uri resultUri = uriUtility.UriFromSbn(sourceUri, requestHandlerSettings);
