...
using Sbn.Cms.Core.Configuration.SbnSettings;
using Sbn.Cms.Core.Strings;

namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.ShortStringHelper
{
    [TestFixture]
    public class DefaultShortStringHelperTestsWithoutSetup
    {
        ...
        public void CleanStringDefaultConfig()
        {
            ...
            // sbn-cased ascii alias, must begin with a proper letter
        ...
        public void CleanStringCasing()
        {
            ...
            Assert.AreEqual("aaa BBB CCc Ddd E FF", helper.CleanString("aaa BBB CCc Ddd E FF", CleanStringType.Alias | CleanStringType.SbnCase));
