...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.CoreXml
{
    ...
    <items>
        ...
        // Sbn : the following test shows that when legacy imports the whole tree in a
        ...
        // Sbn: the CanRemove...NodeAndNavigate tests shows that if the underlying XmlDocument
        ...
        // Sbn: the following test shows that if the underlying XmlDocument is modified while
