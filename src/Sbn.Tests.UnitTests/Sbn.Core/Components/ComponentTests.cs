...
namespace Sbn.Cms.Tests.UnitTests.Sbn.Core.Components
{
    [TestFixture]
    public class ComponentTests
    {
        ...
        {
            // FIXME: use ISbnDatabaseFactory vs SbnDatabaseFactory, clean it all up!
            ...
            var f = new SbnDatabaseFactory(
                ...
                new DatabaseSchemaCreatorFactory(loggerFactory.CreateLogger<DatabaseSchemaCreator>(), loggerFactory, new SbnVersion(), Mock.Of<IEventAggregator>()),
                mapperCollection);
            ...
            mock.Setup(x => x.GetService(typeof(ISbnDatabaseFactory))).Returns(f);
        ...
        public void Boot1A()
        {
            ...
            var composition = new SbnBuilder(register, Mock.Of<IConfiguration>(), TestHelper.GetMockedTypeLoader());
        ...
        public void BrokenRequire()
        {
            ...
            {
                Assert.AreEqual("Broken composer dependency: Sbn.Cms.Tests.UnitTests.Sbn.Core.Components.ComponentTests+Composer2 -> Sbn.Cms.Tests.UnitTests.Sbn.Core.Components.ComponentTests+Composer4.", e.Message);
            }
        }
        ...
        public void AllComposers()
        {
            ...
            IServiceCollection register = MockRegister();
            var builder = new SbnBuilder(register, Mock.Of<IConfiguration>(), TestHelper.GetMockedTypeLoader());

            var allComposers = typeLoader.GetTypes<IComposer>().ToList();
            var types = allComposers.Where(x => x.FullName.StartsWith("Sbn.Core.") || x.FullName.StartsWith("Sbn.Web")).ToList();
        ...
        {
            public virtual void Compose(ISbnBuilder builder) => Composed.Add(GetType());
        }
        ...
        {
            public override void Compose(ISbnBuilder builder)
            {
