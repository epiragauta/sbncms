...
namespace Sbn.Cms.Tests.UnitTests.Sbn.PublishedCache.NuCache
{
    [TestFixture]
    public class SnapDictionaryTests
    {
        ...
        public async Task EventuallyCollectNulls()
        {
            ...
            Assert.IsTrue(d.Test.GenObjs.TryPeek(out global::Sbn.Cms.Infrastructure.PublishedCache.Snap.GenObj genObj));
            genObj = null;
