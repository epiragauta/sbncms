...
namespace Sbn.Cms.Core.Templates
{
    ...
    public sealed class HtmlImageSourceParser
    {
        ...
        /// <summary>
        /// Parses the string looking for Sbn image tags and updates them to their up-to-date image sources.
        /// </summary>
        /// <param name="text"></param>
        /// <returns></returns>
        /// <remarks>Sbn image tags are identified by their data-udi attributes</remarks>
