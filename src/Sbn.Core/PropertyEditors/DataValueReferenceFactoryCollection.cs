...
namespace Sbn.Cms.Core.PropertyEditors
{
    public class DataValueReferenceFactoryCollection : BuilderCollectionBase<IDataValueReferenceFactory>
    {
        ...
        public IEnumerable<SbnEntityReference> GetAllReferences(IPropertyCollection properties, PropertyEditorCollection propertyEditors)
        {
            var trackedRelations = new HashSet<SbnEntityReference>();
