...
namespace Sbn.Cms.Core.PropertyEditors
{
    ...
    public class TagsPropertyEditorAttribute : Attribute
    {
        ...
        public TagsPropertyEditorAttribute(Type tagsConfigurationProvider)
            : this()
        {
            TagsConfigurationProviderType = tagsConfigurationProvider ?? throw new ArgumentNullException(nameof(tagsConfigurationProvider));
        }
        ...
        /// </summary>
        //TODO: This is not used and should be implemented in a nicer way, see https://github.com/sbn/Sbn-CMS/issues/6017#issuecomment-516253562
