...
namespace Sbn.Cms.Core.IO
{
    public class ViewHelper
    {
        ...
        public static string GetDefaultFileContent(string layoutPageAlias = null, string modelClassName = null, string modelNamespace = null, string modelNamespaceAlias = null)
        {
            ...
            // either
            // @inherits Sbn.Web.Mvc.SbnViewPage
            // @inherits Sbn.Web.Mvc.SbnViewPage<ModelClass>
            content.AppendLine("@using Sbn.Cms.Web.Common.PublishedModels;");
            content.Append("@inherits Sbn.Cms.Web.Common.Views.SbnViewPage");
