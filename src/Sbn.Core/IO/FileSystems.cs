...
namespace Sbn.Cms.Core.IO
{
    ...
    public sealed class FileSystems
    {
        ...
        private object CreateWellKnownFileSystems()
        {
            ...
            var scriptsFileSystem = new PhysicalFileSystem(_ioHelper, _hostingEnvironment, logger,  _hostingEnvironment.MapPathWebRoot(_globalSettings.SbnScriptsPath), _hostingEnvironment.ToAbsolute(_globalSettings.SbnScriptsPath));
            ...
            if (_stylesheetsFileSystem == null)
            {
                var stylesheetsFileSystem = new PhysicalFileSystem(_ioHelper, _hostingEnvironment, logger,
                    _hostingEnvironment.MapPathWebRoot(_globalSettings.SbnCssPath),
                    _hostingEnvironment.ToAbsolute(_globalSettings.SbnCssPath));
        ...
        /// <summary>
        /// Creates a shadow wrapper for a filesystem, should never be used outside SbnBuilder or testing
        /// </summary>
