...
namespace Sbn.Extensions
{
    public static class PublishedContentExtensions
    {
        ...
        /// </returns>
        /// <remarks>
        /// This is the same as calling <see cref="Sbn.Web.PublishedContentExtensions.AncestorOrSelf(IPublishedContent, int)" /> with <c>maxLevel</c> set to 1.
        /// </remarks>
        ...
        /// </returns>
        /// <remarks>
        /// This is the same as calling <see cref="Sbn.Web.PublishedContentExtensions.AncestorOrSelf{T}(IPublishedContent, int)" /> with <c>maxLevel</c> set to 1.
        /// </remarks>
        ...
        public static string Url(this IPublishedContent content, IPublishedUrlProvider publishedUrlProvider, string culture = null, UrlMode mode = UrlMode.Default)
        {
            if (publishedUrlProvider == null)
                throw new InvalidOperationException("Cannot resolve a Url when Current.SbnContext.UrlProvider is null.");
