...
namespace Sbn.Cms.Core.Hosting
{
    public interface IHostingEnvironment
    {
        ...
        /// <summary>
        /// The unique application ID for this Sbn website.
        /// </summary>
        /// <remarks>
        /// <para>
        /// The returned value will be the same consistent value for an Sbn website on a specific server and will the same
        /// between restarts of that Sbn website/application on that specific server.
        /// </para>
        /// <para>
        /// The value of this does not necesarily distinguish between unique workers/servers for this Sbn application.
        /// Usage of this must take into account that the same <see cref="ApplicationId"/> may be returned for the same
        /// Sbn website hosted on different servers. Similarly the usage of this must take into account that a different
        /// <see cref="ApplicationId"/> may be returned for the same Sbn website hosted on different servers.
        /// </para>
        /// </remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether Sbn is hosted.
        /// </summary>
        bool IsHosted { get; }
