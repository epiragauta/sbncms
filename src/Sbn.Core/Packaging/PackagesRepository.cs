...
namespace Sbn.Cms.Core.Packaging
{
    ...
    public class PackagesRepository : ICreatedPackagesRepository
    {
            ...
            string mediaFolderPath = null)
        {
            ...
            _mediaFolderPath = mediaFolderPath ?? globalSettings.Value.SbnMediaPath + "/created-packages";
        ...
        /// <summary>
        /// Converts a sbn stylesheet to a package xml node
        /// </summary>
