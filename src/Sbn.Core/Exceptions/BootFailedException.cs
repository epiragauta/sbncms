...
namespace Sbn.Cms.Core.Exceptions
{
    /// <summary>
    /// An exception that is thrown if the Sbn application cannot boot.
    /// </summary>
    ...
    public class BootFailedException : Exception
    {
        ...
        /// </summary>
        public const string DefaultMessage = "Boot failed: Sbn cannot run. See Sbn's log file for more details.";
