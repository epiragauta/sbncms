...
namespace Sbn.Cms.Core.Xml.XPath
{
    /// <summary>
    /// Provides a cursor model for navigating Sbn data as if it were XML.
    /// </summary>
...
// ReSharper restore IntroduceOptionalParameters.Local
        ...
        /// and it probably does not make sense at Sbn level.</remarks>
