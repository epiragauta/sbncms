...
{
    /// <summary>
    /// This is used to parse our customize Sbn XPath expressions (i.e. that include special tokens like $site) into
    /// a real XPath statement
    /// </summary>
    public class SbnXPathPathSyntaxParser
    {
        /// <summary>
        /// Parses custom sbn xpath expression
        /// </summary>
            ...
            Func<int, bool> publishedContentExists)
        {
            ...
            // it does not, there is a ticket raised here about it: http://issues.sbn.org/issue/U4-6364
