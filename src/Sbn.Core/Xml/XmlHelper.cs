...
namespace Sbn.Cms.Core.Xml
{
    /// <summary>
    /// The XmlHelper class contains general helper methods for working with xml in sbn.
    /// </summary>
    public class XmlHelper
    {
        ...
        public static bool TryCreateXPathDocumentFromPropertyValue(object value, out XPathDocument doc)
        {
            ...
            if (nav.MoveToFirstChild())
            {
                ...
                //if (SbnConfig.For.SbnSettings().Scripting.NotDynamicXmlDocumentElements.All(x => x.Element.InvariantEquals(name) == false)) return true;
        ...
        /// </summary>
        /// <param name="filePath">The relative file path. ie. /config/sbn.config</param>
