...
namespace Sbn.Cms.Core.Security
{
    ...
    public class LegacyPasswordSecurity
    {
        ...
        public bool SupportHashAlgorithm(string algorithm)
        {
            ...
            if (algorithm.InvariantEquals(Constants.Security.AspNetSbn8PasswordHashAlgorithmName))
                return true;
        ...
        private bool IsLegacySHA1Algorithm(string algorithm) => algorithm.InvariantEquals(Constants.Security.AspNetSbn4PasswordHashAlgorithmName);
