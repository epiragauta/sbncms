...
namespace Sbn.Extensions
{
    public static class ClaimsPrincipalExtensions
    {
        ...
        /// <returns></returns>
        public static ClaimsIdentity GetSbnIdentity(this IPrincipal principal)
        {
            //If it's already a SbnBackOfficeIdentity
            ...
            //Check if there's more than one identity assigned and see if it's a SbnBackOfficeIdentity and use that
            ...
            //Otherwise convert to a SbnBackOfficeIdentity if it's auth'd
