...
namespace Sbn.Cms.Core.Security
{
    ...
    public class ContentPermissions
    {
        ...
        /// <param name="entity">The <see cref="ISbnEntity"/> item resolved if one was found for the id</param>
        /// <param name="permissionsToCheck"></param>
        /// <returns></returns>
        public ContentAccess CheckPermissions(
            int nodeId,
            IUser user,
            out ISbnEntity entity,
            IReadOnlyList<char> permissionsToCheck = null)
        {
            ...
            entity = _entityService.Get(nodeId, SbnObjectTypes.Document);
            if (entity == null) return ContentAccess.NotFound;
