...
namespace Sbn.Cms.Core.Models.PublishedContent
{
    /// <summary>
    ...
    public class PublishedContentTypeFactory : IPublishedContentTypeFactory
    {
        ...
        /// </summary>
        /// <remarks>Values are assumed to be consisted and are not checked.</remarks>
        internal IPublishedPropertyType CreatePropertyType(string propertyTypeAlias, int dataTypeId, bool sbn = false, ContentVariation variations = ContentVariation.Nothing)
        {
            return new PublishedPropertyType(propertyTypeAlias, dataTypeId, sbn, variations, _propertyValueConverters, _publishedModelFactory, this);
        }
