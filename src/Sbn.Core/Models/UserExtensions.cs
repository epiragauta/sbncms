...
namespace Sbn.Cms.Core.Models
{
    public static class UserExtensions
    {
        ...
        public static bool HasContentPathAccess(this IUser user, ISbnEntity entity, IEntityService entityService, AppCaches appCaches)
        {
        ...
        public static bool HasMediaPathAccess(this IUser user, ISbnEntity entity, IEntityService entityService, AppCaches appCaches)
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
        ...
        public static int[] CalculateContentStartNodeIds(this IUser user, IEntityService entityService, AppCaches appCaches)
        {
            ...
            var result = runtimeCache.GetCacheItem(cacheKey, () =>
            {
                ...
                var vals = CombineStartNodes(SbnObjectTypes.Document, gsn, usn, entityService);
                return vals;
        ...
        public static int[] CalculateMediaStartNodeIds(this IUser user, IEntityService entityService, AppCaches appCaches)
        {
            ...
            var result = runtimeCache.GetCacheItem(cacheKey, () =>
            {
                ...
                var vals = CombineStartNodes(SbnObjectTypes.Media, gsn, usn, entityService);
                return vals;
            }, TimeSpan.FromMinutes(2), true);
        ...
        public static string[] GetMediaStartNodePaths(this IUser user, IEntityService entityService, AppCaches appCaches)
        {
            ...
            var result = runtimeCache.GetCacheItem(cacheKey, () =>
            {
                ...
                var vals = entityService.GetAllPaths(SbnObjectTypes.Media, startNodeIds).Select(x => x.Path).ToArray();
                return vals;
            }, TimeSpan.FromMinutes(2), true);
        ...
        public static string[] GetContentStartNodePaths(this IUser user, IEntityService entityService, AppCaches appCaches)
        {
            ...
            var result = runtimeCache.GetCacheItem(cacheKey, () =>
            {
                ...
                var vals = entityService.GetAllPaths(SbnObjectTypes.Document, startNodeIds).Select(x => x.Path).ToArray();
                return vals;
            }, TimeSpan.FromMinutes(2), true);
        ...
        private static string GetBinPath(SbnObjectTypes objectType)
        {
        ...
        internal static int[] CombineStartNodes(SbnObjectTypes objectType, int[] groupSn, int[] userSn, IEntityService entityService)
        {
