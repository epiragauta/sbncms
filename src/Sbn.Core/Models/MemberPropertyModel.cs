...
{
    /// <summary>
    /// A simple representation of an Sbn member property
    /// </summary>
    public class MemberPropertyModel
    {
        ...
        // for an SbnProperty and then bind with the correct type based on the property type for this alias. This
