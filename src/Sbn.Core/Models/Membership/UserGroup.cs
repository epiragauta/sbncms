...
namespace Sbn.Cms.Core.Models.Membership
{
    /// <summary>
    ...
    public class UserGroup : EntityBase, IUserGroup, IReadOnlyUserGroup
    {
        ...
        {
            get => _alias;
            set => SetPropertyValueAndDetectChanges(value.ToCleanString(_shortStringHelper, CleanStringType.Alias | CleanStringType.SbnCase), ref _alias, nameof(Alias));
        }
