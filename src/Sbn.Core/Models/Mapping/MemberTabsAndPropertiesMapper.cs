...
namespace Sbn.Cms.Core.Models.Mapping
{
    ...
    public class MemberTabsAndPropertiesMapper : TabsAndPropertiesMapper<IMember>
    {
        ...
        protected override IEnumerable<ContentPropertyDisplay> GetCustomGenericProperties(IContentBase content)
        {
            ...
            var genericProperties = new List<ContentPropertyDisplay>
            {
                ...
                new ContentPropertyDisplay
                {
                    ...
                    Value = _localizedTextService.SbnDictionaryTranslate(CultureDictionary, member.ContentType.Name),
        ...
        /// <returns></returns>
        /// <remarks>
        /// If the membership provider installed is the sbn membership provider, then we will allow changing the username, however if
