...
namespace Sbn.Cms.Core.Models.Mapping
{
    ...
    internal class ContentPropertyDisplayMapper : ContentPropertyBasicMapper<ContentPropertyDisplay>
    {
        ...
        public override void Map(IProperty originalProp, ContentPropertyDisplay dest, MapperContext context)
        {
            ...
            //Translate
            dest.Label = _textService.SbnDictionaryTranslate(_cultureDictionary, dest.Label);
            dest.Description = _textService.SbnDictionaryTranslate(_cultureDictionary, dest.Description);
        }
    }
}
