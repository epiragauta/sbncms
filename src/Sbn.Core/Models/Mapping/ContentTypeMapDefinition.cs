    ...
    public class ContentTypeMapDefinition : IMapDefinition
    {
        ...
        private void Map(IContentTypeBase source, ContentTypeBasic target, string entityType)
        {
            ...
            target.IconFilePath = target.IconIsClass
                ? string.Empty
                : $"{_globalSettings.GetBackOfficePath(_hostingEnvironment).EnsureEndsWith("/")}images/sbn/{source.Icon}";
            ...
            target.ThumbnailFilePath = target.ThumbnailIsClass
                ? string.Empty
                : _hostingEnvironment.ToAbsolute("~/sbn/images/thumbnails/" + source.Thumbnail);
        ...
        // Sbn.Code.MapAll -SupportsPublishing -Key -PropertyEditorAlias -ValueStorageType -Variations
        ...
        // Sbn.Code.MapAll -CreateDate -UpdateDate -DeleteDate -Key -PropertyTypes
        ...
        // Sbn.Code.MapAll -ContentTypeId -ParentTabContentTypes -ParentTabContentTypeNames
        ...
        // Sbn.Code.MapAll -Editor -View -Config -ContentTypeId -ContentTypeName -Locked -DataTypeIcon -DataTypeName
        ...
        // Sbn.Code.MapAll -CreatorId -Level -SortOrder -Variations
        // Sbn.Code.MapAll -CreateDate -UpdateDate -DeleteDate
        // Sbn.Code.MapAll -ContentTypeComposition (done by AfterMapSaveToType)
        ...
        // Sbn.Code.MapAll -Blueprints -Errors -ListViewEditorName -Trashed
        ...
        // Sbn.Code.MapAll -CreateDate -UpdateDate -ListViewEditorName -Errors -LockedCompositeContentTypes
