...
namespace Sbn.Cms.Core.Models.Mapping
{
    public class DataTypeMapDefinition : IMapDefinition
    {
        ...
        // Sbn.Code.MapAll -Udi -HasPrevalues -IsSystemDataType -Id -Trashed -Key
        // Sbn.Code.MapAll -ParentId -Path
        ...
        // Sbn.Code.MapAll -Key -Path -CreatorId -Level -SortOrder -Configuration
