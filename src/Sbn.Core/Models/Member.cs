...
namespace Sbn.Cms.Core.Models
{
    ...
    public class Member : ContentBase, IMember
    {
        ...
        // * Check if we are using the sbn membership provider, if so then we need to use the configured fields - not the explicit fields below
        ...
        /// </summary>
        /// <remarks>
        /// Alias: sbnMemberLastPasswordChangeDate
        /// Part of the standard properties collection.
        /// </remarks>
        [DataMember]
        ...
        /// </summary>
        /// <remarks>
        /// Alias: sbnMemberLastLockoutDate
        /// Part of the standard properties collection.
        /// </remarks>
        [DataMember]
        ...
        /// </summary>
        /// <remarks>
        /// Alias: sbnMemberFailedPasswordAttempts
        /// Part of the standard properties collection.
        /// </remarks>
        [DataMember]
