namespace Sbn.Cms.Core
{
    public static partial class Constants
    {
        public static class Security
        {
            ...
            public const string BackOfficeAuthenticationType = "SbnBackOffice";
            public const string BackOfficeExternalAuthenticationType = "SbnExternalCookie";
            public const string BackOfficeExternalCookieName = "UMB_EXTLOGIN";
            public const string BackOfficeTokenAuthenticationType = "SbnBackOfficeToken";
            public const string BackOfficeTwoFactorAuthenticationType = "SbnTwoFactorCookie";
            public const string BackOfficeTwoFactorRememberMeAuthenticationType = "SbnTwoFactorRememberMeCookie";
            ...
            /// </remarks>
            public const string BackOfficeExternalAuthenticationTypePrefix = "Sbn.";

            public const string StartContentNodeIdClaimType = "http://sbn.org/2015/02/identity/claims/backoffice/startcontentnode";
            public const string StartMediaNodeIdClaimType = "http://sbn.org/2015/02/identity/claims/backoffice/startmedianode";
            public const string AllowedApplicationsClaimType = "http://sbn.org/2015/02/identity/claims/backoffice/allowedapp";
            public const string SessionIdClaimType = "http://sbn.org/2015/02/identity/claims/backoffice/sessionid";
            public const string TicketExpiresClaimType = "http://sbn.org/2020/06/identity/claims/backoffice/ticketexpires";
            ...
            public const string AspNetSbn8PasswordHashAlgorithmName = "HMACSHA256";
            public const string AspNetSbn4PasswordHashAlgorithmName = "HMACSHA1";
        }
    }
}
