namespace Sbn.Cms.Core
{
    ...
    {
        /// <summary>
        /// Defines the identifiers for Sbn system nodes.
        /// </summary>
        public static class Web
        {
            ...
            /// <summary>
            /// The route name of the page shown when Sbn has no published content.
            /// </summary>
            public const string NoContentRouteName = "sbn-no-content";
            ...
            {
                public const string InstallArea = "SbnInstall";
                public const string BackOfficePathSegment = "BackOffice"; // The path segment prefix for all back office controllers
                public const string BackOfficeArea = "SbnBackOffice"; // Used for area routes of non-api controllers
                public const string BackOfficeApiArea = "SbnApi"; // Same name as v8 so all routing remains the same
                public const string BackOfficeTreeArea = "SbnTrees"; // Same name as v8 so all routing remains the same
            }
