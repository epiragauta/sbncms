...
{
    public interface ISbnContext : IDisposable
    {
        /// <summary>
        ...
        //// The only nicer way would be to have a RouteRequest method directly on ISbnContext but that means adding another dep to the ctx/factory.
