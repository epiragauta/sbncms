...
namespace Sbn.Cms.Core.HealthChecks.Checks.Permissions
{
    /// <summary>
    ...
    [HealthCheck(
        ...
        Description = "Checks that the web server folder and file permissions are set correctly for Sbn to run.",
        Group = "Permissions")]
    public class FolderAndFilePermissionsCheck : HealthCheck
    {
        ...
        {
            _filePermissionHelper.RunFilePermissionTestSuite(out Dictionary<FilePermissionTest, IEnumerable<string>> errors);
