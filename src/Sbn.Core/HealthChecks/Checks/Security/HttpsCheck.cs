...
namespace Sbn.Cms.Core.HealthChecks.Checks.Security
{
    /// <summary>
    ...
    [HealthCheck(
        ...
        "HTTPS Configuration",
        Description = "Checks if your site is configured to work over HTTPS and if the Sbn related configuration for that is correct.",
        Group = "Security")]
