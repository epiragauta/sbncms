...
namespace Sbn.Cms.Core.Composing
{
    ...
    {
        private readonly ISbnBuilder _builder;
        ...
        /// or
        /// logger</exception>
        public ComposerGraph(ISbnBuilder builder, IEnumerable<Type> composerTypes, IEnumerable<Attribute> enableDisableAttributes, ILogger<ComposerGraph> logger)
        {
