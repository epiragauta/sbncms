...
namespace Sbn.Cms.Core.Composing
{
    ...
    /// </summary>
    /// <remarks>
    /// This will recursively search through the entry point's assemblies and Sbn's core assemblies and their references
    /// to create a list of scannable assemblies based on whether they themselves or their transitive dependencies reference Sbn core assemblies.
    /// </remarks>
    public class DefaultSbnAssemblyProvider : IAssemblyProvider
    {
        ...
        public DefaultSbnAssemblyProvider(
        ...
        public IEnumerable<Assembly> Assemblies
        {
            get
            {
                ...
                IEnumerable<string> additionalTargetAssemblies = Constants.Composing.SbnCoreAssemblyNames;
