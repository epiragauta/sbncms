...
namespace Sbn.Cms.Core.Services
{
    public interface IRelationService : IService
    {
        ...
        /// <returns>An enumerable list of <see cref="IRelation"/> objects</returns>
        IEnumerable<IRelation> GetByParent(ISbnEntity parent);
        ...
        /// <param name="relationTypeAlias">Alias of the type of relation to retrieve</param>
        /// <returns>An enumerable list of <see cref="IRelation"/> objects</returns>
        IEnumerable<IRelation> GetByParent(ISbnEntity parent, string relationTypeAlias);
        ...
        /// <returns>An enumerable list of <see cref="IRelation"/> objects</returns>
        IEnumerable<IRelation> GetByChild(ISbnEntity child);
        ...
        /// <param name="relationTypeAlias">Alias of the type of relation to retrieve</param>
        /// <returns>An enumerable list of <see cref="IRelation"/> objects</returns>
        IEnumerable<IRelation> GetByChild(ISbnEntity child, string relationTypeAlias);
        ...
        /// <summary>
        /// Gets the Child object from a Relation as an <see cref="ISbnEntity"/>
        /// </summary>
        /// <param name="relation">Relation to retrieve child object from</param>
        /// <returns>An <see cref="ISbnEntity"/></returns>
        ISbnEntity GetChildEntityFromRelation(IRelation relation);

        /// <summary>
        /// Gets the Parent object from a Relation as an <see cref="ISbnEntity"/>
        /// </summary>
        /// <param name="relation">Relation to retrieve parent object from</param>
        /// <returns>An <see cref="ISbnEntity"/></returns>
        ISbnEntity GetParentEntityFromRelation(IRelation relation);

        /// <summary>
        /// Gets the Parent and Child objects from a Relation as a <see cref="Tuple"/>"/> with <see cref="ISbnEntity"/>.
        /// </summary>
        ...
        Tuple<ISbnEntity, ISbnEntity> GetEntitiesFromRelation(IRelation relation);

        /// <summary>
        /// Gets the Child objects from a list of Relations as a list of <see cref="ISbnEntity"/> objects.
        /// </summary>
        /// <param name="relations">List of relations to retrieve child objects from</param>
        /// <returns>An enumerable list of <see cref="ISbnEntity"/></returns>
        IEnumerable<ISbnEntity> GetChildEntitiesFromRelations(IEnumerable<IRelation> relations);

        /// <summary>
        /// Gets the Parent objects from a list of Relations as a list of <see cref="ISbnEntity"/> objects.
        /// </summary>
        /// <param name="relations">List of relations to retrieve parent objects from</param>
        /// <returns>An enumerable list of <see cref="ISbnEntity"/></returns>
        IEnumerable<ISbnEntity> GetParentEntitiesFromRelations(IEnumerable<IRelation> relations);
        ...
        /// <param name="totalChildren"></param>
        /// <returns></returns>
        IEnumerable<ISbnEntity> GetPagedParentEntitiesByChildId(int id, long pageIndex, int pageSize, out long totalChildren, params SbnObjectTypes[] entityTypes);
        ...
        /// <param name="totalChildren"></param>
        /// <returns></returns>
        IEnumerable<ISbnEntity> GetPagedChildEntitiesByParentId(int id, long pageIndex, int pageSize, out long totalChildren, params SbnObjectTypes[] entityTypes);

        /// <summary>
        /// Gets the Parent and Child objects from a list of Relations as a list of <see cref="ISbnEntity"/> objects.
        /// </summary>
        /// <param name="relations">List of relations to retrieve parent and child objects from</param>
        /// <returns>An enumerable list of <see cref="Tuple"/> with <see cref="ISbnEntity"/></returns>
        IEnumerable<Tuple<ISbnEntity, ISbnEntity>> GetEntitiesFromRelations(IEnumerable<IRelation> relations);
        ...
        /// <summary>
        /// Relates two objects that are based on the <see cref="ISbnEntity"/> interface.
        /// </summary>
        /// <param name="parent">Parent entity</param>
        /// <param name="child">Child entity</param>
        /// <param name="relationType">The type of relation to create</param>
        /// <returns>The created <see cref="IRelation"/></returns>
        IRelation Relate(ISbnEntity parent, ISbnEntity child, IRelationType relationType);
        ...
        /// <param name="relationTypeAlias">Alias of the type of relation to create</param>
        /// <returns>The created <see cref="IRelation"/></returns>
        IRelation Relate(ISbnEntity parent, ISbnEntity child, string relationTypeAlias);
        ...
        bool AreRelated(ISbnEntity parent, ISbnEntity child);
        ...
        /// <param name="relationTypeAlias">Alias of the type of relation to create</param>
        /// <returns>Returns <c>True</c> if any relations exist between the entities, otherwise <c>False</c></returns>
        bool AreRelated(ISbnEntity parent, ISbnEntity child, string relationTypeAlias);
