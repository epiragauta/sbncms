...
namespace Sbn.Cms.Core.Services
{
    ...
    public interface IRedirectUrlService : IService
    {
        ...
        /// </summary>
        /// <param name="url">The Sbn URL route.</param>
        /// <param name="contentKey">The content unique key.</param>
        /// <param name="culture">The culture.</param>
        /// <remarks>Is a proper Sbn route eg /path/to/foo or 123/path/tofoo.</remarks>
        ...
        /// <summary>
        /// Gets the most recent redirect URLs corresponding to an Sbn redirect URL route.
        /// </summary>
        /// <param name="url">The Sbn redirect URL route.</param>
