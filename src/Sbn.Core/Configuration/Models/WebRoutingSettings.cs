...
namespace Sbn.Cms.Core.Configuration.Models
{
    ...
    /// </summary>
    [SbnOptions(Constants.Configuration.ConfigWebRouting)]
    public class WebRoutingSettings
    {
        ...
        /// the Sbn dynamic router tries to map the request to an Sbn content item.
        /// </summary>
        /// <remarks>
        /// This should not be necessary if the Sbn catch-all/dynamic route is registered last like it's supposed to be. In that case
        ...
        /// <summary>
        /// Gets or sets a value for the Sbn application URL.
        /// </summary>
        public string SbnApplicationUrl { get; set; }
    }
}
