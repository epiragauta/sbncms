...
namespace Sbn.Cms.Core.Configuration.Models
{
    ...
    /// </summary>
    [SbnOptions(Constants.Configuration.ConfigModelsBuilder, BindNonPublicProperties = true)]
    public class ModelsBuilderSettings
    {
        ...
        internal const string StaticModelsDirectory = "~/sbn/models";
        ...
        /// setting is activated the ~/sbn/models/PureLive/ood.txt file is then created. When models are
        ...
        /// </summary>
        /// <remarks>Default is ~/sbn/models but that can be changed.</remarks>
