...
namespace Sbn.Cms.Core.Configuration.Models
{
    ...
    /// </summary>
    [SbnOptions(Constants.Configuration.ConfigPackageMigration)]
    public class PackageMigrationSettings
    {
        ...
        /// Deployment tools such as Sbn Deploy can also configure this option to run or not run these migration
