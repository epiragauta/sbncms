...
namespace Sbn.Cms.Core.Configuration.Models
{
    ...
    /// </summary>
    [SbnOptions(Constants.Configuration.ConfigContent)]
    public class ContentSettings
    {
        ...
        internal const string StaticDefaultPreviewBadge =
            @"
            <div id=""sbnPreviewBadge"" class=""sbn-preview-badge"">
                <span class=""sbn-preview-badge__header"">Preview mode</span>
                <a href=""{0}/preview/?id={2}"" class=""sbn-preview-badge__a open"" title=""Open preview in BackOffice"">
                    …
                </a>
                <a href=""{0}/preview/end?redir={1}"" class=""sbn-preview-badge__a end"" title=""End preview mode"">
            ...
            <style type=""text/css"">
                .sbn-preview-badge {{
                    ...
                    animation: sbn-preview-badge--effect 10s 1.2s ease both;
                    border-radius: 3px 3px 0 0;
                }}
                @keyframes sbn-preview-badge--effect {{
                    0% {{
                        transform: translate(-50%, 40px);
                ...
                .sbn-preview-badge__header {{
                    padding: 1em;
                    font-weight: bold;
                    pointer-events:none;
                }}
                .sbn-preview-badge__a {{
                    width: 3em;
                    padding: 1em;
                    display: flex;
                    flex-shrink: 0;
                ...
                .sbn-preview-badge__a svg {{
                    width: 1em;
                    height:1em;
                }}
                .sbn-preview-badge__a:hover {{
                    background: #202d5e;
                }}
                .sbn-preview-badge__end svg {{
                    fill: #fff;
                    width:1em;
                }}
            </style>
            <script type=""text/javascript"" data-sbn-path=""{0}"" src=""{0}/js/sbn.websitepreview.min.js""></script>";
        ...
        internal const string StaticLoginLogoImage = "assets/img/application/sbn_logo_white.svg";
