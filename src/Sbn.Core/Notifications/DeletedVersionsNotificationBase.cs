...
namespace Sbn.Cms.Core.Notifications
{
    ...
    {
        protected DeletedVersionsNotificationBase(int id, EventMessages messages, int specificVersion = default, bool deletePriorVersions = false, DateTime dateToRetain = default)
        {
            Id = id;
            Messages = messages;
