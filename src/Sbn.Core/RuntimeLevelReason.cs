namespace Sbn.Cms.Core
{
    ...
    public enum RuntimeLevelReason
    {
        ...
        /// downgrading Sbn is not supported.
        /// </summary>
        ...
        /// <summary>
        /// Sbn runs an old version.
        /// </summary>
        UpgradeOldVersion,

        /// <summary>
        /// Sbn runs the current version but some migrations have not run.
        /// </summary>
        UpgradeMigrations,

        /// <summary>
        /// Sbn runs the current version but some package migrations have not run.
        /// </summary>
