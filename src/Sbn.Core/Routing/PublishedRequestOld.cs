...
namespace Sbn.Cms.Core.Routing
{
    ...
    public class PublishedRequestOld // : IPublishedRequest
    {
        ...
        /// </summary>
        public PublishedRequestOld(IPublishedRouter publishedRouter, ISbnContext sbnContext, IOptions<WebRoutingSettings> webRoutingSettings, Uri uri = null)
        {
            SbnContext = sbnContext ?? throw new ArgumentNullException(nameof(sbnContext));
            _publishedRouter = publishedRouter ?? throw new ArgumentNullException(nameof(publishedRouter));
            _webRoutingSettings = webRoutingSettings.Value;
            Uri = uri ?? sbnContext.CleanedSbnUrl;
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the Sbn Backoffice should ignore a collision for this request.
        /// </summary>
        ...
        ///// the request is actually processed and rendered by Sbn.</remarks>
        ...
        /// <remarks>Depending on <c>SbnSettings.InternalRedirectPreservesTemplate</c>, will
        ...
        // see: https://our.sbn.com/forum/using-sbn-and-getting-started/79715-output-cache-in-sbn-752
