...
namespace Sbn.Cms.Core.Routing
{
    ...
    public class PublishedRouter : IPublishedRouter
    {
        ...
        public async Task<IPublishedRequestBuilder> CreateRequestAsync(Uri uri)
        {
            ...
            // this is based on this old task here: https://issues.sbn.org/issue/U4-7914 which was fulfiled by
            // this PR https://github.com/sbn/Sbn-CMS/pull/1137
        ...
        internal bool FindDomain(IPublishedRequestBuilder request)
        {
            ...
            IDomainCache domainsCache = sbnContext.PublishedSnapshot.Domains;
            ...
            bool IsPublishedContentDomain(Domain domain)
            {
                ...
                IPublishedContent domainDocument = sbnContext.PublishedSnapshot.Content.GetById(domain.ContentId);
        ...
        internal void HandleWildcardDomains(IPublishedRequestBuilder request)
        {
            ...
            var sbnContext = _sbnContextAccessor.GetRequiredSbnContext();
            Domain domain = DomainUtilities.FindWildcardDomainInPath(sbnContext.PublishedSnapshot.Domains.GetAll(true), nodePath, rootNodeId);
        ...
        /// <summary>
        /// Follows internal redirections through the <c>sbnInternalRedirectId</c> document property.
        /// </summary>
        /// <param name="request">The request builder.</param>
        ...
        private bool FollowInternalRedirects(IPublishedRequestBuilder request)
        {
            ...
            if (internalRedirectId > 0)
            {
                ...
                valid = true;
                internalRedirectNode = sbnContext.Content.GetById(internalRedirectId);
            }
            else
            {
                ...
                if (udiInternalRedirectId != null)
                {
                    ...
                    valid = true;
                    internalRedirectNode = sbnContext.Content.GetById(udiInternalRedirectId.Guid);
                }
            }
        ...
        private void FindTemplate(IPublishedRequestBuilder request, bool contentFoundByFinders)
        {
            ...
            if (!request.HasTemplate())
            {
                ...
                // initial idea was: if we're not already 404 and SbnSettings.HandleMissingTemplateAs404 is true
        ...
        /// <summary>
        /// Follows external redirection through <c>sbnRedirect</c> document property.
        /// </summary>
