...
{
    /// <summary>
    /// The result of Sbn routing built with the <see cref="IPublishedRequestBuilder"/>
    /// </summary>
    public interface IPublishedRequest
    {
        ...
        /// <summary>
        /// Gets a value indicating whether the Sbn Backoffice should ignore a collision for this request.
        /// </summary>
        /// <remarks>
        ...
        /// <para>This flag is based on previous Sbn versions but it is not clear how this flag can be set by developers since
        ...
        /// <para>More can be read about this setting here: https://github.com/sbn/Sbn-CMS/pull/2148, https://issues.sbn.org/issue/U4-10345
