...
namespace Sbn.Tests.PublishedContent
{
    ...
    public class PublishedContentLanguageVariantTests : PublishedContentSnapshotTestBase
    {
        ...
        {
            var content = Current.SbnContext.Content.GetAtRoot().First().Children.First();
        ...
        {
            var content = Current.SbnContext.Content.GetAtRoot().First().Children.First().Children.First();
