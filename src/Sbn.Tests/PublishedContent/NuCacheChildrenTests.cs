...
using Sbn.Tests.Testing.Objects;
...
namespace Sbn.Tests.PublishedContent
{
    ...
    public class NuCacheChildrenTests
    {
        ...
        private void Init(Func<IEnumerable<ContentNodeKit>> kits)
        {
            ...
            var propertyType = new PropertyType(TestHelper.ShortStringHelper, "Sbn.Void.Editor", ValueStorageType.Nvarchar) { Alias = "prop", DataTypeId = 3, Variations = ContentVariation.Nothing };
            ...
            propertyType = new PropertyType(TestHelper.ShortStringHelper, "Sbn.Void.Editor", ValueStorageType.Nvarchar) { Alias = "prop", DataTypeId = 3, Variations = ContentVariation.Culture };
        ...
        {
            // This test replicates an issue we saw here https://github.com/sbn/Sbn-CMS/pull/7907#issuecomment-610259393
        ...
        {
            //see https://github.com/sbn/Sbn-CMS/issues/6353
        ...
        /// <summary>
        /// This addresses issue: https://github.com/sbn/Sbn-CMS/issues/6698
        /// </summary>
        /// <remarks>
        ...
        {
            //see https://github.com/sbn/Sbn-CMS/issues/7798
            Init(GetInvariantKits);
