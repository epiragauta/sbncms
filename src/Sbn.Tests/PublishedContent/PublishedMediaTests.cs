...
namespace Sbn.Tests.PublishedContent
{
    ...
    /// </summary>
    [TestFixture]
    [SbnTest(Database = SbnTestOptions.Database.NewSchemaPerTest, WithApplication = true)]
    public class PublishedMediaTests : PublishedContentTestBase
    {
        ...
        protected override void Compose()
        {
            ...
            Builder.Services.AddUnique<ISbnContextAccessor, TestSbnContextAccessor>();
        }
        ...
        /// <returns></returns>
        internal IPublishedContent GetNode(int id, ISbnContext sbnContext)
        {
            var cache = new PublishedMediaCache(new XmlStore((XmlDocument)null, null, null, null, HostingEnvironment),
                ...
                Factory.GetRequiredService<IEntityXmlSerializer>(), Factory.GetRequiredService<ISbnContextAccessor>(), VariationContextAccessor);
        ...
        {
            return GetNode(id, GetSbnContext("/test"));
        }
        ...
        public void Ensure_Children_Sorted_With_Examine()
        {
            ...
            using (var indexer = IndexInitializer.GetSbnIndexer(ProfilingLogger, HostingEnvironment, RuntimeState, luceneDir,
            ...
            using (indexer.ProcessNonAsync())
            {
                ...
                var ctx = GetSbnContext("/test");
                var cache = new PublishedMediaCache(ServiceContext.MediaService, ServiceContext.UserService, searcher, new DictionaryAppCache(), ContentTypesCache, Factory.GetRequiredService<IEntityXmlSerializer>(), Factory.GetRequiredService<ISbnContextAccessor>());
        ...
        public void Do_Not_Find_In_Recycle_Bin()
        {
            ...
            using (indexer.ProcessNonAsync())
            {
                ...
                var newXml = XElement.Parse(@"<node id='3113' key='5b3e46ab-3e37-4cfa-ab70-014234b5bd33' parentID='-21' level='1' writerID='0' nodeType='1032' template='0' sortOrder='2' createDate='2010-05-19T17:32:46' updateDate='2010-05-19T17:32:46' nodeName='Another Sbn Image' urlName='acnestressscrub' writerName='Administrator' nodeTypeAlias='Image' path='-1,-21,3113'>
                    <data alias='sbnFile'><![CDATA[/media/1234/blah.pdf]]></data>
                    <data alias='sbnWidth'>115</data>
                    <data alias='sbnHeight'>268</data>
                    <data alias='sbnBytes'>10726</data>
                    <data alias='sbnExtension'>jpg</data>
                </node>");
        ...
        public void Convert_From_Standard_Xml()
        {
            ...
            var xml = XElement.Parse(@"<Image id=""2112"" version=""5b3e46ab-3e37-4cfa-ab70-014234b5bd39"" parentID=""2222"" level=""3"" writerID=""0"" nodeType=""1032"" template=""0"" sortOrder=""1"" createDate=""2010-05-19T17:32:46"" updateDate=""2010-05-19T17:32:46"" nodeName=""Sam's Sbn Image"" urlName=""acnestressscrub"" writerName=""Administrator"" nodeTypeAlias=""Image"" path=""-1,1111,2222,2112"" isDoc="""">
                <sbnFile><![CDATA[/media/1234/blah.pdf]]></sbnFile>
                <sbnWidth>115</sbnWidth>
                <sbnHeight>268</sbnHeight>
                <sbnBytes>10726</sbnBytes>
                <sbnExtension>jpg</sbnExtension>
                <Image id=""3113"" version=""5b3e46ab-3e37-4cfa-ab70-014234b5bd33"" parentID=""2112"" level=""4"" writerID=""0"" nodeType=""1032"" template=""0"" sortOrder=""2"" createDate=""2010-05-19T17:32:46"" updateDate=""2010-05-19T17:32:46"" nodeName=""Another Sbn Image"" urlName=""acnestressscrub"" writerName=""Administrator"" nodeTypeAlias=""Image"" path=""-1,1111,2222,2112,3113"" isDoc="""">
                    <sbnFile><![CDATA[/media/1234/blah.pdf]]></sbnFile>
                    <sbnWidth>115</sbnWidth>
                    <sbnHeight>268</sbnHeight>
                    <sbnBytes>10726</sbnBytes>
            ...
            var publishedMedia = new PublishedMediaCache(new XmlStore((XmlDocument)null, null, null, null, HostingEnvironment), ServiceContext.MediaService, ServiceContext.UserService, new DictionaryAppCache(), ContentTypesCache, Factory.GetRequiredService<IEntityXmlSerializer>(), Factory.GetRequiredService<ISbnContextAccessor>(), VariationContextAccessor);
            ...
            Assert.AreEqual("Sam's Sbn Image", converted.Name);
