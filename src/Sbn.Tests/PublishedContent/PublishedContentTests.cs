...
namespace Sbn.Tests.PublishedContent
{
    ...
    public class PublishedContentTests : PublishedContentTestBase
    {
        protected override void Compose()
        {
            ...
            var pastedImages = new RichTextEditorPastedImages(sbnContextAccessor, loggerFactory.CreateLogger<RichTextEditorPastedImages>(), HostingEnvironment, mediaService, contentTypeBaseServiceProvider, mediaFileService, ShortStringHelper, publishedUrlProvider, serializer);
            var linkParser = new HtmlLocalLinkParser(sbnContextAccessor, publishedUrlProvider);
        ...
        protected override void Initialize()
        {
            ...
            IEnumerable<IPublishedPropertyType> CreatePropertyTypes(IPublishedContentType contentType)
            {
                ...
                yield return factory.CreatePropertyType(contentType, "sbnNaviHide", 1001);
                yield return factory.CreatePropertyType(contentType, "selectedNodes", 1);
                yield return factory.CreatePropertyType(contentType, "sbnUrlAlias", 1);
