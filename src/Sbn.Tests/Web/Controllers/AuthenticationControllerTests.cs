...
namespace Sbn.Tests.Web.Controllers
{
    [TestFixture]
    ...
    public class AuthenticationControllerTests : TestWithDatabaseBase
    {
        protected override void ComposeApplication(bool withApplication)
        {
            ...
            Builder.Services.AddUnique<SbnFeatures>();
        }
        ...
        // {
        //     ApiController CtrlFactory(HttpRequestMessage message, ISbnContextAccessor sbnContextAccessor)
        //     {
        //         //setup some mocks
