...
namespace Sbn.Tests.Routing
{
    ...
    public class ContentFinderByAliasTests : UrlRoutingTestBase
    {
        ...
        protected override void Initialize()
        {
            ...
            var properties = new[]
            {
                new PublishedPropertyType("sbnUrlAlias", Constants.DataTypes.Textbox, false, ContentVariation.Nothing,
        ...
        public async Task Lookup_By_Url_Alias(string urlAsString, int nodeMatch)
        {
            ...
            var lookup =
                new ContentFinderByUrlAlias(LoggerFactory.CreateLogger<ContentFinderByUrlAlias>(), Mock.Of<IPublishedValueFallback>(), VariationContextAccessor, GetSbnContextAccessor(sbnContext));
