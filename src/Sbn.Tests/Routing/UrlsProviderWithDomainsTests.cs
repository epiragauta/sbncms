...
namespace Sbn.Tests.Routing
{
    ...
    {
        private ISbnContextAccessor SbnContextAccessor { get; } = new TestSbnContextAccessor();
        ...
        void SetDomains1()
        {
            ...
            {
                new SbnDomain("domain1.com") {Id = 1, LanguageId = LangFrId, RootContentId = 1001, LanguageIsoCode = "fr-FR"}
            });
        }
        ...
        void SetDomains2()
        {
            SetupDomainServiceMock(new[]
            {
                new SbnDomain("http://domain1.com/foo") {Id = 1, LanguageId = LangFrId, RootContentId = 1001, LanguageIsoCode = "fr-FR"}
            });
        }
        ...
        void SetDomains3()
        {
            SetupDomainServiceMock(new[]
            {
                new SbnDomain("http://domain1.com/") {Id = 1, LanguageId = LangFrId, RootContentId = 10011, LanguageIsoCode = "fr-FR"}
            });
        }
        ...
        void SetDomains4()
        {
            SetupDomainServiceMock(new[]
            {
                new SbnDomain("http://domain1.com/") {Id = 1, LanguageId = LangEngId, RootContentId = 1001, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain1.com/en") {Id = 1, LanguageId = LangEngId, RootContentId = 10011, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain1.com/fr") {Id = 1, LanguageId = LangFrId, RootContentId = 10012, LanguageIsoCode = "fr-FR"},
                new SbnDomain("http://domain3.com/") {Id = 1, LanguageId = LangEngId, RootContentId = 1003, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain3.com/en") {Id = 1, LanguageId = LangEngId, RootContentId = 10031, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain3.com/fr") {Id = 1, LanguageId = LangFrId, RootContentId = 10032, LanguageIsoCode = "fr-FR"}
            });
        }
        ...
        void SetDomains5()
        {
            ...
            {
                new SbnDomain("http://domain1.com/en") {Id = 1, LanguageId = LangEngId, RootContentId = 10011, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain1a.com/en") {Id = 1, LanguageId = LangEngId, RootContentId = 10011, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain1b.com/en") {Id = 1, LanguageId = LangEngId, RootContentId = 10011, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain1.com/fr") {Id = 1, LanguageId = LangFrId, RootContentId = 10012, LanguageIsoCode = "fr-FR"},
                new SbnDomain("http://domain1a.com/fr") {Id = 1, LanguageId = LangFrId, RootContentId = 10012, LanguageIsoCode = "fr-FR"},
                new SbnDomain("http://domain1b.com/fr") {Id = 1, LanguageId = LangFrId, RootContentId = 10012, LanguageIsoCode = "fr-FR"},
                new SbnDomain("http://domain3.com/en") {Id = 1, LanguageId = LangEngId, RootContentId = 10031, LanguageIsoCode = "en-US"},
                new SbnDomain("http://domain3.com/fr") {Id = 1, LanguageId = LangFrId, RootContentId = 10032, LanguageIsoCode = "fr-FR"}
            });
        }
...
<root id=""-1"">
    ...
    <Doc id=""1003"" parentID=""-1"" level=""1"" writerID=""0"" creatorID=""0"" nodeType=""1044"" template=""" + templateId + @""" sortOrder=""1"" createDate=""2012-06-12T14:13:17"" updateDate=""2012-07-20T18:50:43"" nodeName=""Home"" urlName=""1003"" writerName=""admin"" creatorName=""admin"" path=""-1,1003"" isDoc="""">
        ...
        public void Get_Url_SimpleDomain(int nodeId, string currentUrl, bool absolute, string expected)
        {
            ...
            var sbnContext = GetSbnContext("/test", 1111, globalSettings: globalSettings);
            ...
            var urlProvider = new DefaultUrlProvider(Microsoft.Extensions.Options.Options.Create(requestHandlerSettings),
                ...
                new SiteDomainMapper(), sbnContextAccessor, UriUtility);
            var publishedUrlProvider = GetPublishedUrlProvider(sbnContext, urlProvider);
        ...
        public void Get_Url_DomainsAndCache()
        {
            ...
            var cache = sbnContext.Content as PublishedContentCache;
        ...
        public void Get_Url_Relative_Or_Absolute()
        {
            ...
            var sbnContext = GetSbnContext("http://domain1.com/test", 1111, globalSettings: globalSettings);
            var sbnContextAccessor = new TestSbnContextAccessor(sbnContext);
            var urlProvider = new DefaultUrlProvider(
                Microsoft.Extensions.Options.Options.Create(requestHandlerSettings),
                LoggerFactory.CreateLogger<DefaultUrlProvider>(),
        ...
        public void Get_Url_Alternate()
        {
            ...
            var sbnContext = GetSbnContext("http://domain1.com/en/test", 1111, globalSettings: globalSettings);
            var sbnContextAccessor = new TestSbnContextAccessor(sbnContext);
            var urlProvider = new DefaultUrlProvider(
                Microsoft.Extensions.Options.Options.Create(requestHandlerSettings),
                LoggerFactory.CreateLogger<DefaultUrlProvider>(),
        ...
        private IPublishedUrlProvider GetPublishedUrlProvider(ISbnContext sbnContext, DefaultUrlProvider urlProvider)
        {
