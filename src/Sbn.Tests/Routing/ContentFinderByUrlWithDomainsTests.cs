...
namespace Sbn.Tests.Routing
{
    ...
    public class ContentFinderByUrlWithDomainsTests : UrlRoutingTestBase
    {
        ...
        void SetDomains4()
        {
            SetupDomainServiceMock(new[]
            {
                new SbnDomain("domain1.com/") {Id = 1, LanguageId = LangEngId, RootContentId = 1001, LanguageIsoCode = "en-US"},
...
<root id=""-1"">
    ...
    <Doc id=""1003"" parentID=""-1"" level=""1"" writerID=""0"" creatorID=""0"" nodeType=""1044"" template=""" + templateId + @""" sortOrder=""0"" createDate=""2012-06-12T14:13:17"" updateDate=""2012-07-20T18:50:43"" nodeName=""Home"" urlName=""1003"" writerName=""admin"" creatorName=""admin"" path=""-1,1003"" isDoc="""">
        ...
        public async Task Lookup_SingleDomain(string url, int expectedId)
        {
            ...
            var sbnContext = GetSbnContext(url, globalSettings:globalSettings);
            var publishedRouter = CreatePublishedRouter(GetSbnContextAccessor(sbnContext), Factory);
