...
namespace Sbn.Tests.Cache.PublishedCache
{
    [TestFixture]
    ...
    public class PublishMediaCacheTests : BaseWebTest
    {
        ...
        protected override void Compose()
        {
            ...
            _sbnContextAccessor = Current.SbnContextAccessor;
        }
        ...
        public void Get_Item_Without_Examine()
        {
            ...
            //var publishedMedia = PublishedMediaTests.GetNode(mRoot.Id, GetSbnContext("/test", 1234));
