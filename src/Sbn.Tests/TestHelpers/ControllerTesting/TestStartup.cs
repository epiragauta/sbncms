...
namespace Sbn.Tests.TestHelpers.ControllerTesting
{
    ...
    {
        private readonly Func<HttpRequestMessage, ISbnContextAccessor, ApiController> _controllerFactory;
        private readonly Action<HttpConfiguration> _initialize;

        public TestStartup(Action<HttpConfiguration> initialize, Func<HttpRequestMessage, ISbnContextAccessor, ApiController> controllerFactory)
        {
