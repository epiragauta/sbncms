...
namespace Sbn.Tests.TestHelpers
{
    ...
    {
        /// <summary>
        /// Gets a mocked ISbnDatabaseFactory.
        /// </summary>
        /// <returns>An ISbnDatabaseFactory.</returns>
        ...
        public ISbnDatabaseFactory GetDatabaseFactoryMock(bool configured = true, bool canConnect = true)
        {
            ...
            var databaseFactoryMock = new Mock<ISbnDatabaseFactory>();
            ...
            if (configured && canConnect)
                databaseFactoryMock.Setup(x => x.CreateDatabase()).Returns(GetSbnSqlCeDatabase(Mock.Of<ILogger<SbnDatabase>>()));
        ...
        /// Gets an Sbn context.
        /// </summary>
        /// <returns>An Sbn context.</returns>
        /// <remarks>This should be the minimum Sbn context.</remarks>
        public ISbnContext GetSbnContextMock(ISbnContextAccessor accessor = null)
        {
            ...
            if (accessor == null) accessor = new TestSbnContextAccessor();
            ...
            return sbnContextFactory.EnsureSbnContext().SbnContext;
        }
