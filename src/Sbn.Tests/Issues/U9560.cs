...
namespace Sbn.Tests.Issues
{
    ...
    public class U9560 : TestWithDatabaseBase
    {
        ...
        public void Test()
        {
            ...
            using (var db = Factory.GetRequiredService<ISbnDatabaseFactory>().CreateDatabase())
            {
            ...
            //var legacyContentType = new sbn.cms.businesslogic.ContentType(contentType.Id);
