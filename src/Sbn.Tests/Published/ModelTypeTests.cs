...
namespace Sbn.Tests.Published
{
    ...
    public class ModelTypeTests
    {
        ...
        public void ModelTypeFullNameTests()
        {
            ...
            Assert.AreEqual("System.Collections.Generic.IEnumerable`1[[{alias1}[*], Sbn.Core, Version=0.5.0.0, Culture=neutral, PublicKeyToken=null]]", typeof(IEnumerable<>).MakeGenericType(ModelType.For("alias1").MakeArrayType()).FullName);
        }
