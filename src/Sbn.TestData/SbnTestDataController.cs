...
namespace Sbn.TestData
{
    ...
    /// Creates test data
    /// </summary>
    public class SbnTestDataController : SurfaceController
    {
        private const string RichTextDataTypeName = "SbnTestDataContent.RTE";
        private const string MediaPickerDataTypeName = "SbnTestDataContent.MediaPicker";
        private const string TextDataTypeName = "SbnTestDataContent.Text";
