...
`/sbn/surface/sbntestdata/CreateTree?count=100&depth=5`
...
* `SbnTestDataContent.RTE` Data Type
* `SbnTestDataContent.MediaPicker` Data Type
* `SbnTestDataContent.Text` Data Type

For media, the normal folder and image is used

## Media

This does not upload physical files, it just uses a randomized online image as the `sbnFile` value.
