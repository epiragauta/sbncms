...
<body>
  ...
  <div class=""ver"">@_sbnVersion.SemanticVersion.ToSemanticStringWithoutBuild()</div>
  </div>
";
...
@inject Sbn.Cms.Core.Configuration.ISbnVersion _sbnVersion
@{
    Layout = null;
    var container = Sbn.ContentAtRoot().OfTypes(""" + ContainerAlias + @""").FirstOrDefault();
