...
{
    /// <summary>
    /// An indexer for Sbn content and media
    /// </summary>
    public class SbnContentIndex : SbnExamineIndex, ISbnContentIndex, IDisposable
    {
        private readonly ILogger<SbnContentIndex> _logger;
        private readonly ISet<string> _idOnlyFieldSet = new HashSet<string> { "id" };
        public SbnContentIndex(
            ...
            : base(loggerFactory, name, indexOptions, hostingEnvironment, runtimeState)
        {
            ...
            _logger = loggerFactory.CreateLogger<SbnContentIndex>();
        ...
        protected override void PerformDeleteFromIndex(IEnumerable<string> itemIds, Action<IndexOperationEventArgs> onComplete)
        {
            ...
            for (int i = 0; i < idsAsList.Count; i++)
            {
                ...
                var rawQuery = $"{SbnExamineFieldNames.IndexPathFieldName}:{descendantPath}";
