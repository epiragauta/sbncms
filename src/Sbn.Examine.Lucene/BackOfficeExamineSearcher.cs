...
namespace Sbn.Cms.Infrastructure.Examine
{
    public class BackOfficeExamineSearcher : IBackOfficeExamineSearcher
    {
        ...
        private readonly ISbnTreeSearcherFields _treeSearcherFields;
        ...
        public BackOfficeExamineSearcher(IExamineManager examineManager,
            ...
            ISbnTreeSearcherFields treeSearcherFields,
            AppCaches appCaches,
        ...
        public IEnumerable<ISearchResult> Search(string query, SbnEntityTypes entityType, int pageSize, long pageIndex, out long totalFound, string searchFrom = null, bool ignoreUserStartNodes = false)
        {
            var sb = new StringBuilder();

            string type;
            var indexName = Constants.SbnIndexes.InternalIndexName;
            ...
            switch (entityType)
            {
                case SbnEntityTypes.Member:
                    indexName = Constants.SbnIndexes.MembersIndexName;
                    type = "member";
                ...
                case SbnEntityTypes.Media:
                    ...
                    var allMediaStartNodes = currentUser != null
                        ...
                        : Array.Empty<int>();
                    AppendPath(sb, SbnObjectTypes.Media, allMediaStartNodes, searchFrom, ignoreUserStartNodes, _entityService);
                    break;
                case SbnEntityTypes.Document:
                    ...
                    var allContentStartNodes = currentUser != null
                        ...
                        : Array.Empty<int>();
                    AppendPath(sb, SbnObjectTypes.Document, allContentStartNodes, searchFrom, ignoreUserStartNodes, _entityService);
                    break;
                default:
            ...
            else
            {
                ...
                if (trimmed.IsNullOrWhiteSpace() == false)
                {
                    ...
                    foreach (var f in fields)
                    {
                        ...
                        if (f.Equals(SbnExamineFieldNames.SbnFileFieldName))
                        {
        ...
        private void AppendPath(StringBuilder sb, SbnObjectTypes objectType, int[] startNodeIds, string searchFrom, bool ignoreUserStartNodes, IEntityService entityService)
        {
