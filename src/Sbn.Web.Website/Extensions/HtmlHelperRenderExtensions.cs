...
namespace Sbn.Extensions
{
    ...
    public static class HtmlHelperRenderExtensions
    {
        ...
        /// using does not inherit from SbnViewPage
        /// </summary>
        /// <remarks>
        /// See: http://issues.sbn.org/issue/U4-1614
        /// </remarks>
        public static IHtmlContent PreviewBadge(this IHtmlHelper helper, ISbnContextAccessor sbnContextAccessor, IHttpContextAccessor httpContextAccessor, GlobalSettings globalSettings, IIOHelper ioHelper, ContentSettings contentSettings)
        {
            ...
            Func<object, ViewDataDictionary, string> contextualKeyBuilder = null)
        {
            ...
            var sbnContextAccessor = GetRequiredService<ISbnContextAccessor>(htmlHelper);
            sbnContextAccessor.TryGetSbnContext(out var sbnContext);

            if (cacheByPage)
            {
                if (sbnContext == null)
                {
                    throw new InvalidOperationException("Cannot cache by page if the SbnContext has not been initialized, this parameter can only be used in the context of an Sbn request");
                }

                cacheKey.AppendFormat("{0}-", sbnContext.PublishedRequest?.PublishedContent?.Id ?? 0);
            }
            ...
            return appCaches.CachedPartialView(hostingEnvironment, sbnContext, htmlHelper, partialViewName, model, cacheTimeout, cacheKey.ToString(), viewData);
        }
        ...
        /// <remarks>
        /// Typically not used directly because BeginSbnForm automatically outputs this value when routing
        ...
        /// <summary>
        /// Used for rendering out the Form for BeginSbnForm
        /// </summary>
        internal class SbnForm : MvcForm
        {
            private readonly ViewContext _viewContext;
            private readonly string _surfaceControllerInput;

            /// <summary>
            /// Initializes a new instance of the <see cref="SbnForm"/> class.
            /// </summary>
            public SbnForm(
        ...
        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline against a locally declared controller.
        /// </summary>
        ...
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, string controllerName, FormMethod method)
            => html.BeginSbnForm(action, controllerName, null, new Dictionary<string, object>(), method);

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline against a locally declared controller
        /// </summary>
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, string controllerName)
            => html.BeginSbnForm(action, controllerName, null, new Dictionary<string, object>());

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline against a locally declared controller
        /// </summary>
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, string controllerName, object additionalRouteVals, FormMethod method)
            => html.BeginSbnForm(action, controllerName, additionalRouteVals, new Dictionary<string, object>(), method);

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline against a locally declared controller
        /// </summary>
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, string controllerName, object additionalRouteVals)
            => html.BeginSbnForm(action, controllerName, additionalRouteVals, new Dictionary<string, object>());

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline against a locally declared controller
        /// </summary>
        public static MvcForm BeginSbnForm(
            this IHtmlHelper html,
            string action,
            string controllerName,
            object additionalRouteVals,
            object htmlAttributes,
            FormMethod method) => html.BeginSbnForm(action, controllerName, additionalRouteVals, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes), method);
        ...
        public static MvcForm BeginSbnForm(
            ...
            string controllerName,
            object additionalRouteVals,
            object htmlAttributes) => html.BeginSbnForm(action, controllerName, additionalRouteVals, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
            ...
            FormMethod method)
        {
            ...
            return html.BeginSbnForm(action, controllerName, "", additionalRouteVals, htmlAttributes, method);
        }
            ...
            IDictionary<string, object> htmlAttributes)
        {
            ...
            return html.BeginSbnForm(action, controllerName, string.Empty, additionalRouteVals, htmlAttributes);
        }

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, Type surfaceType, FormMethod method)
            => html.BeginSbnForm(action, surfaceType, null, new Dictionary<string, object>(), method);

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, Type surfaceType)
            => html.BeginSbnForm(action, surfaceType, null, new Dictionary<string, object>());

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        /// <typeparam name="T">The <see cref="SurfaceController"/> type</typeparam>
        public static MvcForm BeginSbnForm<T>(this IHtmlHelper html, string action, FormMethod method)
            where T : SurfaceController => html.BeginSbnForm(action, typeof(T), method);

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        /// <typeparam name="T">The <see cref="SurfaceController"/> type</typeparam>
        public static MvcForm BeginSbnForm<T>(this IHtmlHelper html, string action)
            where T : SurfaceController => html.BeginSbnForm(action, typeof(T));
        ...
        public static MvcForm BeginSbnForm(
            ...
            Type surfaceType,
            object additionalRouteVals,
            FormMethod method) => html.BeginSbnForm(action, surfaceType, additionalRouteVals, new Dictionary<string, object>(), method);
        ...
        public static MvcForm BeginSbnForm(
            ...
            string action,
            Type surfaceType,
            object additionalRouteVals) => html.BeginSbnForm(action, surfaceType, additionalRouteVals, new Dictionary<string, object>());

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        /// <typeparam name="T">The <see cref="SurfaceController"/> type</typeparam>
        public static MvcForm BeginSbnForm<T>(this IHtmlHelper html, string action, object additionalRouteVals, FormMethod method)
            where T : SurfaceController => html.BeginSbnForm(action, typeof(T), additionalRouteVals, method);

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        /// <typeparam name="T">The <see cref="SurfaceController"/> type</typeparam>
        public static MvcForm BeginSbnForm<T>(this IHtmlHelper html, string action, object additionalRouteVals)
            where T : SurfaceController => html.BeginSbnForm(action, typeof(T), additionalRouteVals);
        ...
        public static MvcForm BeginSbnForm(
            ...
            object additionalRouteVals,
            object htmlAttributes,
            FormMethod method) => html.BeginSbnForm(action, surfaceType, additionalRouteVals, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes), method);
        ...
        public static MvcForm BeginSbnForm(
            ...
            Type surfaceType,
            object additionalRouteVals,
            object htmlAttributes) => html.BeginSbnForm(action, surfaceType, additionalRouteVals, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        /// <typeparam name="T">The <see cref="SurfaceController"/> type</typeparam>
        public static MvcForm BeginSbnForm<T>(
            this IHtmlHelper html,
            string action,
            object additionalRouteVals,
            object htmlAttributes,
            FormMethod method)
            where T : SurfaceController => html.BeginSbnForm(action, typeof(T), additionalRouteVals, htmlAttributes, method);
        ...
        public static MvcForm BeginSbnForm<T>(
            ...
            object additionalRouteVals,
            object htmlAttributes)
            where T : SurfaceController => html.BeginSbnForm(action, typeof(T), additionalRouteVals, htmlAttributes);
            ...
            FormMethod method)
        {
            ...
            return html.BeginSbnForm(action, metaData.ControllerName, area, additionalRouteVals, htmlAttributes, method);
        }
        ...
        public static MvcForm BeginSbnForm(
            ...
            object additionalRouteVals,
            IDictionary<string, object> htmlAttributes)
            => html.BeginSbnForm(action, surfaceType, additionalRouteVals, htmlAttributes, FormMethod.Post);
        ...
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, string controllerName, string area, FormMethod method)
            => html.BeginSbnForm(action, controllerName, area, null, new Dictionary<string, object>(), method);

        /// <summary>
        /// Helper method to create a new form to execute in the Sbn request pipeline to a surface controller plugin
        /// </summary>
        public static MvcForm BeginSbnForm(this IHtmlHelper html, string action, string controllerName, string area)
            => html.BeginSbnForm(action, controllerName, area, null, new Dictionary<string, object>());
            ...
            FormMethod method)
        {
            ...
            ISbnContextAccessor sbnContextAccessor = GetRequiredService<ISbnContextAccessor>(html);
            var sbnContext = sbnContextAccessor.GetRequiredSbnContext();
            var formAction = sbnContext.OriginalRequestUrl.PathAndQuery;
        ...
        public static MvcForm BeginSbnForm(
            ...
            string area,
            object additionalRouteVals,
            IDictionary<string, object> htmlAttributes) => html.BeginSbnForm(action, controllerName, area, additionalRouteVals, htmlAttributes, FormMethod.Post);
            ...
            object additionalRouteVals = null)
        {
            ...
            // new SbnForm:
            var theForm = new SbnForm(htmlHelper.ViewContext, htmlEncoder, surfaceController, surfaceAction, area, additionalRouteVals);
