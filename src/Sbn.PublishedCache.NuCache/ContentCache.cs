...
using Sbn.Cms.Infrastructure.PublishedCache.Navigable;
...
namespace Sbn.Cms.Infrastructure.PublishedCache
{
    public class ContentCache : PublishedCacheBase, IPublishedContentCache, INavigableData, IDisposable
    {
        ...
        // it's too late for SbnContext which has captured previewDefault and stuff into these ctor vars
        // but, no, SbnContext returns snapshot.Content which comes from elements SO a resync should create a new cache
