...
using Sbn.Cms.Infrastructure.PublishedCache.Snap;
...
namespace Sbn.Cms.Infrastructure.PublishedCache
{
    ...
    public class ContentStore
    {
        ...
        private bool BuildKit(ContentNodeKit kit, out LinkedNode<ContentNode> parent)
        {
            ...
            // We cannot continue if there's no value. This shouldn't happen but it can happen if the database sbnNode.path
        ...
        private void AddTreeNodeLocked(ContentNode content, LinkedNode<ContentNode> parentLink = null)
        {
            ...
            // see https://github.com/sbn/Sbn-CMS/issues/7868
            if (parent == null)
