/**
 * @ngdoc service
 * @name sbn.services.macroService
 *
 *
 * @description
...
function macroService() {
    ...
    return {
        ...
        /** parses the special macro syntax like <?SBN_MACRO macroAlias="Map" /> and returns an object with the macro alias and it's parameters */
        parseMacroSyntax: function (syntax) {
            ...
            var expression = /(<\?SBN_MACRO (?:.+?)?macroAlias=["']([^\"\'\n\r]+?)["'][\s\S]+?)(\/>|>.*?<\/\?SBN_MACRO>)/i;
            ...
            var paramsChunk = match[1].trim().replace(new RegExp("SBN_MACRO macroAlias=[\"']" + alias + "[\"']"), "").trim();
        ...
        /**
         * @ngdoc function
         * @name sbn.services.macroService#generateMacroSyntax
         * @methodOf sbn.services.macroService
         * @function
         *
         * @description
         * generates the syntax for inserting a macro into a rich text editor - this is the very old sbn style syntax
         *
         * @param {object} args an object containing the macro alias and it's parameter values
         */
        generateMacroSyntax: function (args) {

            // <?SBN_MACRO macroAlias="BlogListPosts" />

            var macroString = '<?SBN_MACRO macroAlias=\"' + args.macroAlias + "\" ";
        ...
        /**
         * @ngdoc function
         * @name sbn.services.macroService#generateMvcSyntax
         * @methodOf sbn.services.macroService
         * @function
         *
         * @description
        ...
        generateMvcSyntax: function (args) {
            ...
            var macroString = "@await Sbn.RenderMacroAsync(\"" + args.macroAlias + "\"";
...
angular.module('sbn.services').factory('macroService', macroService);
