/**
 @ngdoc service
 * @name sbn.services.focusService
 *
 * @description
 * <b>Added in Sbn 8.1</b>. Application-wide service for focus related stuff.
 * 
 */
...
(function () {
    ...
    function focusService() {
        ...
        var service = {
            ...
            /**
            * @ngdoc function
            * @name sbn.services.focusService#getLastKnownFocus
            * @methodOf sbn.services.focusService
            * @function
             *
             * @description
            ...
            /**
             * @ngdoc function
             * @name sbn.services.focusService#rememberFocus
             * @methodOf sbn.services.focusService
             * @function
             *
             * @description
            ...
            /**
             * @ngdoc function
             * @name sbn.services.focusService#setLastKnownFocus
             * @methodOf sbn.services.focusService
             * @function
             *
             * @description
    ...
    angular.module("sbn.services").factory("focusService", focusService);
