/**
 * @ngdoc service
 * @name sbn.services.notificationsService
 *
 * @requires $rootScope
 * @requires $timeout
 ...
 *
 * @description
 * Application-wide service for handling notifications, the sbn application
 ...
 * sure the sbn.services module is accesible - which it should be by default.
 *
 * <pre>
...
.factory('notificationsService', function ($rootScope, $timeout, angularHelper) {
	...
	var service = {
		...
		/**
		* @ngdoc method
		* @name sbn.services.notificationsService#add
		* @methodOf sbn.services.notificationsService
		*
		* @description
		...
		*/
	    ...
	    /**
		 * @ngdoc method
		 * @name sbn.services.notificationsService#showNotification
		 * @methodOf sbn.services.notificationsService
		 *
		 * @description
	    ...
	    /**
		 * @ngdoc method
		 * @name sbn.services.notificationsService#success
		 * @methodOf sbn.services.notificationsService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.notificationsService#error
		 * @methodOf sbn.services.notificationsService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.notificationsService#warning
		 * @methodOf sbn.services.notificationsService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.notificationsService#remove
		 * @methodOf sbn.services.notificationsService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.notificationsService#removeAll
		 * @methodOf sbn.services.notificationsService
		 *
		 * @description
		...
		/**
		 * @ngdoc property
		 * @name sbn.services.notificationsService#current
		 * @propertyOf sbn.services.notificationsService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.notificationsService#getCurrent
		 * @methodOf sbn.services.notificationsService
		 *
		 * @description
