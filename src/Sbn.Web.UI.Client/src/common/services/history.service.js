/**
 * @ngdoc service
 * @name sbn.services.historyService
 *
 * @requires $rootScope 
 * @requires $timeout
 ...
 *
 * <pre>
 *      angular.module("sbn").controller("my.controller". function(historyService){
 *         historyService.add({
 *								icon: "icon-class",
...
.factory('historyService', function ($rootScope, $timeout, angularHelper, eventsService) {
	...
	return {
		/**
		 * @ngdoc method
		 * @name sbn.services.historyService#add
		 * @methodOf sbn.services.historyService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.historyService#remove
		 * @methodOf sbn.services.historyService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.historyService#removeAll
		 * @methodOf sbn.services.historyService
		 *
		 * @description
		...
		/**
		 * @ngdoc method
		 * @name sbn.services.historyService#getCurrent
		 * @methodOf sbn.services.historyService
		 *
		 * @description
        ...
        /**
		 * @ngdoc method
		 * @name sbn.services.historyService#getLastAccessedItemForSection
		 * @methodOf sbn.services.historyService
		 *
		 * @description
