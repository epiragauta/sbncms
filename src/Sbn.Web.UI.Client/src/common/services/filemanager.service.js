...
function fileManager($rootScope) {
    ...
    var mgr = {
        /**
         * @ngdoc function
         * @name sbn.services.fileManager#setFiles
         * @methodOf sbn.services.fileManager
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.fileManager#getFiles
         * @methodOf sbn.services.fileManager
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.fileManager#clearFiles
         * @methodOf sbn.services.fileManager
         * @function
         *
         * @description
...
angular.module('sbn.services').factory('fileManager', fileManager);
