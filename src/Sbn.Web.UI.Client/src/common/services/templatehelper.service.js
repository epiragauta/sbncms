(function() {
   ...
   function templateHelperService(localizationService) {
        ...
        //crappy hack due to dictionary items not in sbnNode table
        function getInsertDictionarySnippet(nodeName) {
            return "@Sbn.GetDictionaryValue(\"" + nodeName + "\")";
        }
        ...
        function getTemplateEditorShortcuts(){
            ...
            return localizationService.localizeMany(keys).then(function(data){
                ...
                return {
			        "name": "Sbn", //No need to localise Sbn is the same in all languages :)
			        "shortcuts": [
                        {
   ...
   angular.module('sbn.services').factory('templateHelper', templateHelperService);
