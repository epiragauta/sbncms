...
function iconHelper($http, $q, $sce, $timeout) {
    ...
    function init() {
        ...
        $http({ method: "GET", url: Sbn.Sys.ServerVariables.sbnUrls.iconApiBaseUrl + 'GetIcons' })
...
angular.module('sbn.services').factory('iconHelper', iconHelper);
