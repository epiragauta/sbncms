/**
 * @ngdoc service
 * @name sbn.services.contentTypeHelper
...
function contentTypeHelper(contentTypeResource, dataTypeResource, $filter, $injector, $q) {
    ...
    var contentTypeHelperService = {
        ...
        generateLocalAlias: function(name) {
            return name ? name.toSbnAlias() : String.CreateGuid();
        },
        ...
        generateModels: function () {
            ...
            var modelsBuilderEnabled = Sbn.Sys.ServerVariables.sbnPlugins.modelsBuilder.mode !== "Nothing";
        ...
        checkModelsBuilderStatus: function () {
            var deferred = $q.defer();
            var modelsResource = $injector.has("modelsBuilderManagementResource") ? $injector.get("modelsBuilderManagementResource") : null;
            var modelsBuilderEnabled = (Sbn && Sbn.Sys && Sbn.Sys.ServerVariables && Sbn.Sys.ServerVariables.sbnPlugins && Sbn.Sys.ServerVariables.sbnPlugins.modelsBuilder && Sbn.Sys.ServerVariables.sbnPlugins.modelsBuilder.mode !== "Nothing");
        ...
        rebindSavedContentType: function (contentType, savedContentType) {
            ...
            // Prevent rebinding if there was an error: https://github.com/sbn/Sbn-CMS/pull/11257
...
angular.module('sbn.services').factory('contentTypeHelper', contentTypeHelper);
