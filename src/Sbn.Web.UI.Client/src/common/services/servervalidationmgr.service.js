/**
 * @ngdoc service
 * @name sbn.services.serverValidationManager
 * @function
 *
 * @description
 ...
 * https://github.com/sbn/Sbn-CMS/pull/8339
 * 
 */
function serverValidationManager($timeout) {
     ...
     * @ngdoc function
     * @name notify
     * @methodOf sbn.services.serverValidationManager
     * @function
     *
     * @description
...
angular.module('sbn.services').factory('serverValidationManager', serverValidationManager);
