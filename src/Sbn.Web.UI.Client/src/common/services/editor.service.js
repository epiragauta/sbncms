/**
 @ngdoc service
 * @name sbn.services.editorService
 *
 * @description
 * Added in Sbn 8.0. Application-wide service for handling infinite editing.
 *
 *
 *
 *
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.MediaPickerController", MediaPickerController);
    })();
</pre>
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.Controller", Controller);
    })();
</pre>

<h3><strong>The custom infinite editor view</strong></h3>
When building a custom infinite editor view you can use the same components as a normal editor ({@link sbn.directives.directive:umbEditorView umbEditorView}).
<pre>
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.InfiniteEditorController", InfiniteEditorController);
    })();
</pre>
 */
...
(function () {
    ...
    function editorService(eventsService, keyboardService, $timeout) {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#getEditors
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#getNumberOfEditors
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#blur
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#open
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#close
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#closeAll
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#contentEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#contentPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#contentTypePicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#mediaTypePicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#memberTypePicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#copy
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#move
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#embed
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#rollback
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#linkPicker
         * @methodOf sbn.services.editorService
         *
         * @description
         * Opens an embed editor in infinite editing.
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#mediaEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#mediaPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#mediaCropDetails
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#iconPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#documentTypeEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#mediaTypeEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#memberTypeEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#queryBuilder
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#treePicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#nodePermissions
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#insertCodeSnippet
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#userGroupPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#userGroupEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#templateEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#sectionPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#insertField
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#templateSections
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#userPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
        * @ngdoc method
        * @name sbn.services.editorService#filePicker
        * @methodOf sbn.services.editorService
        *
        * @description
        ...
        */
        ...
        /**
        * @ngdoc method
        * @name sbn.services.editorService#staticFilePicker
        * @methodOf sbn.services.editorService
        *
        * @description
        ...
        */
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#itemPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#macroPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#memberGroupPicker
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
        * @ngdoc method
        * @name sbn.services.editorService#memberPicker
        * @methodOf sbn.services.editorService
        *
        * @description
        ...
        */
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#memberEditor
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#storeKeyboardShortcuts
         * @methodOf sbn.services.editorService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.editorService#rebindKeyboardShortcuts
         * @methodOf sbn.services.editorService
         *
         * @description
    ...
    angular.module("sbn.services").factory("editorService", editorService);
