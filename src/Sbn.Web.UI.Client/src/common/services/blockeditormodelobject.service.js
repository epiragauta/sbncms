/**
 * @ngdoc service
 * @name sbn.services.blockEditorModelObject
 *
 * @description
 * <b>Added in Sbn 8.7</b>. Model Object for dealing with data of Block Editors.
 *
 ...
 * See {@link sbn.services.blockEditorService blockEditorService}
 *
 */
(function () {
    'use strict';
    ...
    function blockEditorModelObjectFactory($interpolate, $q, udiService, contentResource, localizationService, umbRequestHelper, clipboardService, notificationsService) {
         ...
         * @ngdoc method
         * @name constructor
         * @methodOf sbn.services.blockEditorModelObject
    ...
    angular.module('sbn.services').service('blockEditorModelObject', blockEditorModelObjectFactory);
