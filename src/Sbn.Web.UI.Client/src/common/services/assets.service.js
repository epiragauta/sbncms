/**
 * @ngdoc service
 * @name sbn.services.assetsService
 *
 * @requires $q
 ...
 *
 * <pre>
 *      angular.module("sbn").controller("my.controller". function(assetsService){
...
angular.module('sbn.services')
    .factory('assetsService', function ($q, $log, angularHelper, umbRequestHelper, $rootScope, $http, userService, javascriptLibraryResource) {
        ...
        function appendRnd(url) {
            //if we don't have a global sbn obj yet, the app is bootstrapping
            if (!Sbn.Sys.ServerVariables.application) {
                return url;
            }
        ...
        var service = {
            ...
            */
            ...
            /**
             * @ngdoc method
             * @name sbn.services.assetsService#loadCss
             * @methodOf sbn.services.assetsService
             *
             * @description
            ...
            /**
             * @ngdoc method
             * @name sbn.services.assetsService#loadJs
             * @methodOf sbn.services.assetsService
             *
             * @description
            ...
            /**
             * @ngdoc method
             * @name sbn.services.assetsService#load
             * @methodOf sbn.services.assetsService
             *
             * @description
