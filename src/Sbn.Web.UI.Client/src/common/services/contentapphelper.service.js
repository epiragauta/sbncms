...
/**
* @ngdoc service
* @name sbn.services.contentAppHelper
...
function contentAppHelper() {
    ...
    /**
    * @ngdoc method
    * @name sbn.services.contentAppHelper#isContentBasedApp
    * @methodOf sbn.services.contentAppHelper
    *
...
angular.module('sbn.services').factory('contentAppHelper', contentAppHelper);
