...
function formHelper(angularHelper, serverValidationManager, notificationsService, overlayService) {
    return {
        ...
        /**
         * @ngdoc function
         * @name sbn.services.formHelper#submitForm
         * @methodOf sbn.services.formHelper
         * @function
         *
         * @description
        ...
        submitForm: function (args) {
         ...
         /**
         * @ngdoc function
         * @name sbn.services.formHelper#focusOnFirstError
         * @methodOf sbn.services.formHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.formHelper#handleError
         * @methodOf sbn.services.formHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.formHelper#handleServerValidation
         * @methodOf sbn.services.formHelper
         * @function
         *
         * @description
...
angular.module('sbn.services').factory('formHelper', formHelper);
