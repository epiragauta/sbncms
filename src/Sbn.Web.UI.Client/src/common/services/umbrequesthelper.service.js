/**
* @ngdoc service
* @name sbn.services.umbRequestHelper
...
function umbRequestHelper($http, $q, notificationsService, eventsService, formHelper, overlayService) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.umbRequestHelper#convertVirtualToAbsolutePath
         * @methodOf sbn.services.umbRequestHelper
         * @function
         *
         * @description
        ...
        convertVirtualToAbsolutePath: function (virtualPath) {
            ...
            if (!Sbn.Sys.ServerVariables.application.applicationPath) {
                throw "No applicationPath defined in Sbn.ServerVariables.application.applicationPath";
            }
            return Sbn.Sys.ServerVariables.application.applicationPath + virtualPath.trimStart("~/");
        },


        /**
         * @ngdoc method
         * @name sbn.services.umbRequestHelper#dictionaryToQueryString
         * @methodOf sbn.services.umbRequestHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.umbRequestHelper#getApiUrl
         * @methodOf sbn.services.umbRequestHelper
         * @function
         *
         * @description
         ...
         *
         * @param {string} apiName The webapi name that is found in the servervariables["sbnUrls"] dictionary
        ...
        getApiUrl: function (apiName, actionName, queryStrings) {
            if (!Sbn || !Sbn.Sys || !Sbn.Sys.ServerVariables || !Sbn.Sys.ServerVariables["sbnUrls"]) {
                throw "No server variables defined!";
            }

            if (!Sbn.Sys.ServerVariables["sbnUrls"][apiName]) {
                throw "No url found for api name " + apiName;
            }

            return Sbn.Sys.ServerVariables["sbnUrls"][apiName] + actionName +
        ...
        /**
         * @ngdoc function
         * @name sbn.services.umbRequestHelper#resourcePromise
         * @methodOf sbn.services.umbRequestHelper
         * @function
         *
         * @description
        ...
        resourcePromise: function (httpPromise, opts) {
            ...
            return httpPromise.then(function (response) {
                ...
                if (response.status >= 500 && response.status < 600) {
                    ...
                    //show a ysod dialog
                    if (Sbn.Sys.ServerVariables["isDebuggingEnabled"] === true) {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.contentResource#postSaveContent
            ...
            return this.postMultiPartRequest(
                ...
                function (data, formData) {
                    ...
                    if (response.status >= 500 && response.status < 600) {
                        ...
                        else if (Sbn.Sys.ServerVariables["isDebuggingEnabled"] === true) {
                            //show a ysod dialog
                            const error = { errorMsg: 'An error occurred', data: response.data };
                            // TODO: All YSOD handling should be done with an interceptor
                            overlayService.ysod(error);
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.contentResource#downloadFile
         * @methodOf sbn.resources.contentResource
         *
         * @description
...
angular.module('sbn.services').factory('umbRequestHelper', umbRequestHelper);
