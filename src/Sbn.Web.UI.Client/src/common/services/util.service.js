...
angular.module('sbn.services').factory('versionHelper', versionHelper);
...
function dateHelper() {
    ...
    return {
        ...
        getLocalDate: function (date, culture, format) {
            if (date) {
                var dateVal;
                var serverOffset = Sbn.Sys.ServerVariables.application.serverTimeOffset;
...
angular.module('sbn.services').factory('dateHelper', dateHelper);
...
angular.module('sbn.services').factory('packageHelper', packageHelper);

/**
 * @ngdoc function
 * @name sbn.services.umbModelMapper
 * @function
 *
 * @description
...
function umbModelMapper() {
    ...
    return {
        ...
        /**
         * @ngdoc function
         * @name sbn.services.umbModelMapper#convertToEntityBasic
         * @methodOf sbn.services.umbModelMapper
         * @function
         *
         * @description
...
angular.module('sbn.services').factory('umbModelMapper', umbModelMapper);

/**
 * @ngdoc function
 * @name sbn.services.umbSessionStorage
 * @function
 *
 * @description
...
angular.module('sbn.services').factory('umbSessionStorage', umbSessionStorage);

/**
 * @ngdoc function
 * @name sbn.services.updateChecker
 * @function
 *
 * @description
...
function updateChecker($http, umbRequestHelper) {
    return {
        ...
        /**
         * @ngdoc function
         * @name sbn.services.updateChecker#check
         * @methodOf sbn.services.updateChecker
         * @function
         *
         * @description
...
angular.module('sbn.services').factory('updateChecker', updateChecker);

/**
* @ngdoc service
* @name sbn.services.umbPropertyEditorHelper
...
function umbPropEditorHelper() {
    return {
         ...
         * @methodOf sbn.services.umbPropertyEditorHelper
         * @function    
         *
         * @description
         * Returns the correct view path for a property editor, it will detect if it is a full virtual path but if not then default to the internal sbn one
         * 
...
angular.module('sbn.services').factory('umbPropEditorHelper', umbPropEditorHelper);
