/**
 * @ngdoc service
 * @name sbn.services.sbnMenuActions
 *
 * @requires q
 ...
 */
function sbnMenuActions(treeService, $location, navigationService, appState, localizationService, usersResource, umbRequestHelper, notificationsService) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.sbnMenuActions#RefreshNode
         * @methodOf sbn.services.sbnMenuActions
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.sbnMenuActions#CreateChildEntity
         * @methodOf sbn.services.sbnMenuActions
         * @function
         *
         * @description
...
angular.module('sbn.services').factory('sbnMenuActions', sbnMenuActions);
