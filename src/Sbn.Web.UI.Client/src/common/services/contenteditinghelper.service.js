...
/**
* @ngdoc service
* @name sbn.services.contentEditingHelper
...
function contentEditingHelper(fileManager, $q, $location, $routeParams, editorState, notificationsService, navigationService, localizationService, serverValidationManager, formHelper, contentTypeHelper) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.contentEditingHelper#getAllProps
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.contentEditingHelper#buildCompositeVariantId
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.contentEditingHelper#configureButtons
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.contentEditingHelper#getButtonFromAction
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.contentEditingHelper#reBindChangedProperties
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.contentEditingHelper#handleSaveError
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.contentEditingHelper#handleSuccessfulSave
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.contentEditingHelper#redirectToCreatedContent
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.contentEditingHelper#redirectToRenamedContent
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.contentEditingHelper#sortVariants
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.contentEditingHelper#getSortedVariantsAndSegments
         * @methodOf sbn.services.contentEditingHelper
         * @function
         *
         * @description
...
angular.module('sbn.services').factory('contentEditingHelper', contentEditingHelper);
