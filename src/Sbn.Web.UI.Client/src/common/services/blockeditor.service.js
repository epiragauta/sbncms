/**
 * @ngdoc service
 * @name sbn.services.blockEditorService
 *
 * @description
 * <b>Added in Sbn 8.7</b>. Service for dealing with Block Editors.
 *
 ...
 *
 *
 * See {@link sbn.services.blockEditorModelObject BlockEditorModelObject} for more samples.
 *
 */
(function () {
    'use strict';
     ...
     */
    angular.module('sbn').run(['clipboardService', 'udiService', function (clipboardService, udiService) {
    ...
    function blockEditorService(blockEditorModelObject) {
         ...
         * @methodOf sbn.services.blockEditorService
         *
         * @description
         * Create a new Block Editor Model Object.
         * See {@link sbn.services.blockEditorModelObject blockEditorModelObject}
         *
         * @see sbn.services.blockEditorModelObject
    ...
    angular.module('sbn.services').service('blockEditorService', blockEditorService);
