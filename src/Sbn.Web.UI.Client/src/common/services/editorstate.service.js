 ...
 */
angular.module('sbn.services').factory("editorState", function ($rootScope, eventsService) {
    ...
    var state = {
        ...
        /**
         * @ngdoc function
         * @name sbn.services.angularHelper#set
         * @methodOf sbn.services.editorState
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.angularHelper#reset
         * @methodOf sbn.services.editorState
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.angularHelper#getCurrent
         * @methodOf sbn.services.editorState
         * @function
         *
         * @description
