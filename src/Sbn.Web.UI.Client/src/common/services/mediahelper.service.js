...
function mediaHelper(umbRequestHelper, $http, $log) {
    ...
    return {
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#getImagePropertyValue
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        getMediaPropertyValue: function (options) {
            ...
            var mediaRoot = Sbn.Sys.ServerVariables.sbnSettings.mediaPath;
            var imageProp = _.find(props, function (item) {
                if (item.alias === "sbnFile") {
                    return true;
                }
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#getThumbnail
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#resolveFileFromEntity
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#resolveFile
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#scaleToMaxSize
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#getThumbnailFromPath
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#detectIfImageByExtension
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        detectIfImageByExtension: function (imagePath) {
            ...
            return ("," + Sbn.Sys.ServerVariables.sbnSettings.imageFileTypes + ",").indexOf("," + ext + ",") !== -1;
        },

        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#formatFileTypes
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#getFileExtension
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.services.mediaHelper#getProcessedImageUrl
         * @methodOf sbn.services.mediaHelper
         * @function
         *
         * @description
...
} angular.module('sbn.services').factory('mediaHelper', mediaHelper);
