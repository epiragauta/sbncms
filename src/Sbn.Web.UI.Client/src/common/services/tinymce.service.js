/**
 * @ngdoc service
 * @name sbn.services.tinyMceService
 *
 *
 * @description
 * A service containing all logic for all of the Sbn TinyMCE plugins
 */
function tinyMceService($rootScope, $q, imageHelper, $locale, $http, $timeout, stylesheetResource, macroResource, macroService,
    ...
    function getStyles(configuredStylesheets) {
        ...
        if (configuredStylesheets) {
            configuredStylesheets.forEach(function (val, key) {
                ...
                if (val.indexOf(Sbn.Sys.ServerVariables.sbnSettings.cssPath + "/") === 0) {
                    ...
                    stylesheets.push(Sbn.Sys.ServerVariables.sbnSettings.cssPath + "/" + val + ".css");
                }
        ...
        return $q.all(promises).then(function() {
            // Always push our Sbn RTE stylesheet
            // So we can style macros, embed items etc...
            stylesheets.push(`${Sbn.Sys.ServerVariables.sbnSettings.sbnPath}/assets/css/rte-content.css`);
    ...
    function uploadImageHandler(blobInfo, success, failure, progress){
        ...
        xhr.open('POST', Sbn.Sys.ServerVariables.sbnUrls.tinyMceApiBaseUrl + 'UploadImage');
    ...
    return {
        ...
        getTinyMceEditorConfig: function (args) {
            ...
            tinymce.baseURL = Sbn.Sys.ServerVariables.sbnSettings.sbnPath + "/lib/tinymce/"; // trailing slash important
            ...
            return $q.all(promises).then(function(result) {
                ...
                var config = {
                    ...
                    cache_suffix: "?umb__rnd=" + Sbn.Sys.ServerVariables.application.cacheBuster
                };
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tinyMceService#configuration
         * @methodOf sbn.services.tinyMceService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tinyMceService#defaultPrevalues
         * @methodOf sbn.services.tinyMceService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tinyMceService#createInsertEmbeddedMedia
         * @methodOf sbn.services.tinyMceService
         *
         * @description
         * Creates the sbn insert embedded media tinymce plugin
         *
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tinyMceService#createMediaPicker
         * @methodOf sbn.services.tinyMceService
         *
         * @description
         * Creates the sbn insert media tinymce plugin
         *
         * @param {Object} editor the TinyMCE editor instance
         */
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tinyMceService#createSbnMacro
         * @methodOf sbn.services.tinyMceService
         *
         * @description
         * Creates the insert sbn macro tinymce plugin
         *
         * @param {Object} editor the TinyMCE editor instance
         */
        ...
        /** Helper method to initialize the tinymce editor within Sbn */
        initializeEditor: function (args) {
            ...
            self.createAceCodeEditor(args.editor, function () {
                ...
                html = html.replace(/(<div class=".*?umb-macro-holder.*?mceNonEditable.*?"><!-- <\?SBN_MACRO macroAlias="(.*?)".*?\/> --> *<ins>)[\s\S]*?(<\/ins> *<\/div>)/ig, "$1Macro alias: <strong>$2</strong>$3");
                */
...
angular.module('sbn.services').factory('tinyMceService', tinyMceService);
