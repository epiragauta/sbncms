/**
* @ngdoc service
* @name sbn.services.cropperHelper
...
function cropperHelper(umbRequestHelper, $http) {
	var service = {
		...
		/**
		* @ngdoc method
		* @name sbn.services.cropperHelper#configuration
		* @methodOf sbn.services.cropperHelper
		*
		* @description
...
angular.module('sbn.services').factory('cropperHelper', cropperHelper);
