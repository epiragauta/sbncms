...
function treeService($q, treeResource, iconHelper, notificationsService, eventsService) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getTreePackageFolder
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        getTreePackageFolder: function (treeAlias) {
            ...
            if (Sbn.Sys.ServerVariables.sbnPlugins &&
                Sbn.Sys.ServerVariables.sbnPlugins.trees &&
                Utilities.isArray(Sbn.Sys.ServerVariables.sbnPlugins.trees)) {

                var found = _.find(Sbn.Sys.ServerVariables.sbnPlugins.trees, function (item) {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#clearCache
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#loadNodeChildren
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#removeNode
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#removeChildNodes
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getChildNode
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getDescendantNode
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getTreeRoot
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getTreeAlias
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getTree
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getMenu
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getChildren
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#reloadNode
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.treeService#getPath
         * @methodOf sbn.services.treeService
         * @function
         *
         * @description
...
angular.module('sbn.services').factory('treeService', treeService);
