/**
 * @ngdoc service
 * @name sbn.services.clipboardService
 *
...
function clipboardService($window, notificationsService, eventsService, localStorageService, iconHelper) {
    ...
    var prepareEntryForStorage = function(type, entryData, firstLevelClearupMethod) {
        ...
        if(typeResolver) {
            ...
            console.warn("Sbn.service.clipboardService has no type resolver for '" + type + "'.");
        }
    ...
    /**
    * @ngdoc method
    * @name sbn.services.clipboardService#parseContentForPaste
    * @methodOf sbn.services.clipboardService
    *
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.clipboardService#registrerClearPropertyResolver
    * @methodOf sbn.services.clipboardService
    *
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.clipboardService#registerClearPropertyResolver
    * @methodOf sbn.services.clipboardService
    *
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.clipboardService#registerPastePropertyResolver
    * @methodOf sbn.services.clipboardService
    *
    * @param {method} function A method executed for every property and inner properties copied. Notice the method both needs to deal with retriving a property object {alias:..editor:..value:... ,...} and the raw property value as if the property is an inner property of a nested property.
    * @param {string} string A string representing the property type format for this resolver to execute for.
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.clipboardService#registrerTypeResolvers
    * @methodOf sbn.services.clipboardService
    *
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.clipboardService#copy
    * @methodOf sbn.services.clipboardService
    *
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.clipboardService#copyArray
    * @methodOf sbn.services.clipboardService
    *
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.supportsCopy#supported
    * @methodOf sbn.services.clipboardService
    *
    * @description
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.supportsCopy#hasEntriesOfType
    * @methodOf sbn.services.clipboardService
    *
    ...
    */
    ...
    /**
    * @ngdoc method
    * @name sbn.services.supportsCopy#retriveEntriesOfType
    * @methodOf sbn.services.clipboardService
    *
...
angular.module("sbn.services").factory("clipboardService", clipboardService);
