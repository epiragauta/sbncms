/**
 * @ngdoc service
 * @name sbn.services.localizationService
 *
 * @requires $http
 * @requires $q
 * @requires $window
...
.factory('localizationService', function ($http, $q, eventsService) {
    ...
    var service = {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.localizationService#tokenize
         * @methodOf sbn.services.localizationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.localizationService#tokenReplace
         * @methodOf sbn.services.localizationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.localizationService#localize
         * @methodOf sbn.services.localizationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.localizationService#localizeMany
         * @methodOf sbn.services.localizationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.localizationService#concat
         * @methodOf sbn.services.localizationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.localizationService#format
         * @methodOf sbn.services.localizationService
         *
         * @description
