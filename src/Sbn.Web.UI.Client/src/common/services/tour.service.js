/**
 @ngdoc service
 * @name sbn.services.tourService
 *
 * @description
 * <b>Added in Sbn 7.8</b>. Application-wide service for handling tours.
 */
(function () {
    'use strict';
    ...
    function tourService(eventsService, currentUserResource, $q, tourResource) {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tourService#startTour
         * @methodOf sbn.services.tourService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tourService#endTour
         * @methodOf sbn.services.tourService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tourService#completeTour
         * @methodOf sbn.services.tourService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tourService#getCurrentTour
         * @methodOf sbn.services.tourService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tourService#getGroupedTours
         * @methodOf sbn.services.tourService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.tourService#getTourByAlias
         * @methodOf sbn.services.tourService
         *
         * @description
        ...
        /**
        * @ngdoc method
        * @name sbn.services.tourService#getToursForDoctype
        * @methodOf sbn.services.tourService
        *
        * @description
    ...
    angular.module("sbn.services").factory("tourService", tourService);
