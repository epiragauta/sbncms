/**
 * @ngdoc service
 * @name sbn.services.navigationService
 *
 * @requires $rootScope
...
function navigationService($routeParams, $location, $q, $injector, eventsService, umbModelMapper, treeService, appState, backdropService) {
    ...
    var service = {
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#isRouteChangingNavigation
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#waitForNavReady
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#clearSearch
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#setSoftRedirect
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#retainQueryStrings
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#load
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#changeSection
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#showTree
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#syncTree
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#hasTree
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        */
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#hideTree
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#showMenu
         * @methodOf sbn.services.navigationService
         *
         * @description
         * Hides the tree by hiding the containing dom element.
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#hideMenu
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.services.navigationService#showDialog
         * @methodOf sbn.services.navigationService
         *
         * @description
        ...
        /**
          * @ngdoc method
          * @name sbn.services.navigationService#getTreeTemplateUrl
          * @methodOf sbn.services.navigationService
          *
        ...
        getTreeTemplateUrl: function (treeAlias, action) {
            ...
            if (packageTreeFolder) {
                return (Sbn.Sys.ServerVariables.sbnSettings.appPluginsPath +
                    "/" + packageTreeFolder +
        ...
        /**
          * @ngdoc method
          * @name sbn.services.navigationService#allowHideDialog
          * @methodOf sbn.services.navigationService
          *
        ...
        /**
	     * @ngdoc method
	     * @name sbn.services.navigationService#hideDialog
	     * @methodOf sbn.services.navigationService
	     *
	     * @description
        ...
        /**
          * @ngdoc method
          * @name sbn.services.navigationService#showSearch
          * @methodOf sbn.services.navigationService
          *
          * @description
        ...
        /**
          * @ngdoc method
          * @name sbn.services.navigationService#hideSearch
          * @methodOf sbn.services.navigationService
          *
          * @description
        ...
        */
        ...
        /**
          * @ngdoc method
          * @name sbn.services.navigationService#hideNavigation
          * @methodOf sbn.services.navigationService
          *
          * @description
...
angular.module('sbn.services').factory('navigationService', navigationService);
