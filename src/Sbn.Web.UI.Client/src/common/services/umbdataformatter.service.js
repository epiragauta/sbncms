(function () {
    ...
    /**
    * @ngdoc service
    * @name sbn.services.umbDataFormatter
    * @description A helper object used to format/transform JSON Sbn data, mostly used for persisting data to the server
    **/
    ...
    angular.module('sbn.services').factory('umbDataFormatter', umbDataFormatter);
