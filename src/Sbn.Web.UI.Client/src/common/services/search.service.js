/**
 * @ngdoc service
 * @name sbn.services.searchService
 *
 *
 * @description
...
angular.module('sbn.services')
    .factory('searchService', function (entityResource, $injector, searchResultFormatter) {
        ...
        return {
            ...
            /**
            * @ngdoc method
            * @name sbn.services.searchService#searchMembers
            * @methodOf sbn.services.searchService
            *
            * @description
            ...
            */
            ...
            /**
            * @ngdoc method
            * @name sbn.services.searchService#searchContent
            * @methodOf sbn.services.searchService
            *
            * @description
            ...
            */
            ...
            /**
            * @ngdoc method
            * @name sbn.services.searchService#searchMedia
            * @methodOf sbn.services.searchService
            *
            * @description
            ...
            */
            ...
            /**
            * @ngdoc method
            * @name sbn.services.searchService#searchAll
            * @methodOf sbn.services.searchService
            *
            * @description
