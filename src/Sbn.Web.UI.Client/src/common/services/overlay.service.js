/**
 @ngdoc service
 * @name sbn.services.overlayService
 *
 * @description
 * <b>Added in Sbn 8.0</b>. Application-wide service for handling overlays.
 */
(function () {
    "use strict";
    ...
    angular.module("sbn.services").factory("overlayService", overlayService);
