/**
 * @ngdoc service
 * @name sbn.resources.publicAccessResource
...
function publicAccessResource($http, umbRequestHelper) {
    ...
    return {    
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.publicAccessResource#getPublicAccess
          * @methodOf sbn.resources.publicAccessResource
          *
          * @description
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.publicAccessResource#updatePublicAccess
          * @methodOf sbn.resources.publicAccessResource
          *
          * @description
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.publicAccessResource#removePublicAccess
          * @methodOf sbn.resources.publicAccessResource
          *
          * @description
...
angular.module('sbn.resources').factory('publicAccessResource', publicAccessResource);
