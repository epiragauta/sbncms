/**
 * @ngdoc service
 * @name sbn.resources.logViewerResource
 * @description Retrives Sbn log items (by default from JSON files on disk)
 *
 *
 **/
...
angular.module('sbn.resources').factory('logViewerResource', logViewerResource);
