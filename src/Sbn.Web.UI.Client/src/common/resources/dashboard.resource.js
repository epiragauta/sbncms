/**
    * @ngdoc service
    * @name sbn.resources.dashboardResource
...
function dashboardResource($q, $http, umbRequestHelper) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dashboardResource#getDashboard
         * @methodOf sbn.resources.dashboardResource
         *
         * @description
        ...
        /**
        * @ngdoc method
        * @name sbn.resources.dashboardResource#getRemoteDashboardContent
        * @methodOf sbn.resources.dashboardResource
        *
        * @description
...
angular.module('sbn.resources').factory('dashboardResource', dashboardResource);