/**
 * @ngdoc service
 * @name sbn.resources.authResource
 * @description
 * This Resource perfomrs actions to common authentication tasks for the Sbn backoffice user
 *
 * @requires $q
 * @requires $http
...
function authResource($q, $http, umbRequestHelper, angularHelper) {
  ...
  return {
     /**
     * @ngdoc method
     * @name sbn.resources.authResource#get2FAProviders
     * @methodOf sbn.resources.authResource
     *
     * @description
     * Logs the Sbn backoffice user in if the credentials are good
     *
     * ##usage
     * <pre>
    ...
    */
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#performLogin
     * @methodOf sbn.resources.authResource
     *
     * @description
     * Logs the Sbn backoffice user in if the credentials are good
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#performRequestPasswordReset
     * @methodOf sbn.resources.authResource
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#performValidatePasswordResetCode
     * @methodOf sbn.resources.authResource
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.currentUserResource#getPasswordConfig
     * @methodOf sbn.resources.currentUserResource
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#performSetPassword
     * @methodOf sbn.resources.authResource
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#performLogout
     * @methodOf sbn.resources.authResource
     *
     * @description
     * Logs out the Sbn backoffice user
     *
     * ##usage
     * <pre>
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#getCurrentUser
     * @methodOf sbn.resources.authResource
     *
     * @description
     ...
     *    .then(function(data) {
     *        //Do stuff for fetching the current logged in Sbn backoffice user
     *    });
     * </pre>
     * @returns {Promise} resourcePromise object
     *
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#isAuthenticated
     * @methodOf sbn.resources.authResource
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name sbn.resources.authResource#getRemainingTimeoutSeconds
     * @methodOf sbn.resources.authResource
     *
     * @description
...
angular.module('sbn.resources').factory('authResource', authResource);
