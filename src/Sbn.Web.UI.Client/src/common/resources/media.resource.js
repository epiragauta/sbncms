/**
 * @ngdoc service
 * @name sbn.resources.mediaResource
...
function mediaResource($q, $http, umbDataFormatter, umbRequestHelper) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#sort
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#move
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#getById
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#deleteById
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#getByIds
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#getScaffold
         * @methodOf sbn.resources.mediaResource
         *
         * @description
         * Returns a scaffold of an empty media item, given the id of the media item to place it underneath and the media type alias.
         *
         * - Parent Id must be provided so sbn knows where to store the media
         * - Media Type alias must be provided so sbn knows which properties to put on the media scaffold
         *
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#getChildren
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#save
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#addFolder
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#getChildFolders
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#emptyRecycleBin
         * @methodOf sbn.resources.mediaResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaResource#search
         * @methodOf sbn.resources.mediaResource
         *
         * @description
...
angular.module('sbn.resources').factory('mediaResource', mediaResource);
