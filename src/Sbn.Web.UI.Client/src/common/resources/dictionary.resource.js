/**
    * @ngdoc service
    * @name sbn.resources.dictionaryResource
...
function dictionaryResource($q, $http, $location, umbRequestHelper, umbDataFormatter) {
  ...
  /**
         * @ngdoc method
         * @name sbn.resources.dictionaryResource#deleteById
         * @methodOf sbn.resources.dictionaryResource
         *
         * @description
  ...
  **/
  ...
  /**
         * @ngdoc method
         * @name sbn.resources.dictionaryResource#create
         * @methodOf sbn.resources.dictionaryResource
         *
         * @description
  ...
  **/
    ...
    /**
        * @ngdoc method
        * @name sbn.resources.dictionaryResource#save
        * @methodOf sbn.resources.dictionaryResource
        *
        * @description
    ...
    /**
         * @ngdoc method
         * @name sbn.resources.dictionaryResource#getList
         * @methodOf sbn.resources.dictionaryResource
         *
         * @description
...
angular.module("sbn.resources").factory("dictionaryResource", dictionaryResource);
