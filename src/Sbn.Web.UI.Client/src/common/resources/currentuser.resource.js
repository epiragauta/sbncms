/**
    * @ngdoc service
    * @name sbn.resources.currentUserResource
...
function currentUserResource($q, $http, umbRequestHelper, umbDataFormatter) {
    ...
    return {
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.currentUserResource#hasPermission
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.currentUserResource#changePassword
         * @methodOf sbn.resources.currentUserResource
         *
         * @description
...
angular.module('sbn.resources').factory('currentUserResource', currentUserResource);
