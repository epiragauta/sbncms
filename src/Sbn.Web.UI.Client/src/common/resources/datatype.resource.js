/**
    * @ngdoc service
    * @name sbn.resources.dataTypeResource
...
function dataTypeResource($q, $http, umbDataFormatter, umbRequestHelper) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#getPreValues
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
         ...
         * ##usage
         * <pre>
         * dataTypeResource.getPreValues("Sbn.MediaPicker", 1234)
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#getReferences
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#getById
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#getByName
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#deleteById
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#getCustomListView
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
        ...
        /**
        * @ngdoc method
        * @name sbn.resources.dataTypeResource#createCustomListView
        * @methodOf sbn.resources.dataTypeResource
        *
        * @description
        ...
        */
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#save
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.dataTypeResource#move
         * @methodOf sbn.resources.dataTypeResource
         *
         * @description
...
angular.module("sbn.resources").factory("dataTypeResource", dataTypeResource);
