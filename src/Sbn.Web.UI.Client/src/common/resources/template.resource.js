/**
    * @ngdoc service
    * @name sbn.resources.templateResource
...
function templateResource($q, $http, umbDataFormatter, umbRequestHelper, localizationService) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.templateResource#getById
         * @methodOf sbn.resources.templateResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.templateResource#getByAlias
         * @methodOf sbn.resources.templateResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.templateResource#getAll
         * @methodOf sbn.resources.templateResource
         *
         * @description
         * Gets all templates
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.templateResource#getScaffold
         * @methodOf sbn.resources.templateResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.templateResource#deleteById
         * @methodOf sbn.resources.templateResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.templateResource#save
         * @methodOf sbn.resources.templateResource
         *
         * @description
...
angular.module("sbn.resources").factory("templateResource", templateResource);
