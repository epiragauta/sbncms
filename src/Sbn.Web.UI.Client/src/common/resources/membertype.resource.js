/**
    * @ngdoc service
    * @name sbn.resources.memberTypeResource
...
function memberTypeResource($q, $http, umbRequestHelper, umbDataFormatter, localizationService) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.memberTypeResource#save
         * @methodOf sbn.resources.memberTypeResource
         *
         * @description
...
angular.module('sbn.resources').factory('memberTypeResource', memberTypeResource);
