/**
 * @ngdoc service
 * @name sbn.resources.templateQueryResource
 * @function
 *
 * @description
...
(function () {
    ...
    function templateQueryResource($http, umbRequestHelper) {
        ...
        /**
         * @ngdoc function
         * @name sbn.resources.templateQueryResource#getAllowedProperties
         * @methodOf sbn.resources.templateQueryResource
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.resources.templateQueryResource#getContentTypes
         * @methodOf sbn.resources.templateQueryResource
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.resources.templateQueryResource#getFilterConditions
         * @methodOf sbn.resources.templateQueryResource
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.resources.templateQueryResource#postTemplateQuery
         * @methodOf sbn.resources.templateQueryResource
         * @function
         *
         * @description
    ...
    angular.module('sbn.resources').factory('templateQueryResource', templateQueryResource);
