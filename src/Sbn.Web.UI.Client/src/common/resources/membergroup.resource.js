/**
    * @ngdoc service
    * @name sbn.resources.memberGroupResource
...
function memberGroupResource($q, $http, umbRequestHelper) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.memberGroupResource#save
         * @methodOf sbn.resources.memberGroupResource
         *
         * @description
...
angular.module('sbn.resources').factory('memberGroupResource', memberGroupResource);
