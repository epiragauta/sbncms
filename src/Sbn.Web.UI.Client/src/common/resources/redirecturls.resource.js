/**
 * @ngdoc service
 * @name sbn.resources.redirectUrlResource
 * @function
 *
 * @description
...
(function() {
    ...
    function redirectUrlsResource($http, umbRequestHelper) {
        ...
        /**
         * @ngdoc function
         * @name sbn.resources.redirectUrlResource#searchRedirectUrls
         * @methodOf sbn.resources.redirectUrlResource
         * @function
         *
         * @description
        ...
        /**
   * @ngdoc function
   * @name sbn.resources.redirectUrlResource#getRedirectsForContentItem
   * @methodOf sbn.resources.redirectUrlResource
   * @function
   *
   * @description
   ...
   */
        ...
        /**
         * @ngdoc function
         * @name sbn.resources.redirectUrlResource#deleteRedirectUrl
         * @methodOf sbn.resources.redirectUrlResource
         * @function
         *
         * @description
        ...
        /**
         * @ngdoc function
         * @name sbn.resources.redirectUrlResource#toggleUrlTracker
         * @methodOf sbn.resources.redirectUrlResource
         * @function
         *
         * @description
    ...
    angular.module('sbn.resources').factory('redirectUrlsResource', redirectUrlsResource);
