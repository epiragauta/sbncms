/**
    * @ngdoc service
    * @name sbn.resources.codefileResource
...
function codefileResource($q, $http, umbDataFormatter, umbRequestHelper, localizationService) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#getByPath
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#getByAlias
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#deleteByPath
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#save
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#getSnippets
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#getScaffold
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#createContainer
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#interpolateStylesheetRules
         * @methodOf sbn.resources.codefileResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.codefileResource#extractStylesheetRules
         * @methodOf sbn.resources.codefileResource
         *
         * @description
...
angular.module("sbn.resources").factory("codefileResource", codefileResource);
