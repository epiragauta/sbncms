/**
    * @ngdoc service
    * @name sbn.resources.macroResource
...
function macroResource($q, $http, umbRequestHelper) {
    ...
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.macroResource#getMacroParameters
         * @methodOf sbn.resources.macroResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.macroResource#getMacroResult
         * @methodOf sbn.resources.macroResource
         *
         * @description
...
angular.module('sbn.resources').factory('macroResource', macroResource);
