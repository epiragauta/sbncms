/**
 * @ngdoc service
 * @name sbn.resources.relationTypeResource
...
function relationTypeResource($q, $http, umbRequestHelper, umbDataFormatter) {
    return {
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.relationTypeResource#getById
         * @methodOf sbn.resources.relationTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.relationTypeResource#getRelationObjectTypes
         * @methodOf sbn.resources.relationTypeResource
         *
         * @description
         * Gets a list of Sbn object types which can be associated with a relation.
         *
         * @returns {Object} A collection of Sbn object types.
         */
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.relationTypeResource#save
         * @methodOf sbn.resources.relationTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.relationTypeResource#create
         * @methodOf sbn.resources.relationTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.relationTypeResource#deleteById
         * @methodOf sbn.resources.relationTypeResource
         *
         * @description
...
angular.module("sbn.resources").factory("relationTypeResource", relationTypeResource);
