/**
    * @ngdoc service
    * @name sbn.resources.logResource
    * @description Retrives log history from sbn
    * 
    *
    **/
function logResource($q, $http, umbRequestHelper) {
    ...
    return {
        ...
        /**
        * @ngdoc method
        * @name sbn.resources.logResource#getPagedEntityLog
        * @methodOf sbn.resources.logResource
        *
        * @description
        ...
        */
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.logResource#getPagedUserLog
         * @methodOf sbn.resources.logResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.logResource#getLog
         * @methodOf sbn.resources.logResource
         *
         * @description
...
angular.module('sbn.resources').factory('logResource', logResource);
