/**
    * @ngdoc service
    * @name sbn.resources.mediaTypeResource
    ...
    return {
        ...
        getAvailableCompositeContentTypes: function (contentTypeId, filterContentTypes, filterPropertyTypes) {
            ...
            return umbRequestHelper.resourcePromise(
               ...
               /**
         * @ngdoc method
         * @name sbn.resources.mediaTypeResource#getWhereCompositionIsUsedInContentTypes
         * @methodOf sbn.resources.mediaTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaTypeResource#getAllowedTypes
         * @methodOf sbn.resources.mediaTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaTypeResource#save
         * @methodOf sbn.resources.mediaTypeResource
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name sbn.resources.mediaTypeResource#move
         * @methodOf sbn.resources.mediaTypeResource
         *
         * @description
...
angular.module('sbn.resources').factory('mediaTypeResource', mediaTypeResource);
