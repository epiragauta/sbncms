/**
    * @ngdoc service
    * @name sbn.resources.memberResource
...
function memberResource($q, $http, umbDataFormatter, umbRequestHelper) {
    ...
    return {
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.memberResource#getByKey
          * @methodOf sbn.resources.memberResource
          *
          * @description
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.memberResource#deleteByKey
          * @methodOf sbn.resources.memberResource
          *
          * @description
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.memberResource#getScaffold
          * @methodOf sbn.resources.memberResource
          *
          * @description
          ...
          *         
          * - Member Type alias must be provided so sbn knows which properties to put on the member scaffold 
          * 
        ...
        /**
          * @ngdoc method
          * @name sbn.resources.memberResource#save
          * @methodOf sbn.resources.memberResource
          *
          * @description
...
angular.module('sbn.resources').factory('memberResource', memberResource);
