      ...
      function getLanguageResource(status, data, headers) {
          ...
          if (!mocksUtils.checkAuth()) {
              ...
              return [200, {
                  ...
                  "dashboard_nothinghappens": "If Sbn isn't opening, you might need to allow popups from this site",
                  ...
                  "installer_databaseInstall": "      Press the <strong>install</strong> button to install the Sbn %0% database    ",
                  "installer_databaseInstallDone": "Sbn %0% has now been copied to your database. Press <strong>Next</strong> to proceed.",
                  "installer_databaseNotFound": "<p>Database not found! Please check that the information in the 'connection string' of the \"web.config\" file is correct.</p>              <p>To proceed, please edit the 'web.config' file (using Visual Studio or your favourite text editor), scroll to the bottom, add the connection string for your database in the key named 'SbnDbDSN' and save the file. </p>              <p>              Click the <strong>retry</strong> button when               done.<br /><a href='https://our.sbn.com/Documentation/Reference/Config/webconfig/' target='_blank' rel='noopener'>              More information on editing web.config here.</a></p>",
                  ...
                  "installer_databaseUpgrade": "      <p>      Press the <strong>upgrade</strong> button to upgrade your database to Sbn %0%</p>      <p>      Don't worry - no content will be deleted and everything will continue working afterwards!      </p>          ",
                  ...
                  "installer_defaultUserDisabled": "<strong>The Default user has been disabled or has no access to Sbn!</strong></p><p>No further actions needs to be taken. Click <b>Next</b> to proceed.",
                  ...
                  "installer_defaultUserText": "        <p>          Sbn creates a default user with a login <strong>('admin')</strong> and password <strong>('default')</strong>. It's <strong>important</strong> that the password is           changed to something unique.        </p>        <p>          This step will check the default user's password and suggest if it needs to be changed.        </p>      ",
                  "installer_greatStart": "Get a great start, watch our introduction videos",
                  "installer_licenseText": "By clicking the next button (or modifying the SbnConfigurationStatus in web.config), you accept the license for this software as specified in the box below. Notice that this Sbn distribution consists of two different licenses, the open source MIT license for the framework and the Sbn freeware license that covers the UI.",
                  "installer_None": "Not installed yet.",
                  "installer_permissionsAffectedFolders": "Affected files and folders",
                  "installer_permissionsAffectedFoldersMoreInfo": "More information on setting up permissions for Sbn here",
                  "installer_permissionsAffectedFoldersText": "You need to grant ASP.NET modify permissions to the following files/folders",
                  "installer_permissionsAlmostPerfect": "<strong>Your permission settings are almost perfect!</strong><br /><br />        You can run Sbn without problems, but you will not be able to install packages which are recommended to take full advantage of Sbn.",
                  ...
                  "installer_permissionsHowtoResolveText": "Watch our <strong>video tutorial</strong> on setting up folder permissions for Sbn or read the text version.",
                  "installer_permissionsMaybeAnIssue": "<strong>Your permission settings might be an issue!</strong>      <br/><br />      You can run Sbn without problems, but you will not be able to create folders or install packages which are recommended to take full advantage of Sbn.",
                  "installer_permissionsNotReady": "<strong>Your permission settings are not ready for Sbn!</strong>          <br /><br />          In order to run Sbn, you'll need to update your permission settings.",
                  "installer_permissionsPerfect": "<strong>Your permission settings are perfect!</strong><br /><br />              You are ready to run Sbn and install packages!",
                  ...
                  "installer_permissionsText": "      Sbn needs write/modify access to certain directories in order to store files like pictures and PDF's.      It also stores temporary data (aka: cache) for enhancing the performance of your website.    ",
                  "installer_runwayFromScratch": "I want to start from scratch",
                  "installer_runwayFromScratchText": "        Your website is completely empty at the moment, so that's perfect if you want to start from scratch and create your own document types and templates.         (<a href='https://sbn.tv/videos/sbn-v7/implementor/fundamentals/document-types/what-is-a-document-type/'>learn how</a>)        You can still choose to install Runway later on. Please go to the Developer section and choose Packages.      ",
                  "installer_runwayHeader": "You've just set up a clean Sbn platform. What do you want to do next?",
                  ...
                  "installer_runwaySimpleSiteText": "      <p>      'Runway' is a simple website providing some basic document types and templates. The installer can set up Runway for you automatically,         but you can easily edit, extend or remove it. It's not necessary and you can perfectly use Sbn without it. However,         Runway offers an easy foundation based on best practices to get you started faster than ever.        If you choose to install Runway, you can optionally select basic building blocks called Runway Modules to enhance your Runway pages.        </p>        <small>        <em>Included with Runway:</em> Home page, Getting Started page, Installing Modules page.<br />        <em>Optional Modules:</em> Top Navigation, Sitemap, Contact, Gallery.        </small>      ",
                  ...
                  "installer_step4": "Step 4/5: Check Sbn security",
                  "installer_step5": "Step 5/5: Sbn is ready to get you started",
                  "installer_thankYou": "Thank you for choosing Sbn",
                  "installer_theEndBrowseSite": "<h3>Browse your new site</h3>You installed Runway, so why not see how your new website looks.",
                  "installer_theEndFurtherHelp": "<h3>Further help and information</h3>Get help from our award winning community, browse the documentation or watch some free videos on how to build a simple site, how to use packages and a quick guide to the Sbn terminology",
                  "installer_theEndHeader": "Sbn %0% is installed and ready for use",
                  "installer_theEndInstallFailed": "To finish the installation, you'll need to         manually edit the <strong>/web.config file</strong> and update the AppSetting key <strong>SbnConfigurationStatus</strong> in the bottom to the value of <strong>'%0%'</strong>.",
                  "installer_theEndInstallSuccess": "You can get <strong>started instantly</strong> by clicking the 'Launch Sbn' button below. <br />If you are <strong>new to Sbn</strong>, you can find plenty of resources on our getting started pages.",
                  "installer_theEndOpenSbn": "<h3>Launch Sbn</h3>To manage your website, simply open the Sbn back office and start adding content, updating the templates and stylesheets or add new functionality",
                  "installer_Unavailable": "Connection to database failed.",
                  "installer_Version3": "Sbn Version 3",
                  "installer_Version4": "Sbn Version 4",
                  "installer_watch": "Watch",
                  "installer_welcomeIntro": "This wizard will guide you through the process of configuring <strong>Sbn %0%</strong> for a fresh install or upgrading from version 3.0.                                <br /><br />                                Press <strong>'next'</strong> to start the wizard.",
                  ...
                  "login_bottomText": "<p style='text-align:right;'>&copy; 2001 - %0% <br /><a href='https://Sbn.com' style='text-decoration: none' target='_blank' rel='noopener'>Sbn.org</a></p> ",
                  ...
                  "paste_errorMessage": "The text you're trying to paste contains special characters or formatting. This could be caused by copying text from Microsoft Word. Sbn can remove special characters or formatting automatically, so the pasted content will be more suitable for the web.",
                  ...
                  "publicAccess_paAdvancedHelp": "If you wish to control access to the page using role-based authentication,<br /> using Sbn's member groups.",
                  ...
                  "sections_installer": "Sbn Configuration Wizard",
                  ...
                  "template_insertPageField": "Insert Sbn page field",
                  "template_mastertemplate": "Master template",
                  "template_quickGuide": "Quick Guide to Sbn template tags",
                  ...
                  "translation_mailBody": "      Hi %0%      This is an automated mail to inform you that the document '%1%'      has been requested for translation into '%5%' by %2%.      Go to http://%3%/translation/details.aspx?id=%4% to edit.      Or log into Sbn to get an overview of your translation tasks      http://%3%      Have a nice day!      Cheers from the Sbn robot    ",
                 ...
                 "translation_pageHasBeenSendToTranslation": "The page '%0%' has been send to translation",
                  ...
                  "user_changePasswordDescription": "You can change your password for accessing the Sbn Back Office by filling out the form below and click the 'Change Password' button",
                  ...
                  "user_noConsole": "Disable Sbn Access",
