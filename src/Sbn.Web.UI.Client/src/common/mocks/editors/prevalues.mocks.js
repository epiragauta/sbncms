angular.module('sbn.mocks').
    factory('prevaluesMocks', ['$httpBackend', 'mocksUtils', function ($httpBackend, mocksUtils) {
        ...
        return {
            register: function () {
                $httpBackend
                    .whenGET(mocksUtils.urlRegex('/sbn/SbnApi/RichTextPreValue/GetConfiguration'))
