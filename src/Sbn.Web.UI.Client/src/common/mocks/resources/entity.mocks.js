  ...
  factory('entityMocks', ['$httpBackend', 'mocksUtils', function ($httpBackend, mocksUtils) {
      ...
      return {
          register: function () {
              ...
              $httpBackend
                  .whenGET(mocksUtils.urlRegex('/sbn/SbnApi/Entity/GetByIds'))
                  .respond(returnEntitybyIds);

              $httpBackend
                  .whenPOST(mocksUtils.urlRegex('/sbn/SbnApi/Entity/GetByIds'))
                  .respond(returnEntitybyIdsPost);

              $httpBackend
                  .whenGET(mocksUtils.urlRegex('/sbn/SbnApi/Entity/GetAncestors'))
                  .respond(returnEntitybyIds);

              $httpBackend
                  .whenGET(mocksUtils.urlRegex('/sbn/SbnApi/Entity/GetById?'))
                  .respond(returnEntitybyId);
            
            $httpBackend
                  .whenGET(mocksUtils.urlRegex('/sbn/SbnApi/Entity/GetUrl?'))
