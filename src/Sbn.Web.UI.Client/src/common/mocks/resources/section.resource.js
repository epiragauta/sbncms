...
function sectionMocks($httpBackend, mocksUtils) {
    ...
    return {
        register: function () {
            $httpBackend
              .whenGET(mocksUtils.urlRegex('/sbn/SbnApi/Section/GetSections'))
              .respond(getSections);
        }
    };
}

angular.module('sbn.mocks').factory('sectionMocks', ['$httpBackend', 'mocksUtils', sectionMocks]);
