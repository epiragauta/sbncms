/**
@ngdoc directive
@name sbn.directives.directive:umbkeyboardShortcutsOverview
@restrict E
@scope
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbKeyboardShortcutsOverview', KeyboardShortcutsOverviewDirective);
