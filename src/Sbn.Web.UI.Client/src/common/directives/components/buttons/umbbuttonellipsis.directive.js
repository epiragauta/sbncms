/**
@ngdoc directive
@name sbn.directives.directive:umbButtonEllipsis
@restrict E
@scope

@description
<b>Added in Sbn version 8.7.0</b> Use this directive to render an sbn ellipsis.
...
(function () {
    ...
    angular.module('sbn.directives').component('umbButtonEllipsis', component);
