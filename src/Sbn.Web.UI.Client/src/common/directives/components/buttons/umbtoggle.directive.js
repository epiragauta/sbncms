/**
@ngdoc directive
@name sbn.directives.directive:umbToggle
@restrict E
@scope

@description
<b>Added in Sbn version 7.7.0</b> Use this directive to render an sbn toggle.
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbToggle', ToggleDirective);
