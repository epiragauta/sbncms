/**
@ngdoc directive
@name sbn.directives.directive:umbIcon
@restrict E
@scope
@description
Use this directive to show an render an sbn backoffice svg icon. All svg icons used by this directive should use the following naming convention to keep things consistent: icon-[name of icon]. For example <pre>icon-alert.svg</pre>
...
(function () {
    ...
    angular.module("sbn.directives").directive("umbIcon", UmbIconDirective);
