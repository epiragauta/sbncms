/**
@ngdoc directive
@name sbn.directives.directive:umbEditorContainer
@restrict E
...
<pre>
    <div ng-controller="Sbn.Controller as vm">
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbEditorContainer', EditorContainerDirective);
