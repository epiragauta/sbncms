/**
@ngdoc directive
@name sbn.directives.directive:umbEditorView
@restrict E
@scope
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("MySection.Controller", Controller);
    })();
</pre>
...
@param {boolean} footer Whether the directive should make place for a {@link sbn.directives.directive:umbEditorFooter umbEditorFooter} at the bottom (`true` by default).
**/
...
(function() {
   ...
   angular.module('sbn.directives').directive('umbEditorView', EditorViewDirective);
