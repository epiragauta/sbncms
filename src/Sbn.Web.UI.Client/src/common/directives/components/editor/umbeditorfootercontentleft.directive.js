/**
@ngdoc directive
@name sbn.directives.directive:umbEditorFooterContentLeft
@restrict E
...
(function() {
   ...
   angular.module('sbn.directives').directive('umbEditorFooterContentLeft', EditorFooterContentLeftDirective);
