/**
@ngdoc directive
@name sbn.directives.directive:umbEditorSubHeaderSection
@restrict E
...
(function() {
   ...
   angular.module('sbn.directives').directive('umbEditorSubHeaderSection', EditorSubHeaderSectionDirective);
