/**
@ngdoc directive
@name sbn.directives.directive:umbEditorSubHeaderContentRight
@restrict E
...
<ul>
    <li>{@link sbn.directives.directive:umbEditorSubHeader umbEditorSubHeader}</li>
...
(function() {
   ...
   angular.module('sbn.directives').directive('umbEditorSubHeaderContentRight', EditorSubHeaderContentRightDirective);
