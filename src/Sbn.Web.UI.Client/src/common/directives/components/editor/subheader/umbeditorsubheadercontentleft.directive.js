/**
@ngdoc directive
@name sbn.directives.directive:umbEditorSubHeaderContentLeft
@restrict E
...
(function() {
   ...
   angular.module('sbn.directives').directive('umbEditorSubHeaderContentLeft', EditorSubHeaderContentLeftDirective);
