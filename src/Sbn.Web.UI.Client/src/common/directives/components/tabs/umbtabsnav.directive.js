/**
@ngdoc directive
@name sbn.directives.directive:umbTabsNav
@restrict E
@scope
...
<ul>
    <li>{@link sbn.directives.directive:umbTabContent umbTabContent}</li>
</ul>
...
(function() {
    ...
    angular.module('sbn.directives').directive('umbTabsNav', TabsNavDirective);
