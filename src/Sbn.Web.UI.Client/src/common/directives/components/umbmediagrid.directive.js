/**
@ngdoc directive
@name sbn.directives.directive:umbMediaGrid
@restrict E
@scope
...
(function() {
    ...
    angular.module('sbn.directives').directive('umbMediaGrid', MediaGridDirective);
