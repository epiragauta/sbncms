/**
@ngdoc directive
@name sbn.directives.directive:umbGenerateAlias
@restrict E
@scope

@description
Use this directive to generate a camelCased sbn alias.
...
the directive will use {@link sbn.directives.directive:umbLockedField umbLockedField} to lock and unlock the alias.
