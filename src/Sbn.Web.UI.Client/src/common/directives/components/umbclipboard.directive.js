/**
@ngdoc directive
@name sbn.directives.directive:umbClipboard
@restrict E
@scope

@description
<strong>Added in Sbn v. 7.7:</strong> Use this directive to copy content to the clipboard
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.ClipBoardController", Controller);
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbClipboard', umbClipboardDirective);
