/**
@ngdoc directive
@name sbn.directives.directive:umbDropdown
@restrict E
@scope
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("MyDropdown.Controller", Controller);
    })();
</pre>

<h3>Use in combination with</h3>
<ul>
    <li>{@link sbn.directives.directive:umbDropdownItem umbDropdownItem}</li>
    <li>{@link sbn.directives.directive:umbKeyboardList umbKeyboardList}</li>
</ul>
...
(function() {
    ...
    angular.module('sbn.directives').directive('umbDropdown', umbDropdown);
