/**
@ngdoc directive
@name sbn.directives.directive:umbBoxHeader
@restrict E
@scope

@description
Use this directive to construct a title. Recommended to use it inside an {@link sbn.directives.directive:umbBox umbBox} directive. See documentation for {@link sbn.directives.directive:umbBox umbBox}.
...
{@link https://our.sbn.com/documentation/extending/language-files/ Here you can see more about the language files}

<h3>Use in combination with:</h3>
<ul>
    <li>{@link sbn.directives.directive:umbBox umbBox}</li>
    <li>{@link sbn.directives.directive:umbBoxContent umbBoxContent}</li>
</ul>
...
(function(){
    ...
    angular.module('sbn.directives').directive('umbBoxHeader', BoxHeaderDirective);
