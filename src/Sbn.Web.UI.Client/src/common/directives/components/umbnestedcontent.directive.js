angular.module("sbn.directives").directive('umbNestedContentEditor', [
    ...
    function () {
        ...
        return {
            restrict: "E",
            replace: true,
            templateUrl: Sbn.Sys.ServerVariables.sbnSettings.sbnPath + "/views/propertyeditors/nestedcontent/nestedcontent.editor.html",
            scope: {
                ngModel: '=',
                tabAlias: '='
            },
...
//angular.module("sbn.directives").directive('nestedContentSubmitWatcher', function () {
//    var link = function (scope) {
