/**
@ngdoc directive
@name sbn.directives.directive:umbDateTimePicker
@restrict E
@scope

@description
<b>Added in Sbn version 8.0</b>
...
(function () {
    ...
    angular.module('sbn.directives').component('umbFlatpickr', umbDateTimePicker);
    angular.module('sbn.directives').component('umbDateTimePicker', umbDateTimePicker);
})();
