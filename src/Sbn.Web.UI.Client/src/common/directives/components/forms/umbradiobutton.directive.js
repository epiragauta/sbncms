/**
@ngdoc directive
@name sbn.directives.directive:umbRadiobutton
@restrict E
@scope

@description
<b>Added in Sbn version 7.14.0</b> Use this directive to render an sbn radio button.
...
(function () {
    ...
    angular.module('sbn.directives').component('umbRadiobutton', component);
