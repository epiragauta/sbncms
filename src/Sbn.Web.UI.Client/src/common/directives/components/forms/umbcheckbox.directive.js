/**
@ngdoc directive
@name sbn.directives.directive:umbCheckbox
@restrict E
@scope

@description
<b>Added in Sbn version 7.14.0</b> Use this directive to render an sbn checkbox.
...
(function () {
    ...
    angular.module('sbn.directives').component('umbCheckbox', component);
