/**
@ngdoc directive
@name sbn.directives.directive:umbSearchFilter
@restrict E
@scope

@description
<b>Added in Sbn version 8.7.0</b> Use this directive to render an sbn search filter.
...
(function () {
    ...
    angular.module('sbn.directives').component('umbSearchFilter', component);
