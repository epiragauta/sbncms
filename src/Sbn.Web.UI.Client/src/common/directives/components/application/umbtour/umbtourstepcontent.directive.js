/**
@ngdoc directive
@name sbn.directives.directive:umbTourStepContent
@restrict E
@scope

@description
<b>Added in Sbn 7.8</b>. The tour step content component is a component that can be used in custom views for tour steps.
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbTourStepContent', TourStepContentDirective);
