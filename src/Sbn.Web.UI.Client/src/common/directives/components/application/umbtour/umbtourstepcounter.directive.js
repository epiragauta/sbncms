/**
@ngdoc directive
@name sbn.directives.directive:umbTourStepCounter
@restrict E
@scope

@description
<b>Added in Sbn 7.8</b>. The tour step counter component is a component that can be used in custom views for tour steps.
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbTourStepCounter', TourStepCounterDirective);
