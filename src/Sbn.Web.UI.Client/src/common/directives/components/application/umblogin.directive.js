(function () {
    ...
    function UmbLoginController($scope, $location, currentUserResource, formHelper,
        ...
        vm.avatarFile = {
            ...
            uploadStatus: null,
            uploadProgress: 0,
            maxFileSize: Sbn.Sys.ServerVariables.sbnSettings.maxFileSize + "KB",
            acceptedFileTypes: mediaHelper.formatFileTypes(Sbn.Sys.ServerVariables.sbnSettings.imageFileTypes),
            uploaded: false
        };

        vm.allowPasswordReset = Sbn.Sys.ServerVariables.sbnSettings.canSendRequiredEmail && Sbn.Sys.ServerVariables.sbnSettings.allowPasswordReset;
        vm.errorMsg = "";
        vm.externalLoginFormAction = Sbn.Sys.ServerVariables.sbnUrls.externalLoginsUrl;
        ...
        vm.logoImage = Sbn.Sys.ServerVariables.sbnSettings.loginLogoImage;
        vm.backgroundImage = Sbn.Sys.ServerVariables.sbnSettings.loginBackgroundImage;
