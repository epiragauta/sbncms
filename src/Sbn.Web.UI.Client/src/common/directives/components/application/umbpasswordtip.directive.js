(function () {
    ...
    function UmbPasswordTipController(localizationService) {
        ...
        let defaultMinPwdLength = Sbn.Sys.ServerVariables.sbnSettings.minimumPasswordLength;
        let defaultMinPwdNonAlphaNum = Sbn.Sys.ServerVariables.sbnSettings.minimumPasswordNonAlphaNum;
