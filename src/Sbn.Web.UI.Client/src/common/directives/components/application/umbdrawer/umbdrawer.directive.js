/**
@ngdoc directive
@name sbn.directives.directive:umbDrawer
@restrict E
@scope

@description
The drawer component is a global component and is already added to the sbn markup. It is registered in globalState and can be opened and configured by raising events.
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.DrawerController", DrawerController);
...
function Drawer($location, $routeParams, helpService, userService, localizationService, dashboardResource) {
    ...
    angular.module('sbn.directives').directive("umbDrawer", Drawer);
