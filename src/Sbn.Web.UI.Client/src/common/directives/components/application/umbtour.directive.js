/**
@ngdoc directive
@name sbn.directives.directive:umbTour
@restrict E
@scope

@description
<b>Added in Sbn 7.8</b>. The tour component is a global component and is already added to the sbn markup.
In the Sbn UI the tours live in the "Help drawer" which opens when you click the Help-icon in the bottom left corner of Sbn.
You can easily add you own tours to the Help-drawer or show and start tours from
anywhere in the Sbn backoffice. To see a real world example of a custom tour implementation, install <a href="https://our.sbn.com/projects/starter-kits/the-starter-kit/">The Starter Kit</a> in Sbn 7.8

<h1><b>Extending the help drawer with custom tours</b></h1>
The easiet way to add new tours to Sbn is through the Help-drawer. All it requires is a my-tour.json file.
Place the file in <i>App_Plugins/{MyPackage}/backoffice/tours/{my-tour}.json</i> and it will automatically be
picked up by Sbn and shown in the Help-drawer.
...
<h1><b>Adding tours to other parts of the Sbn backoffice</b></h1>
It is also possible to add a list of custom tours to other parts of the Sbn backoffice,
as an example on a Dashboard in a Custom section. You can then use the {@link sbn.services.tourService tourService} to start and stop tours but you don't have to register them as part of the tour service.
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.TourController", TourController);
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.TourStep", StepController);
...
<ul>
    <li>{@link sbn.services.tourService tourService}</li>
</ul>
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbTour', TourDirective);
