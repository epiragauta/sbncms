/**
@ngdoc directive
@name sbn.directives.directive:umbColorPicker
@restrict E
@scope

@description
<strong>Added in Sbn v. 8.10:</strong> Use this directive to render a color picker.
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.ColorController", Controller);
