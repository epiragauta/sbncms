/**
@ngdoc directive
@name sbn.directives.directive:umbTable
@restrict E
@scope

@description
<strong>Added in Sbn v. 7.4:</strong> Use this directive to render a data table.
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.TableController", Controller);
