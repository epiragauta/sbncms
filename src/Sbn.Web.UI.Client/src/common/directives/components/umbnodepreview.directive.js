/**
@ngdoc directive
@name sbn.directives.directive:umbNodePreview
@restrict E
@scope

@description
<strong>Added in Sbn v. 7.6:</strong> Use this directive to render a node preview.
...
<pre>
    (function () {
        ...
        angular.module("sbn").controller("My.NodePreviewController", Controller);
...
(function () {
    ...
    angular.module('sbn.directives').directive('umbNodePreview', NodePreviewDirective);
