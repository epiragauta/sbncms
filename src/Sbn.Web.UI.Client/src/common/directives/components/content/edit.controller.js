(function () {
    ...
    function ContentEditController($rootScope, $scope, $routeParams, $q, $window,
        ...
        */
        ...
        $scope.preview = function (content) {
            ...
            var redirect = Sbn.Sys.ServerVariables.sbnSettings.sbnPath + '/preview/?' + query;
    ...
    function createDirective() {
        ...
        var directive = {
            ...
            controller: 'Sbn.Editors.Content.EditorDirectiveController',
            scope: {
                contentId: "=",
                isNew: "=?",
                treeAlias: "@",
    ...
    angular.module('sbn.directives').controller('Sbn.Editors.Content.EditorDirectiveController', ContentEditController);
    angular.module('sbn.directives').directive('contentEditor', createDirective);
