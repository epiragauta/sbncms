(function () {
    ...
    function ContentNodeInfoDirective($timeout, logResource, eventsService, userService, localizationService, dateHelper, editorService, redirectUrlsResource, overlayService, entityResource) {
        ...
        function link(scope) {
            ...
            scope.disableTemplates = Sbn.Sys.ServerVariables.features.disabledFeatures.disableTemplates;
    ...
    angular.module('sbn.directives').directive('umbContentNodeInfo', ContentNodeInfoDirective);
