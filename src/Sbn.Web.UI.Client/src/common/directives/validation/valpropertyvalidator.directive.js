/**
* @ngdoc directive
* @name sbn.directives.directive:valPropertyValidator
* @restrict A
* @description Performs any custom property value validation checks on the client side. This allows property editors to be highly flexible when it comes to validation
                ...
                might require custom validation. This directive can be used to validate an Sbn property in any way that a developer would like by specifying a
...
angular.module('sbn.directives.validation').directive("valPropertyValidator", valPropertyValidator);
