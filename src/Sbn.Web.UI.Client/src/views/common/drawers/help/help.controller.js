(function () {
    ...
    function HelpDrawerController($scope, $routeParams, $timeout, dashboardResource, localizationService, userService, eventsService, helpService, appState, tourService, $filter, editorState, notificationsService, currentUserResource, platformService) {
        ...
        var evts = [];
        vm.title = "";
        vm.subtitle = "Sbn version" + " " + Sbn.Sys.ServerVariables.application.version;
        ...
        function findHelp(section, tree, usertype, userLang) {
            ...
            if ($routeParams.url) {
                ...
                if (rq.path.indexOf(Sbn.Sys.ServerVariables.sbnSettings.sbnPath) === 0) {
                    rq.path = rq.path.substring(Sbn.Sys.ServerVariables.sbnSettings.sbnPath.length);
                }
    ...
    angular.module("sbn").controller("Sbn.Drawers.Help", HelpDrawerController);
})();
