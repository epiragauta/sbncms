/**
 * @ngdoc controller
 * @name Sbn.Editors.DataTypeConfigurationPickerController
 * @function
 *
 * @description
...
(function() {
    ...
    angular.module("sbn").controller("Sbn.Editors.DataTypeConfigurationPickerController", DataTypeConfigurationPicker);
