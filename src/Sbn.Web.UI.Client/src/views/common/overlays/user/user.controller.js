angular.module("sbn")
    .controller("Sbn.Overlays.UserController", function ($scope, $location, $timeout,
        ...
        //$scope.version = Sbn.Sys.ServerVariables.application.version + " assembly: " + Sbn.Sys.ServerVariables.application.assemblyVersion;
        $scope.showPasswordFields = false;
        $scope.changePasswordButtonState = "init";
        $scope.model.title = "user.name";
        //$scope.model.subtitle = "Sbn version" + " " + $scope.version;
        /*
        ...
        */
        ...
        $scope.externalLinkLoginFormAction = Sbn.Sys.ServerVariables.sbnUrls.externalLinkLoginsUrl;
        var evts = [];
