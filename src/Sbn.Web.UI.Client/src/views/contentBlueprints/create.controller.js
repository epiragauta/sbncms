/**
 * @ngdoc controller
 * @name Sbn.Editors.ContentBlueprint.CreateController
 * @function
 *
 * @description
...
angular.module("sbn").controller("Sbn.Editors.ContentBlueprint.CreateController", ContentBlueprintCreateController);
