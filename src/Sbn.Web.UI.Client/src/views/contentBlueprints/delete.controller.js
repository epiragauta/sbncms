/**
 * @ngdoc controller
 * @name Sbn.Editors.ContentBlueprint.DeleteController
 * @function
 *
 * @description
...
angular.module("sbn").controller("Sbn.Editors.ContentBlueprint.DeleteController", ContentBlueprintDeleteController);
