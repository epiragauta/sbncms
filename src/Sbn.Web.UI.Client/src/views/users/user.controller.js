(function () {
    ...
    function UserEditController($scope, eventsService, $q, $location, $routeParams, formHelper, usersResource,
        ...
        vm.avatarFile = {};
        vm.labels = {};
        vm.maxFileSize = Sbn.Sys.ServerVariables.sbnSettings.maxFileSize + "KB";
        vm.acceptedFileTypes = mediaHelper.formatFileTypes(Sbn.Sys.ServerVariables.sbnSettings.imageFileTypes);
        ...
        function init() {
            ...
            usersResource.getUser($routeParams.id).then(function (user) {
                ...
                vm.usernameIsEmail = Sbn.Sys.ServerVariables.sbnSettings.usernameIsEmail && user.email === user.username;
    ...
    angular.module("sbn").controller("Sbn.Editors.Users.UserController", UserEditController);
})();
