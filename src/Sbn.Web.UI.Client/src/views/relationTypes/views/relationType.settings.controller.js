/**
 * @ngdoc controller
 * @name Sbn.Editors.RelationTypes.SettingsController
 * @function
 *
 * @description
...
angular.module("sbn").controller("Sbn.Editors.RelationTypes.SettingsController", RelationTypeSettingsController);
