/**
 * @ngdoc controller
 * @name Sbn.Editors.PartialViewMacros.DeleteController
 * @function
 *
 * @description
...
angular.module("sbn").controller("Sbn.Editors.PartialViewMacros.DeleteController", PartialViewMacrosDeleteController);
