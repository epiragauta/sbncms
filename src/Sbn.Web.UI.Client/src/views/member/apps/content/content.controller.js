(function () {
    ...
    function MemberAppContentController($scope, $filter, contentEditingHelper, contentTypeHelper) {
        ...
        function hideSystemProperties (property) {
            ...
            // hide all label properties with the alias prefix "sbnMember" (e.g. "sbnMemberFailedPasswordAttempts")
            return property.view !== "readonlyvalue" || property.alias.startsWith('sbnMember') === false;
        }
    }

    angular.module("sbn").controller("Sbn.Editors.Member.Apps.ContentController", MemberAppContentController);
})();
