/**
 * @ngdoc controller
 * @name Sbn.Editors.Member.EditController
 * @function
 *
 * @description
...
function MemberEditController($scope, $routeParams, $location, $http, $q, appState, memberResource,
    ...
    if (create) {
        ...
        // we are not using the sbn membership provider
        if (docType) {
...
angular.module("sbn").controller("Sbn.Editors.Member.EditController", MemberEditController);
