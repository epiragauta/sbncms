(function () {
            ...
            var savedSearches = logViewerResource.getSavedSearches().then(function (data) {
                ...
                function () {
                    vm.searches = [
                        ...
                        {
                            "name": "Find all logs that are from the namespace 'Sbn.Core'",
                            "query": "StartsWith(SourceContext, 'Sbn.Core')"
                    },
                        {
    ...
    angular.module("sbn").controller("Sbn.Editors.LogViewer.OverviewController", LogViewerOverviewController);
