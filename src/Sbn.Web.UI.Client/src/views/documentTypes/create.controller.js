/**
 * @ngdoc controller
 * @name Sbn.Editors.DocumentType.CreateController
 * @function
 *
 * @description
...
function DocumentTypesCreateController($scope, $location, navigationService, contentTypeResource, formHelper, appState, notificationsService, localizationService, iconHelper) {
    ...
    var disableTemplates = Sbn.Sys.ServerVariables.features.disabledFeatures.disableTemplates;
...
angular.module('sbn').controller("Sbn.Editors.DocumentTypes.CreateController", DocumentTypesCreateController);
