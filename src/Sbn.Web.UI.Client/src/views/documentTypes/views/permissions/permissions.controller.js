/**
 * @ngdoc controller
 * @name Sbn.Editors.DocumentType.PropertyController
 * @function
 *
 * @description
...
(function() {
    ...
    function PermissionsController($scope, $timeout, contentTypeResource, iconHelper, contentTypeHelper, localizationService, overlayService) {
        ...
        vm.contentTypes = [];
        vm.selectedChildren = [];
        vm.showAllowSegmentationOption = Sbn.Sys.ServerVariables.sbnSettings.showAllowSegmentationForDocumentTypes || false;
    ...
    angular.module("sbn").controller("Sbn.Editors.DocumentType.PermissionsController", PermissionsController);
})();
