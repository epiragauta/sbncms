(function () {
    ...
    /**
     * @ngdoc controller
     * @name Sbn.Editors.FileUploadController
     * @function
     *
     * @description
    ...
    */
    ...
    angular.module("sbn")
        .controller('Sbn.PropertyEditors.FileUploadController', fileUploadController)
        .run(function (mediaHelper) {
            if (mediaHelper && mediaHelper.registerFileResolver) {

                //NOTE: The 'entity' can be either a normal media entity or an "entity" returned from the entityResource
                // they contain different data structures so if we need to query against it we need to be aware of this.
                mediaHelper.registerFileResolver("Sbn.UploadField", function (property, entity, thumbnail) {
                    if (thumbnail) {
