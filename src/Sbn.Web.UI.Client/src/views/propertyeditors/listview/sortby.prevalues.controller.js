function sortByPreValsController($rootScope, $scope, localizationService, editorState, listViewPrevalueHelper) {
	...
	// beware: ensure that GetDatabaseFieldNameForOrderBy knows about those fields!
        ...
        if (existingValue) {
            ...
            // The old implementation pre Sbn 7.5 used PascalCase aliases, this uses camelCase, so this ensures that any previous value is set
...
angular.module("sbn").controller("Sbn.PrevalueEditors.SortByListViewController", sortByPreValsController);
