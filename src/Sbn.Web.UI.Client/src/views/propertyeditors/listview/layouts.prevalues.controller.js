/**
 * @ngdoc controller
 * @name Sbn.PrevalueEditors.ListViewLayoutsPreValsController
 * @function
 *
 * @description
...
(function() {
   ...
   angular.module("sbn").controller("Sbn.PrevalueEditors.ListViewLayoutsPreValsController", ListViewLayoutsPreValsController);
