/**
 * @ngdoc controller
 * @name Sbn.Editors.DocumentType.EditController
 * @function
 *
 * @description
...
(function () {
    ...
    function ListViewGridLayoutController($scope, mediaHelper, $location, listViewHelper, mediaTypeHelper) {
        ...
        vm.acceptedFileTypes = mediaHelper.formatFileTypes(sbnSettings.allowedUploadFiles);
    ...
    angular.module("sbn").controller("Sbn.PropertyEditors.ListView.GridLayoutController", ListViewGridLayoutController);
