/**
 * @ngdoc controller
 * @name Sbn.Editors.BlockList.BlockConfigurationController
 * @function
 *
 * @description
...
(function () {
    ...
    angular.module("sbn").controller("Sbn.PropertyEditors.BlockList.BlockConfigurationController", BlockConfigurationController);
