/**
 * @ngdoc controller
 * @name Sbn.Editors.BlockList.BlockConfigurationOverlayController
 * @function
 *
 * @description
...
(function () {
    ...
    angular.module("sbn").controller("Sbn.PropertyEditors.BlockList.BlockConfigurationOverlayController", BlockConfigurationOverlayController);
