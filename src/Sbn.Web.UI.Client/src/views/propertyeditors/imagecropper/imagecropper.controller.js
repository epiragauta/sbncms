angular.module('sbn')
    .controller("Sbn.PropertyEditors.ImageCropperController",
        function ($scope, fileManager, $timeout, mediaHelper) {
            ...
            $scope.acceptFileExt = mediaHelper.formatFileTypes(sbnSettings.imageFileTypes);
            /**
    ...
    .run(function (mediaHelper, umbRequestHelper) {
        if (mediaHelper && mediaHelper.registerFileResolver) {
            ...
            mediaHelper.registerFileResolver("Sbn.ImageCropper", function (property, entity, thumbnail) {
