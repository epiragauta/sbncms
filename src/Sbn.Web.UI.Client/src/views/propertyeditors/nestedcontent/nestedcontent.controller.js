(function () {
    ...
    angular.module('sbn').run(['clipboardService', function (clipboardService) {

        function resolveNestedContentPropertiesForPaste(prop, propClearingMethod) {

            // if prop.editor is "Sbn.NestedContent"
            if ((typeof prop === 'object' && prop.editor === "Sbn.NestedContent")) {
