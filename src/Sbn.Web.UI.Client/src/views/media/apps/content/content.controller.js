(function () {
    ...
    function MediaAppContentController($scope, $filter, contentEditingHelper, contentTypeHelper) {
    ...
    angular.module("sbn").controller("Sbn.Editors.Media.Apps.ContentController", MediaAppContentController);
})();
