/**
 * @ngdoc controller
 * @name Sbn.Editors.Media.EmptyRecycleBinController
 * @function
 * 
 * @description
...
angular.module("sbn").controller("Sbn.Editors.Media.EmptyRecycleBinController", MediaEmptyRecycleBinController);
