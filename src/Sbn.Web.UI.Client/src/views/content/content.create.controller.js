/**
 * @ngdoc controller
 * @name Sbn.Editors.Content.CreateController
 * @function
 *
 * @description
...
angular.module("sbn").controller("Sbn.Editors.Content.CreateController", contentCreateController);

angular.module("sbn").value("blueprintConfig", {
    skipSelect: false,
    allowBlank: true
});
