(function () {
    ...
    function ScheduleContentController($scope, $timeout, localizationService, dateHelper, userService, contentEditingHelper) {
        ...
        function setPublishDate(variant, date) {
            ...
            var serverTime = dateHelper.convertToServerStringTime(moment(date), Sbn.Sys.ServerVariables.application.serverTimeOffset);
    ...
    angular.module("sbn").controller("Sbn.Overlays.ScheduleContentController", ScheduleContentController);
