angular.module("sbn.install").controller("Sbn.InstallerController",
	function ($scope, installerService) {
	    ...
	    // see: https://github.com/sbn/Sbn-CMS/commit/b86ef0d7ac83f699aee35d807f7f7ebb6dd0ed2c#commitcomment-5721204
...
angular.module("sbn.install").run(function ($templateCache) {
