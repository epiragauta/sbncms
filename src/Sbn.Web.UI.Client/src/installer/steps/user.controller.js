angular.module("sbn.install").controller("Sbn.Install.UserController", function($scope, installerService) {
    
    $scope.majorVersion = Sbn.Sys.ServerVariables.application.version;
