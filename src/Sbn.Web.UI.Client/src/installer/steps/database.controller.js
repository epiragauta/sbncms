angular.module("sbn.install").controller("Sbn.Installer.DataBaseController", function($scope, $http, installerService){
    ...
    $scope.validateAndForward = function() {
        if (!$scope.checking && this.myForm.$valid)
        {
			...
			$http.post(
				Sbn.Sys.ServerVariables.installApiBaseUrl + "PostValidateDatabaseConnection",
