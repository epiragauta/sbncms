...
var app = angular.module("sbn.preview", ['sbn.resources', 'sbn.services'])
    ...
    .controller("previewController", function ($scope, $window, $location, $http) {
        ...
        function configureSignalR(iframe) {
            ...
            $.connection = new signalR.HubConnectionBuilder()
                .withUrl(Sbn.Sys.ServerVariables.sbnUrls.previewHubUrl)
        ...
        function checkPreviewState() {
            if (getCookie("UMB_PREVIEW") === null) {
                ...
                modal.innerHTML = `<div class="sbn-preview-dialog__headline">${umbLocalizedVars.returnToPreviewHeadline}</div>
                    <div class="sbn-preview-dialog__question">${umbLocalizedVars.returnToPreviewDescription}</div>`;
    ...
    .component('previewIFrame', {
        ...
        controller: function ($element, $scope, angularHelper) {
            ...
            function hideSbnPreviewBadge(iframe) {
                if (iframe && iframe.contentDocument && iframe.contentDocument.getElementById("sbnPreviewBadge")) {
                    iframe.contentDocument.getElementById("sbnPreviewBadge").style.display = "none";
                }
            };
