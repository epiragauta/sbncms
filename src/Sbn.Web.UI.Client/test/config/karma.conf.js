...
module.exports = function (config) {
    ...
    config.set({
        ...
        files: [
            ...
            //application files
            '../Sbn.Web.UI/wwwroot/sbn/js/*.controllers.min.js',
            '../Sbn.Web.UI/wwwroot/sbn/js/*.directives.min.js',
            '../Sbn.Web.UI/wwwroot/sbn/js/*.filters.min.js',
            '../Sbn.Web.UI/wwwroot/sbn/js/*.services.min.js',
            '../Sbn.Web.UI/wwwroot/sbn/js/*.interceptors.min.js',
            '../Sbn.Web.UI/wwwroot/sbn/js/*.resources.min.js',

            //mocked data and routing
            'src/common/mocks/sbn.servervariables.js',
            'src/common/mocks/**/*.js',
