describe('tree service tests', function () {
    ...
    function getContentTree() {
        ...
        var url = "/sbn/SbnTrees/ApplicationTreeApi/GetChildren?treeType=content&id=1234&level=1";
        var menuUrl = "/sbn/SbnTrees/ApplicationTreeApi/GetMenu?treeType=content&id=1234&parentId=456";
    ...
    describe('lookup plugin based trees', function() {
        ...
        it('can find a plugin based tree', function () {
            //we know this exists in the mock sbn server vars
        ...
        it('returns undefined for a not found tree', function () {
            //we know this does not exist in the mock sbn server vars
