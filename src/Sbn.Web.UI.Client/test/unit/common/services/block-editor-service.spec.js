    ...
    describe('init blockEditorModelObject', function () {
        ...
        it('fail if no model value', function () {
            function createWithNoModelValue() {
                blockEditorService.createModelObject(null, "Sbn.TestBlockEditor", [], $scope, $scope);
            }
            expect(createWithNoModelValue).toThrow();
        });

        it('return a object, with methods', function () {
            var modelObject = blockEditorService.createModelObject({}, "Sbn.TestBlockEditor", [], $scope, $scope);
        ...
        it('getBlockConfiguration provide the requested block configurtion', function () {
            var modelObject = blockEditorService.createModelObject({}, "Sbn.TestBlockEditor", [blockConfigurationMock], $scope, $scope);
        ...
        it('getLayoutEntry has values', function (done) {
            ...
            var modelObject = blockEditorService.createModelObject(propertyModelMock, "Sbn.TestBlockEditor", [blockConfigurationMock], $scope, $scope);
            ...
            modelObject.load().then(() => {
                ...
                try {
                    ...
                    expect(layout[0]).toBe(propertyModelMock.layout["Sbn.TestBlockEditor"][0]);
                    expect(layout[0].contentUdi).toBe(propertyModelMock.layout["Sbn.TestBlockEditor"][0].contentUdi);
        ...
        it('getBlockObject syncs primitive values', function (done) {
            ...
            var modelObject = blockEditorService.createModelObject(propertyModel, "Sbn.TestBlockEditor", [blockConfigurationMock], $scope, $scope);
        ...
        it('layout is referencing layout of propertyModel', function (done) {
            ...
            modelObject.load().then(() => {
                ...
                expect(propertyModel.layout["Sbn.TestBlockEditor"].length).toBe(0);
                expect(propertyModel.layout["Sbn.TestBlockEditor"][0]).toBeUndefined();
        ...
        it('getBlockObject of block with settings has values', function (done) {
            ...
            var modelObject = blockEditorService.createModelObject(propertyModel, "Sbn.TestBlockEditor", [blockWithSettingsConfigurationMock], $scope, $scope);
