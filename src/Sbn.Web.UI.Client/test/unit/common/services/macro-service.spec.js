describe('macro service tests', function () {
    ...
    describe('generates macro syntax', function() {
        ...
        it('can parse syntax for macros', function () {
            ...
            var result = macroService.parseMacroSyntax("<?SBN_MACRO macroAlias='Map' test=\"asdf\" test2='hello' />");
        ...
        it('can parse syntax for macros with aliases containing dots', function () {
            ...
            var result = macroService.parseMacroSyntax("<?SBN_MACRO macroAlias='Map.Test' test=\"asdf\" test2='hello' />");
        ...
        it('can parse syntax for macros when macroAlias is not the first parameter', function () {
            ...
            var result = macroService.parseMacroSyntax("<?SBN_MACRO test=\"asdf\" test2='hello' macroAlias='Map.Test' />");
        ...
        it('can parse syntax for macros with aliases containing whitespace and other chars', function () {
            ...
            var result = macroService.parseMacroSyntax("<?SBN_MACRO macroAlias='Map Test [Hello\\World]' test=\"asdf\" test2='hello' />");
        ...
        it('can parse syntax for macros with body', function () {
            ...
            var result = macroService.parseMacroSyntax("<?SBN_MACRO macroAlias='Map' test1=\"asdf\" test2='hello' ><img src='blah.jpg'/></?SBN_MACRO>");
    ...
    describe('generates macro syntax', function () {
        ...
        it('can generate syntax for macros', function () {
            ...
            expect(syntax).
                toBe("<?SBN_MACRO macroAlias=\"myMacro\" param1=\"value1\" param2=\"value2\" param3=\"value3\" />");
        ...
        it('can generate syntax for macros with no params', function () {
            ...
            expect(syntax).
                toBe("<?SBN_MACRO macroAlias=\"myMacro\" />");
        ...
        it('can generate syntax for MVC', function () {
            ...
            expect(syntax).
                toBe("@await Sbn.RenderMacroAsync(\"myMacro\", new {param1=\"value1\", param2=\"value2\", param3=\"value3\"})");
        ...
        it('can generate syntax for MVC with no params', function () {
            ...
            expect(syntax).
                toBe("@await Sbn.RenderMacroAsync(\"myMacro\")");
