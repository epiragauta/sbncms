describe('umbRequestHelper tests', function () {
    ...
    beforeEach(inject(function ($injector) {
        ...
        // set the Sbn.Sys.ServerVariables.application.applicationPath
        if (!Sbn) Sbn = {};
        if (!Sbn.Sys) Sbn.Sys = {};
        if (!Sbn.Sys.ServerVariables) Sbn.Sys.ServerVariables = {};
        if (!Sbn.Sys.ServerVariables.application) Sbn.Sys.ServerVariables.application = {};
        Sbn.Sys.ServerVariables.application.applicationPath = "/mysite/";
    }));
    ...
    describe('formatting Urls', function () {
        ...
        it('can create a url based on server vars', function () {
            ...
            expect(umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "GetAllowedChildren", [{ contentId: 123 }])).toBe(
                    "/sbn/Api/ContentType/GetAllowedChildren?contentId=123");
        });
