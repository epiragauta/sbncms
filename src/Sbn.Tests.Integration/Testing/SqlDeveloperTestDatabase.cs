...
namespace Sbn.Cms.Tests.Integration.Testing
{
    ...
    public class SqlDeveloperTestDatabase : BaseTestDatabase, ITestDatabase
    {
        ...
        public SqlDeveloperTestDatabase(TestDatabaseSettings settings, ILoggerFactory loggerFactory, ISbnDatabaseFactory databaseFactory, string masterConnectionString)
        {
