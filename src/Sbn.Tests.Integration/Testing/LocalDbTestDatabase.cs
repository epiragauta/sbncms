...
namespace Sbn.Cms.Tests.Integration.Testing
{
    ...
    {
        public const string InstanceName = "SbnTests";
        public const string DatabaseName = "SbnTests";
        ...
        // It's internal because `Sbn.Core.Persistence.LocalDb` is internal
        internal LocalDbTestDatabase(TestDatabaseSettings settings, ILoggerFactory loggerFactory, LocalDb localDb, string filesPath, ISbnDatabaseFactory dbFactory)
        {
