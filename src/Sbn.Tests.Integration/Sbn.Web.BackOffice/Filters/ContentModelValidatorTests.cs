...
using DataType = Sbn.Cms.Core.Models.DataType;

namespace Sbn.Cms.Tests.Integration.Sbn.Web.BackOffice.Filters
{
    [TestFixture]
    [SbnTest(Database = SbnTestOptions.Database.NewSchemaPerTest, Mapper = true, WithApplication = true, Logger = SbnTestOptions.Logger.Console)]
    public class ContentModelValidatorTests : SbnIntegrationTest
    {
        ...
        public void Validating_ContentItemSave()
        {
            ...
            ISbnMapper sbnMapper = Services.GetRequiredService<ISbnMapper>();
            ...
            ContentItemBinder.BindModel(save, content, _modelBinderHelper, sbnMapper);
