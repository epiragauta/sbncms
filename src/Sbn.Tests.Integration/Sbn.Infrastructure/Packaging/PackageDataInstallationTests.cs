...
using Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services.Importing;
...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Packaging
{
    ...
    public class PackageDataInstallationTests : SbnIntegrationTestWithContent
    {
        ...
        public void Can_Import_Template_Package_Xml()
        {
            ...
            Assert.IsTrue(allTemplates.All(x => x.Content.Contains("SbnViewPage")));
        }
