...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    [SbnTest(
        ...
        Logger = SbnTestOptions.Logger.Console)]
    public class ContentServiceTagsTests : SbnIntegrationTest
    {
        ...
        [Test]
        [Ignore("https://github.com/sbn/Sbn-CMS/issues/3821 (U4-8442), will need to be fixed.")]
