...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    public class LocalizationServiceTests : SbnIntegrationTest
    {
        ...
        public void Can_Get_Dictionary_Item_Descendants()
        {
            using (IScope scope = ScopeProvider.CreateScope())
            {
                ...
                Debug.WriteLine("SQL CALLS: " + scope.Database.AsSbnDatabase().SqlCount);
                ...
                Assert.Less(scope.Database.AsSbnDatabase().SqlCount, 30);
            }
        }
