...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    public class EntityServiceTests : SbnIntegrationTest
    {
        ...
        public void EntityService_Can_Get_Paged_Descendants_Ordering_Path()
        {
            ...
            IEntitySlim[] entities = EntityService.GetPagedDescendants(rootId, SbnObjectTypes.Document, 0, 6, out long total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(6));
            Assert.That(total, Is.EqualTo(10));
            Assert.AreEqual(ids[0], entities[0].Id);

            entities = EntityService.GetPagedDescendants(rootId, SbnObjectTypes.Document, 1, 6, out total).ToArray();
        ...
        public void EntityService_Can_Get_Paged_Content_Children()
        {
            ...
            IEntitySlim[] entities = EntityService.GetPagedChildren(root.Id, SbnObjectTypes.Document, 0, 6, out long total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(6));
            Assert.That(total, Is.EqualTo(10));
            Assert.AreEqual(ids[0], entities[0].Id);

            entities = EntityService.GetPagedChildren(root.Id, SbnObjectTypes.Document, 1, 6, out total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(4));
            Assert.That(total, Is.EqualTo(10));
            Assert.AreEqual(ids[6], entities[0].Id);
        ...
        public void EntityService_Can_Get_Paged_Content_Descendants()
        {
            ...
            IEntitySlim[] entities = EntityService.GetPagedDescendants(root.Id, SbnObjectTypes.Document, 0, 31, out long total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(31));
            Assert.That(total, Is.EqualTo(60));
            entities = EntityService.GetPagedDescendants(root.Id, SbnObjectTypes.Document, 1, 31, out total).ToArray();
        ...
        public void EntityService_Can_Get_Paged_Content_Descendants_Including_Recycled()
        {
            ...
            int[] entities = EntityService.GetPagedDescendants(-1, SbnObjectTypes.Document, 0, 1000, out long total)
                .Select(x => x.Id)
                .ToArray();
        ...
        public void EntityService_Can_Get_Paged_Content_Descendants_Without_Recycled()
        {
            ...
            // search at root to see if it returns recycled
            int[] entities = EntityService.GetPagedDescendants(SbnObjectTypes.Document, 0, 1000, out long total, includeTrashed: false)
                .Select(x => x.Id)
                .ToArray();
        ...
        public void EntityService_Can_Get_Paged_Content_Descendants_With_Search()
        {
            ...
            IEntitySlim[] entities = EntityService.GetPagedDescendants(
                ...
                10,
                out long total,
                filter: SqlContext.Query<ISbnEntity>().Where(x => x.Name.Contains("ssss"))).ToArray();
            ...
            entities = EntityService.GetPagedDescendants(
                ...
                50,
                out total,
                filter: SqlContext.Query<ISbnEntity>().Where(x => x.Name.Contains("tttt"))).ToArray();
        ...
        public void EntityService_Can_Get_Paged_Media_Children()
        {
            ...
            IEntitySlim[] entities = EntityService.GetPagedChildren(root.Id, SbnObjectTypes.Media, 0, 6, out long total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(6));
            Assert.That(total, Is.EqualTo(10));
            entities = EntityService.GetPagedChildren(root.Id, SbnObjectTypes.Media, 1, 6, out total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(4));
            Assert.That(total, Is.EqualTo(10));
        }
        ...
        public void EntityService_Can_Get_Paged_Media_Descendants()
        {
            ...
            IEntitySlim[] entities = EntityService.GetPagedDescendants(root.Id, SbnObjectTypes.Media, 0, 31, out long total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(31));
            Assert.That(total, Is.EqualTo(60));
            entities = EntityService.GetPagedDescendants(root.Id, SbnObjectTypes.Media, 1, 31, out total).ToArray();
            Assert.That(entities.Length, Is.EqualTo(29));
            Assert.That(total, Is.EqualTo(60));
        }
        ...
        public void EntityService_Can_Get_Paged_Media_Descendants_Including_Recycled()
        {
            ...
            // search at root to see if it returns recycled
            int[] entities = EntityService.GetPagedDescendants(-1, SbnObjectTypes.Media, 0, 1000, out long total)
                .Select(x => x.Id)
                .ToArray();
        ...
        public void EntityService_Can_Get_Paged_Media_Descendants_Without_Recycled()
        {
            ...
            // search at root to see if it returns recycled
            int[] entities = EntityService.GetPagedDescendants(SbnObjectTypes.Media, 0, 1000, out long total, includeTrashed: false)
                .Select(x => x.Id)
                .ToArray();
        ...
        [Test]
        public void EntityService_Can_Find_All_Content_By_SbnObjectTypes()
        {
            IEntitySlim[] entities = EntityService.GetAll(SbnObjectTypes.Document).ToArray();
        ...
        [Test]
        public void EntityService_Can_Find_All_Content_By_SbnObjectType_Id()
        {
        ...
        [Test]
        public void EntityService_Can_Get_Child_Content_By_ParentId_And_SbnObjectType()
        {
            IEntitySlim[] entities = EntityService.GetChildren(-1, SbnObjectTypes.Document).ToArray();
        ...
        [Test]
        public void EntityService_Can_Get_Content_By_SbnObjectType_With_Variant_Names()
        {
            ...
            IEntitySlim result = EntityService.Get(c1.Id, SbnObjectTypes.Document);
        ...
        [Test]
        public void EntityService_Can_Get_Child_Content_By_ParentId_And_SbnObjectType_With_Variant_Names()
        {
            ...
            IEntitySlim[] entities = EntityService.GetChildren(root.Id, SbnObjectTypes.Document).ToArray();
        ...
        [Test]
        public void EntityService_Can_Find_All_ContentTypes_By_SbnObjectTypes()
        {
            IEntitySlim[] entities = EntityService.GetAll(SbnObjectTypes.DocumentType).ToArray();
        ...
        [Test]
        public void EntityService_Can_Find_All_ContentTypes_By_SbnObjectType_Id()
        {
        ...
        [Test]
        public void EntityService_Can_Find_All_Media_By_SbnObjectTypes()
        {
            IEntitySlim[] entities = EntityService.GetAll(SbnObjectTypes.Media).ToArray();
        ...
        {
            SbnObjectTypes mediaObjectType = EntityService.GetObjectType(1031);

            Assert.NotNull(mediaObjectType);
            Assert.AreEqual(mediaObjectType, SbnObjectTypes.MediaType);
        }

        [Test]
        public void EntityService_Can_Get_Key_For_Id_With_Unknown_Type()
        {
            Attempt<Guid> result = EntityService.GetKey(_contentType.Id, SbnObjectTypes.Unknown);
        ...
        {
            Attempt<Guid> result = EntityService.GetKey(_contentType.Id, SbnObjectTypes.DocumentType);
        ...
        {
            Attempt<Guid> result1 = EntityService.GetKey(_contentType.Id, SbnObjectTypes.DocumentType);
            Attempt<Guid> result2 = EntityService.GetKey(_contentType.Id, SbnObjectTypes.MediaType);
        ...
        {
            Attempt<int> result = EntityService.GetId(Guid.Parse("1D3A8E6E-2EA9-4CC1-B229-1AEE19821522"), SbnObjectTypes.Unknown);
        ...
        {
            Attempt<int> result = EntityService.GetId(Guid.Parse("1D3A8E6E-2EA9-4CC1-B229-1AEE19821522"), SbnObjectTypes.DocumentType);
        ...
        {
            Attempt<int> result1 = EntityService.GetId(Guid.Parse("1D3A8E6E-2EA9-4CC1-B229-1AEE19821522"), SbnObjectTypes.DocumentType);
            Attempt<int> result2 = EntityService.GetId(Guid.Parse("1D3A8E6E-2EA9-4CC1-B229-1AEE19821522"), SbnObjectTypes.MediaType);
        ...
        public void ReserveId()
        {
            ...
            // can get it back
            Attempt<int> id = EntityService.GetId(guid, SbnObjectTypes.DocumentType);
            Assert.IsTrue(id.Success);
            Assert.AreEqual(reservedId, id.Result);

            // anything goes
            id = EntityService.GetId(guid, SbnObjectTypes.Media);
            Assert.IsTrue(id.Success);
            Assert.AreEqual(reservedId, id.Result);

            // a random guid won't work
            Assert.IsFalse(EntityService.GetId(Guid.NewGuid(), SbnObjectTypes.DocumentType).Success);
        }
