...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    public class ContentEventsTests : SbnIntegrationTestWithContent
    {
        private CacheRefresherCollection CacheRefresherCollection => GetRequiredService<CacheRefresherCollection>();

        private ISbnContextFactory SbnContextFactory => GetRequiredService<ISbnContextFactory>();
        ...
        public void UnpublishContentBranch()
        {
            ...
            // the whole branch by themselves. Examine does it in SbnContentIndexer,
