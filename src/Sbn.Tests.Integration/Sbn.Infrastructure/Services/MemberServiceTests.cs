...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    [TestFixture]
    [Category("Slow")]
    [SbnTest(Database = SbnTestOptions.Database.NewSchemaPerTest, PublishedRepositoryEvents = true, WithApplication = true)]
    public class MemberServiceTests : SbnIntegrationTest
    {
        ...
        public void Can_Create_Member_With_Properties()
        {
            ...
            // contains the sbnMember... properties created when installing, on the member type
        ...
        public void Can_Get_Members_In_Role()
        {
            ...
            {
                roleId = scope.Database.ExecuteScalar<int>("SELECT id from sbnNode where [text] = 'MyTestRole1'");
                scope.Complete();
            }
