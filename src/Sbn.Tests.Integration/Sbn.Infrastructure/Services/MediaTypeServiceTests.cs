...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    public class MediaTypeServiceTests : SbnIntegrationTest
    {
        private MediaService MediaService => (MediaService)GetRequiredService<IMediaService>();

        private IMediaTypeService MediaTypeService => GetRequiredService<IMediaTypeService>();

        protected override void CustomTestSetup(ISbnBuilder builder) => builder
        ...
        public void Can_Copy_MediaType_By_Performing_Clone()
        {
            ...
            Assert.AreNotEqual(mediaType.PropertyTypes.First(x => x.Alias.Equals("sbnFile")).Id, sut.PropertyTypes.First(x => x.Alias.Equals("sbnFile")).Id);
        ...
        public void Can_Copy_MediaType_To_New_Parent_By_Performing_Clone()
        {
            ...
            Assert.AreNotEqual(clonedMediaType.PropertyTypes.First(x => x.Alias.StartsWith("sbnFile")).Id, originalMediaType.PropertyTypes.First(x => x.Alias.StartsWith("sbnFile")).Id);
