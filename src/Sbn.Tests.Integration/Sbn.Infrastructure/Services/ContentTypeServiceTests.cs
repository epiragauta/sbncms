...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    public class ContentTypeServiceTests : SbnIntegrationTest
    {
        ...
        {
            // Related the second issue in screencast from this post http://issues.sbn.org/issue/U4-5986
        ...
        {
            // Related the first issue in screencast from this post http://issues.sbn.org/issue/U4-5986
