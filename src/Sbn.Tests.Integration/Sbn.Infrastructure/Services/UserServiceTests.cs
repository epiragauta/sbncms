...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    public class UserServiceTests : SbnIntegrationTest
    {
        ...
        public void Get_All_User_Permissions_For_All_Nodes_With_Explicit_Permission()
        {
            ...
            IUser user = UserService.CreateUserWithIdentity("John Doe", "john@sbn.io");
        ...
        {
            // see: http://issues.sbn.org/issue/U4-10075#comment=67-40085
        ...
        {
            IUser user = UserService.CreateUserWithIdentity("JohnDoe", "john@sbn.io");
        ...
        {
            IUser user = UserService.CreateUserWithIdentity("JohnDoe", "john@sbn.io");
            IUser user2 = UserService.CreateUserWithIdentity("john2@sbn.io", "john2@sbn.io");
            Assert.IsTrue(UserService.Exists("JohnDoe"));
            Assert.IsFalse(UserService.Exists("notFound"));
            Assert.IsTrue(UserService.Exists("john2@sbn.io"));
        }
        ...
        {
            IUser user = UserService.CreateUserWithIdentity("mydomain\\JohnDoe", "john@sbn.io");
        ...
        {
            // Act
            IUser membershipUser = UserService.CreateUserWithIdentity("JohnDoe", "john@sbn.io");
        ...
        public void Can_Persist_New_User_With_Hashed_Password()
        {
            ...
            var membershipUser = new User(globalSettings, "JohnDoe", "john@sbn.io", encodedPassword, encodedPassword);
        ...
        {
            // Act & Assert
            Assert.Throws<ArgumentException>(() => UserService.CreateUserWithIdentity(string.Empty, "john@sbn.io"));
        }
