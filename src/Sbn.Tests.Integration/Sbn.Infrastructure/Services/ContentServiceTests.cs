...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Services
{
    ...
    [TestFixture]
    [SbnTest(
        Database = SbnTestOptions.Database.NewSchemaPerTest,
        PublishedRepositoryEvents = true,
        WithApplication = true)]
    public class ContentServiceTests : SbnIntegrationTestWithContent
    {
        ...
        public void Can_Empty_RecycleBin_With_Content_That_Has_All_Related_Data()
        {
            ...
            Assert.IsTrue(DomainService.Save(new SbnDomain("www.test.com", "en-AU")
            {
        ...
        {
            // see https://github.com/sbn/Sbn-CMS/issues/5513
