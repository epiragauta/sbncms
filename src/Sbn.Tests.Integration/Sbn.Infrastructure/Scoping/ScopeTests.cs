...
{
    [TestFixture]
    [SbnTest(Database = SbnTestOptions.Database.NewEmptyPerFixture)]
    public class ScopeTests : SbnIntegrationTest
    {
        ...
        public void ScopeReference()
        {
            ...
            {
                ISbnDatabase db = scope.Database;
            });
            Assert.Throws<ObjectDisposedException>(() =>
            {
                ISbnDatabase db = nested.Database;
            });
        }
