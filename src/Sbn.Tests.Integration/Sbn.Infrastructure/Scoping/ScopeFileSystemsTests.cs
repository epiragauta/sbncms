...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Scoping
{
    ...
    public class ScopeFileSystemsTests : SbnIntegrationTest
    {
        ...
        {
            string rootPath = HostingEnvironment.MapPathWebRoot(GlobalSettings.SbnMediaPath);
            string rootUrl = HostingEnvironment.ToAbsolute(GlobalSettings.SbnMediaPath);
