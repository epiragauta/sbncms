...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class UserGroupRepositoryTest : SbnIntegrationTest
    {
        private UserGroupRepository CreateRepository(IScopeProvider provider) =>
            new UserGroupRepository((IScopeAccessor)provider, global::Sbn.Cms.Core.Cache.AppCaches.Disabled, LoggerFactory.CreateLogger<UserGroupRepository>(), LoggerFactory, ShortStringHelper);
        ...
        public void Can_Perform_Delete_On_UserGroupRepository()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                var repository2 = new UserGroupRepository((IScopeAccessor)provider, global::Sbn.Cms.Core.Cache.AppCaches.Disabled, LoggerFactory.CreateLogger<UserGroupRepository>(), LoggerFactory, ShortStringHelper);
