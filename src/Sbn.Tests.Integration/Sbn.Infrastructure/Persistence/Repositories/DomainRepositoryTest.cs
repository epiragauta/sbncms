...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class DomainRepositoryTest : SbnIntegrationTest
    {
        ...
        public void Can_Create_And_Get_By_Id()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                var domain = (IDomain)new SbnDomain("test.com") { RootContentId = content.Id, LanguageId = lang.Id };
                repo.Save(domain);
        ...
        public void Can_Create_And_Get_By_Id_Empty_lang()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                var domain = (IDomain)new SbnDomain("test.com") { RootContentId = content.Id };
                repo.Save(domain);
        ...
        public void Cant_Create_Duplicate_Domain_Name()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                var domain1 = (IDomain)new SbnDomain("test.com") { RootContentId = content.Id, LanguageId = lang.Id };
                repo.Save(domain1);

                var domain2 = (IDomain)new SbnDomain("test.com") { RootContentId = content.Id, LanguageId = lang.Id };
        ...
        public void Can_Update()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                var domain = (IDomain)new SbnDomain("test.com") { RootContentId = content1.Id, LanguageId = lang1.Id };
                repo.Save(domain);
        ...
        public void Exists()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    var domain = (IDomain)new SbnDomain("test" + i + ".com") { RootContentId = content.Id, LanguageId = lang.Id };
                    repo.Save(domain);
                }
        ...
        public void Get_All_Without_Wildcards()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    var domain = (IDomain)new SbnDomain((i % 2 == 0) ? "test " + i + ".com" : ("*" + i))
                    {
