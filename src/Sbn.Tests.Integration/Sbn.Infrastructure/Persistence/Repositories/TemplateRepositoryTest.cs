...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class TemplateRepositoryTest : SbnIntegrationTest
    {
        ...
        public void Can_Perform_Add_View_With_Default_Content()
        {
            ...
            using (provider.CreateScope())
            {
                ...
                Assert.That(FileSystems.MvcViewsFileSystem.FileExists("test.cshtml"), Is.True);
                Assert.AreEqual(
                    @"@usingSbn.Cms.Web.Common.PublishedModels;@inheritsSbn.Cms.Web.Common.Views.SbnViewPage@{Layout=null;}".StripWhitespace(),
        ...
        public void Can_Perform_Add_View_With_Default_Content_With_Parent()
        {
            ...
            using (provider.CreateScope())
            {
                ...
                Assert.AreEqual(
                    "@usingSbn.Cms.Web.Common.PublishedModels;@inherits Sbn.Cms.Web.Common.Views.SbnViewPage @{ Layout = \"test.cshtml\";}".StripWhitespace(),
