...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class MediaTypeRepositoryTest : SbnIntegrationTest
    {
        ...
        public void Can_Move()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                global::Sbn.Cms.Core.Events.MoveEventInfo<IMediaType>[] result = repository.Move(contentType, container1).ToArray();
