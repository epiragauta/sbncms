...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class ServerRegistrationRepositoryTest : SbnIntegrationTest
    {
        ...
        public void Can_Perform_Update_On_Repository()
        {
            ...
            using (provider.CreateScope())
            {
                ...
                server.ServerAddress = "https://sbn.com";
                ...
                Assert.That(serverUpdated.ServerAddress, Is.EqualTo("https://sbn.com"));
