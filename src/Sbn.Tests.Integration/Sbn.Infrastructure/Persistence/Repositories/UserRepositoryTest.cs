...
{
    [TestFixture]
    [SbnTest(Database = SbnTestOptions.Database.NewSchemaPerTest, WithApplication = true, Logger = SbnTestOptions.Logger.Console)]
    public class UserRepositoryTest : SbnIntegrationTest
    {
