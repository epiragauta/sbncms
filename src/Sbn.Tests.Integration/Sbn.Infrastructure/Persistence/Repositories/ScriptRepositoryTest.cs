...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class ScriptRepositoryTest : SbnIntegrationTest
    {
        ...
        {
            string path = GlobalSettings.SbnScriptsPath;
            ...
            using (Stream stream = CreateStream("Sbn.Sys.registerNamespace(\"Sbn.Utils\");"))
            {
