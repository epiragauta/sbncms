...
{
    [TestFixture]
    [SbnTest(Database = SbnTestOptions.Database.None, Logger = SbnTestOptions.Logger.Console)]
    public class StylesheetRepositoryTest : SbnIntegrationTest
    {
        ...
        {
            string path = HostingEnvironment.MapPathWebRoot(GlobalSettings.SbnCssPath);
