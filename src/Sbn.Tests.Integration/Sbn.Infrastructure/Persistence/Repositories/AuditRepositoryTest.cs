...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class AuditRepositoryTest : SbnIntegrationTest
    {
        ...
        public void Can_Add_Audit_Entry()
        {
            ...
            using (IScope scope = ScopeProvider.CreateScope())
            {
                ...
                repo.Save(new AuditItem(-1, AuditType.System, -1, SbnObjectTypes.Document.GetName(), "This is a System audit trail"));
        ...
        public void Get_Paged_Items()
        {
            ...
            using (IScope scope = sp.CreateScope())
            {
                ...
                for (int i = 0; i < 100; i++)
                {
                    repo.Save(new AuditItem(i, AuditType.New, -1, SbnObjectTypes.Document.GetName(), $"Content {i} created"));
                    repo.Save(new AuditItem(i, AuditType.Publish, -1, SbnObjectTypes.Document.GetName(), $"Content {i} published"));
                }
        ...
        public void Get_Paged_Items_By_User_Id_With_Query_And_Filter()
        {
            ...
            using (IScope scope = sp.CreateScope())
            {
                ...
                try
                {
                    scope.Database.AsSbnDatabase().EnableSqlTrace = true;
                    scope.Database.AsSbnDatabase().EnableSqlCount = true;
                ...
                {
                    scope.Database.AsSbnDatabase().EnableSqlTrace = false;
                    scope.Database.AsSbnDatabase().EnableSqlCount = false;
                }
            }
        }
        ...
        public void Get_Paged_Items_With_Custom_Filter()
        {
            ...
            using (IScope scope = sp.CreateScope())
            {
                ...
                for (int i = 0; i < 100; i++)
                {
                    repo.Save(new AuditItem(i, AuditType.New, -1, SbnObjectTypes.Document.GetName(), "Content created"));
                    repo.Save(new AuditItem(i, AuditType.Publish, -1, SbnObjectTypes.Document.GetName(), "Content published"));
                }
