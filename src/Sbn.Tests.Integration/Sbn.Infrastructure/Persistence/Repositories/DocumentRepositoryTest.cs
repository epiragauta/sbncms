...
namespace Sbn.Cms.Tests.Integration.Sbn.Infrastructure.Persistence.Repositories
{
    ...
    public class DocumentRepositoryTest : SbnIntegrationTest
    {
        ...
        public void CacheActiveForIntsAndGuids()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                ISbnDatabase udb = scope.Database;
        ...
        ////         var textpage = ContentBuilder.CreateSimpleContentWithSpecialDatabaseTypes(contentType, "test@sbn.org", -1, "100", "150", dateValue);
        ////
        ...
        public void SaveContentWithAtSignInName()
        {
            ...
            using (IScope scope = provider.CreateScope())
            {
                ...
                Content textpage = ContentBuilder.CreateSimpleContent(contentType, "test@sbn.org");
