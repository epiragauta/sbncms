...
namespace Sbn.Cms.Tests.Integration.Sbn.Core.Mapping
{
    ...
    public class ContentTypeModelMappingTests : SbnIntegrationTest
    {
        ...
        {
            _sut = Services.GetRequiredService<ISbnMapper>();
        ...
        public void IContentTypeComposition_To_ContentTypeDisplay()
        {
            ...
            ctMain.AddPropertyType(new PropertyType(ShortStringHelper, Constants.PropertyEditors.Aliases.TextBox, ValueStorageType.Ntext)
            {
                Alias = "sbnUrlName", Name = "Slug", Description = string.Empty, Mandatory = false, SortOrder = 1, DataTypeId = -88
            });
            ...
            contentType.AddPropertyType(new PropertyType(ShortStringHelper, Constants.PropertyEditors.Aliases.TextBox, ValueStorageType.Ntext)
            {
                Alias = "sbnUrlAlias", Name = "AltUrl", Description = string.Empty, Mandatory = false, SortOrder = 1, DataTypeId = -88
            });
