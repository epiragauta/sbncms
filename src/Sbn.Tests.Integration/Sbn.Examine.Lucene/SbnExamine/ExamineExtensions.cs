...
{
    /// <summary>
    /// LEGACY!! Static methods to help query sbn xml
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Returns true if the XElement is recognized as an sbn xml NODE (doc type) 
        /// </summary>
        /// <param name="x"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns sbn value for a data element with the specified alias.
        /// </summary>
        ...
        public static ValueSet ConvertToValueSet(this XElement xml, string indexCategory)
        {
            ...
            //since this is what Sbn expects
