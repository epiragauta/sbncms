...
using IContentService = Sbn.Cms.Core.Services.IContentService;
using IMediaService = Sbn.Cms.Core.Services.IMediaService;
...
namespace Sbn.Cms.Tests.Integration.Sbn.Examine.Lucene.SbnExamine
{
    ...
    public class IndexInitializer
    {
        ...
        public ContentIndexPopulator GetContentIndexRebuilder(IContentService contentService, bool publishedValuesOnly, ISbnDatabaseFactory sbnDatabaseFactory)
        {
            ...
            var allRecs = demoData.GetLatestContentByXPath("//*[@isDoc]")
                ...
                .Select((xmlElement, index) => Mock.Of<IContent>(
                    m =>
                        ...
                        m.Name == (string)xmlElement.Attribute(SbnExamineFieldNames.NodeNameFieldName) &&
                        m.GetCultureName(It.IsAny<string>()) == (string)xmlElement.Attribute(SbnExamineFieldNames.NodeNameFieldName) &&
        ...
        public SbnContentIndex GetSbnIndexer(
            ...
            IContentValueSetValidator validator = null)
        {
            ...
            var options = GetOptions(
                ...
                new LuceneDirectoryIndexOptions
                {
                    ...
                    FieldDefinitions = new SbnFieldDefinitionCollection()
                });

            var i = new SbnContentIndex(
                _loggerFactory,
                "testIndexer",
                options,
                hostingEnvironment,
