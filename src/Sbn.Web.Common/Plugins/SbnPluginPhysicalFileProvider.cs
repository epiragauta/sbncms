...
namespace Sbn.Cms.Web.Common.Plugins
{
    /// <summary>
    ...
    /// </remarks>
    public class SbnPluginPhysicalFileProvider : PhysicalFileProvider, IFileProvider
    {
        private readonly IOptions<SbnPluginSettings> _options;

        /// <summary>
        /// Initializes a new instance of the <see cref="SbnPluginPhysicalFileProvider"/> class, at the given root directory.
        /// </summary>
        /// <param name="root">The root directory. This should be an absolute path.</param>
        /// <param name="options">The configuration options.</param>
        /// <param name="filters">Specifies which files or directories are excluded.</param>
        public SbnPluginPhysicalFileProvider(string root, IOptions<SbnPluginSettings> options, ExclusionFilters filters = ExclusionFilters.Sensitive)
        ...
        /// </summary>
        /// <remarks>
        /// The path needs to pass the <see cref="ExclusionFilters"/> and the <see cref="SbnPluginSettings.BrowsableFileExtensions"/> to be found.
        /// </remarks>
