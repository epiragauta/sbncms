...
namespace Sbn.Cms.Web.Common.ModelBinders
{
    ...
    public class ContentModelBinder : IModelBinder
    {
        ...
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            // in the SbnRouteValues --> IContentModel
            SbnRouteValues sbnRouteValues = bindingContext.HttpContext.Features.Get<SbnRouteValues>();
            if (sbnRouteValues is null)
            {
                return Task.CompletedTask;
            }

            BindModel(bindingContext, sbnRouteValues.PublishedRequest.PublishedContent, bindingContext.ModelType);
            return Task.CompletedTask;
        }
