...
namespace Sbn.Extensions
{
    ...
    /// </summary>
    public static class SbnBuilderDependencyInjectionExtensions
    {
        /// <summary>
        /// Adds sbn's embedded model builder support
        /// </summary>
        public static ISbnBuilder AddModelsBuilder(this ISbnBuilder builder)
        {
            var umbServices = new UniqueServiceDescriptor(typeof(SbnServices), typeof(SbnServices), ServiceLifetime.Singleton);
            ...
            builder.AddNotificationHandler<SbnApplicationStartingNotification, AutoModelsNotificationHandler>();
            builder.AddNotificationHandler<SbnRequestEndNotification, AutoModelsNotificationHandler>();
        ...
        private static ISbnBuilder AddInMemoryModelsRazorEngine(this ISbnBuilder builder)
        {
