...
namespace Sbn.Extensions
{
    ...
    {
        /// <summary>
        /// Adds Identity support for Sbn members
        /// </summary>
        public static ISbnBuilder AddMembersIdentity(this ISbnBuilder builder)
        {
            ...
            // If a developer wishes to use Sbn Members with different AuthN/AuthZ values, like different cookie values
            // or authentication scheme's then they can call the default identity configuration methods like ConfigureApplicationCookie.
            // BUT ... if a developer wishes to use the default auth schemes for entirely separate purposes alongside Sbn members,
            ...
            services.AddIdentity<MemberIdentityUser, SbnIdentityRole>()
                ...
                .AddUserConfirmation<SbnUserConfirmation<MemberIdentityUser>>();
