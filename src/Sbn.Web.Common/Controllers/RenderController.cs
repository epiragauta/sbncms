...
namespace Sbn.Cms.Web.Common.Controllers
{
    ...
    public class RenderController : SbnPageController, IRenderController
    {
        ...
        /// </summary>
        public RenderController(ILogger<RenderController> logger, ICompositeViewEngine compositeViewEngine, ISbnContextAccessor sbnContextAccessor)
        ...
        {
            IPublishedRequest pcr = SbnRouteValues.PublishedRequest;
            ...
            SbnRouteResult routeStatus = pcr.GetRouteResult();
            switch (routeStatus)
            {
                case SbnRouteResult.Redirect:
                    ...
                    break;
                case SbnRouteResult.NotFound:
                    // set the redirect result and do not call next to short circuit
                    context.Result = GetNoTemplateResult(pcr);
                    break;
                case SbnRouteResult.Success:
                default:
        ...
        private PublishedContentNotFoundResult GetNoTemplateResult(IPublishedRequest pcr)
        {
            ...
            if (!pcr.HasPublishedContent())
            {
                ...
                return new PublishedContentNotFoundResult(SbnContext);
            }
