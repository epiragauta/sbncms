        ...
        public async Task InvokeAsync(HttpContext context, RequestDelegate next)
        {
            ...
            try
            {
                ...
                if (isPreview)
                {
                    ...
                    // If we've gotten this far it means a preview cookie has been set and a front-end sbn document request is executing.
                    // In this case, authentication will not have occurred for an Sbn back office User, however we need to perform the authentication
                    ...
                    if (request.Cookies.TryGetValue(cookieOptions.Cookie.Name, out var cookie))
                    {
                        ...
                        var backOfficeIdentity = unprotected?.Principal.GetSbnIdentity();
