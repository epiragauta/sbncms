...
namespace Sbn.Cms.Web.Common.ApplicationModels
{
    ...
    /// <summary>
    /// An application model provider for Sbn API controllers to behave like WebApi controllers
    /// </summary>
    /// <remarks>
    /// <para>
    /// Conventions will be applied to controllers attributed with <see cref="SbnApiControllerAttribute"/>
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public class SbnApiBehaviorApplicationModelProvider : IApplicationModelProvider
    {
        private readonly List<IActionModelConvention> _actionModelConventions;

        /// <summary>
        /// Initializes a new instance of the <see cref="SbnApiBehaviorApplicationModelProvider"/> class.
        /// </summary>
        public SbnApiBehaviorApplicationModelProvider(IModelMetadataProvider modelMetadataProvider)
        {
            ...
            _actionModelConventions = new List<IActionModelConvention>()
            {
                ...
                // using our own SbnJsonModelBinder
                new SbnJsonModelBinderConvention()
            };
        ...
        public void OnProvidersExecuting(ApplicationModelProviderContext context)
        {
            ...
            {
                if (!IsSbnApiController(controller))
                {
                    continue;
                }
        ...
        private bool IsSbnApiController(ControllerModel controller)
            => controller.Attributes.OfType<SbnApiControllerAttribute>().Any();
    }
}
