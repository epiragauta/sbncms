...
namespace Sbn.Cms.Web.Common.Profiler
{
    ...
    public class WebProfiler : IProfiler
    {
        ...
        public void SbnApplicationBeginRequest(HttpContext context, RuntimeLevel runtimeLevel)
        {
        ...
        public void SbnApplicationEndRequest(HttpContext context, RuntimeLevel runtimeLevel)
        {
            if (runtimeLevel != RuntimeLevel.Run)
            {
                return;
