...
namespace Sbn.Cms.Web.Common.Security
{
    public class EncryptionHelper
    {
        ...
        /// <summary>
        /// This is used in methods like BeginSbnForm and SurfaceAction to generate an encrypted string which gets submitted in a request for which
        /// Sbn can decrypt during the routing process in order to delegate the request to a specific MVC Controller.
        /// </summary>
        ...
        public static bool DecryptAndValidateEncryptedRouteString(IDataProtectionProvider dataProtectionProvider, string encryptedString, out IDictionary<string, string> parts)
        {
            ...
            {
                StaticApplicationLogging.Logger.LogWarning("A value was detected in the ufprt parameter but Sbn could not decrypt the string");
                parts = null;
                return false;
            }
