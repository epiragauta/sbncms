...
{
    public class BackOfficeUserManager : SbnUserManager<BackOfficeIdentityUser, UserPasswordConfigurationSettings>, IBackOfficeUserManager
    {
        ...
        /// <remarks>
        /// In the ASP.NET Identity world, there is only one value for being locked out, in Sbn we have 2 so when checking this for Sbn we need to check both values
        /// </remarks>
        ...
        {
            ClaimsIdentity umbIdentity = currentUser?.GetSbnIdentity();
