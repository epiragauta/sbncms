...
namespace Sbn.Cms.Web.Common.AspNetCore
{
    public class AspNetCoreHostingEnvironment : IHostingEnvironment
    {
            ...
            IWebHostEnvironment webHostEnvironment)
        {
            ...
            if (_webRoutingSettings.CurrentValue.SbnApplicationUrl is not null)
            {
                ApplicationMainUrl = new Uri(_webRoutingSettings.CurrentValue.SbnApplicationUrl);
            }
        }
            ...
            get
            {
                ...
                switch (_hostingSettings.CurrentValue.LocalTempStorageLocation)
                {
                    case LocalTempStorage.EnvironmentTemp:
                        ...
                        string siteTemp = Path.Combine(Environment.ExpandEnvironmentVariables("%temp%"), "SbnData", hash);
