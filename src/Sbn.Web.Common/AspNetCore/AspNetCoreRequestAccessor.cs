...
{
    public class AspNetCoreRequestAccessor : IRequestAccessor, INotificationHandler<SbnRequestBeginNotification>
    {
        ...
        public Uri GetApplicationUrl()
        {
            ...
            // about this is that this is here specifically for the slot swap scenario https://issues.sbn.org/issue/U4-10626

            // see U4-10626 - in some cases we want to reset the application url
            // (this is a simplified version of what was in 7.x)
            // note: should this be optional? is it expensive?

            if (!(_webRoutingSettings.SbnApplicationUrl is null))
            {
                return new Uri(_webRoutingSettings.SbnApplicationUrl);
            }
        ...
        /// </summary>
        public void Handle(SbnRequestBeginNotification notification)
