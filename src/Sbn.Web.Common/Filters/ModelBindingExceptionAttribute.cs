...
namespace Sbn.Cms.Web.Common.Filters
{
    ...
    public sealed class ModelBindingExceptionAttribute : TypeFilterAttribute
    {
        ...
        {
            private static readonly Regex s_getPublishedModelsTypesRegex = new Regex("Sbn.Web.PublishedModels.(\\w+)", RegexOptions.Compiled);
