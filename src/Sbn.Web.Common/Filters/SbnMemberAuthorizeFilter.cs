...
namespace Sbn.Cms.Web.Common.Filters
{
    ...
    /// </summary>
    public class SbnMemberAuthorizeFilter : IAsyncAuthorizationFilter
    {
        public SbnMemberAuthorizeFilter()
        {
        }

        public  SbnMemberAuthorizeFilter(string allowType, string allowGroup, string allowMembers)
        {
            AllowType = allowType;
