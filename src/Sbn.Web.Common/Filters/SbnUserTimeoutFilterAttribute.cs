...
namespace Sbn.Cms.Web.Common.Filters
{
    ...
    /// </summary>
    public class SbnUserTimeoutFilterAttribute : TypeFilterAttribute
    {
        public SbnUserTimeoutFilterAttribute() : base(typeof(SbnUserTimeoutFilter))
        {
        }

        private class SbnUserTimeoutFilter : IActionFilter
        {
