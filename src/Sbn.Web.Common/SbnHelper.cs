...
{
    /// <summary>
    /// A helper class that provides many useful methods and functionality for using Sbn in templates
    /// </summary>
    /// <remarks>
    /// This object is a request based lifetime
    /// </remarks>
    public class SbnHelper
    {
        private readonly IPublishedContentQuery _publishedContentQuery;
        private readonly ISbnComponentRenderer _componentRenderer;
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="SbnHelper"/>.
        /// </summary>
        ...
        public SbnHelper(ICultureDictionaryFactory cultureDictionary,
            ISbnComponentRenderer componentRenderer,
        ...
        /// <summary>
        /// Initializes a new empty instance of <see cref="SbnHelper"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets (or sets) the current <see cref="IPublishedContent"/> item assigned to the SbnHelper.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Note that this is the assigned IPublishedContent item to the
        /// SbnHelper, this is not necessarily the Current IPublishedContent
        /// item being rendered that is assigned to the SbnContext.
        /// This IPublishedContent object is contextual to the current SbnHelper instance.
        /// </para>
        ///<para>
        ...
        /// SbnHelper is constructed with an SbnContext and it is not a
        ...
        public IPublishedContent AssignedContentItem
        {
            get
            {
                ...
                throw new InvalidOperationException(
                    $"Cannot return the {nameof(IPublishedContent)} because the {nameof(SbnHelper)} was not constructed with an {nameof(IPublishedContent)}."
                    );
        ...
        /// <param name="altText">fall back text if dictionary item is empty - Name altText to match Sbn.Field</param>
        /// <returns></returns>
