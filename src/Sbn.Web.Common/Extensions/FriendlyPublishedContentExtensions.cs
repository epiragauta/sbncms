...
namespace Sbn.Extensions
{
    public static class FriendlyPublishedContentExtensions
    {
        ...
        private static ISbnContextAccessor SbnContextAccessor { get; } =
            StaticServiceProvider.Instance.GetRequiredService<ISbnContextAccessor>();
        ...
        /// 'sbnFile' property. Use the MediaUrl() method to get the media url for other
        /// properties.</para>
        ...
        /// <param name="propertyAlias">The alias of the property (use 'sbnFile' by default).</param>
        ...
        public static string GetCultureFromDomains(
            this IPublishedContent content,
            Uri current = null)
            => content.GetCultureFromDomains(SbnContextAccessor, SiteDomainHelper, current);
        ...
        public static IEnumerable<PublishedSearchResult> SearchDescendants(
            ...
            => content.SearchDescendants(ExamineManager, SbnContextAccessor, term, indexName);
        ...
        public static IEnumerable<PublishedSearchResult> SearchChildren(
            ...
            string term,
            string indexName = null)
            => content.SearchChildren(ExamineManager, SbnContextAccessor, term, indexName);
