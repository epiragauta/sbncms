...
namespace Sbn.Extensions
{
    public static class FriendlyImageCropperTemplateExtensions
    {
        ...
        /// <summary>
        /// Gets the underlying image processing service URL by the crop alias (from the "sbnFile" property alias) on the IPublishedContent item.
        /// </summary>
        ...
        /// <summary>
        /// Gets the underlying image processing service URL by the crop alias (from the "sbnFile" property alias in the MediaWithCrops content item) on the MediaWithCrops item.
        /// </summary>
        ...
        /// </summary>
        /// <param name="mediaItem">The IPublishedContent item.</param>
        /// <param name="propertyAlias">The property alias of the property containing the JSON data e.g. sbnFile.</param>
        /// <param name="cropAlias">The crop alias e.g. thumbnail.</param>
        /// <param name="urlMode">The url mode.</param>
        /// <returns>
        /// The URL of the cropped image.
        ...
        /// <param name="width">The width of the output image.</param>
        /// <param name="height">The height of the output image.</param>
        /// <param name="imageCropperValue">The JSON data from the Sbn Core Image Cropper property editor.</param>
        /// <param name="cropAlias">The crop alias.</param>
        /// <param name="quality">Quality percentage of the output image.</param>
        /// <param name="imageCropMode">The image crop mode.</param>
        /// <param name="imageCropAnchor">The image crop anchor.</param>
