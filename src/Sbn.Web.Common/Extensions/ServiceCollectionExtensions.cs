...
using Sbn.Cms.Core.Logging.Serilog;
...
namespace Sbn.Extensions
{
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Called to create the <see cref="TypeLoader"/> to assign to the <see cref="ISbnBuilder"/>
        /// </summary>
        ...
        /// <returns></returns>
        /// <remarks>
        /// This should never be called in a web project. It is used internally by Sbn but could be used in unit tests.
            ...
            IProfiler profiler)
        {
            ...
            var assemblyProvider = new DefaultSbnAssemblyProvider(
                entryAssembly,
                loggerFactory,
