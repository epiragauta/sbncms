...
namespace Sbn.Cms.Web.Common.Localization
{
    ...
    /// </summary>
    public class SbnPublishedContentCultureProvider : RequestCultureProvider
    {
        private readonly RequestLocalizationOptions _localizationOptions;
        private readonly object _locker = new object();

        /// <summary>
        /// Initializes a new instance of the <see cref="SbnPublishedContentCultureProvider"/> class.
        /// </summary>
        public SbnPublishedContentCultureProvider(RequestLocalizationOptions localizationOptions) => _localizationOptions = localizationOptions;

        /// <inheritdoc/>
        public override Task<ProviderCultureResult> DetermineProviderCultureResult(HttpContext httpContext)
        {
            SbnRouteValues routeValues = httpContext.Features.Get<SbnRouteValues>();
            if (routeValues != null)
            {
